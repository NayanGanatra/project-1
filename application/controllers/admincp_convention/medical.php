...

{
...

	{
		...
		$this->load->model('admincp_convention/dbmedical');
	...
	public function destroy()
	{
		...
		redirect(base_url()."admincp_convention/medical/view");
	}
...

	{
		...
		{
			$search_key = 0;
			$config['base_url'] = base_url().'admincp_convention/medical/view/'.$search_key.'/';
		}
		else
		{
			$config['base_url'] = base_url().'admincp_convention/medical/view/'.$search_key.'/';
		...
		$this->load->view('admincp_convention/medical/view',$data);
...

	{
...

		{
					...
					redirect(base_url().'admincp_convention/medical');
		...
		$this->load->view('admincp_convention/medical/edit',$data);
	...
	public function add()
	{
...

		{
					...
					$data=array(
						...
						'md_modified_date'=>$this->input->post('md_created_date'),

						'md_modified_by'=>$this->input->post('md_created_by')
		...
		$this->load->view('admincp_convention/medical/add',$data);
	}
