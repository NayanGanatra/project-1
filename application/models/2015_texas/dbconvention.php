...
class Dbconvention extends CI_Model
{
	function getpage()
	{
		...
		$sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."pages where page_home=1 ORDER BY page_id DESC LIMIT 3";
...

	{
		...
		$sql="select * from ".$this->config->item('convention_texas_db_prefix')."settings where cs_id = '1' LIMIT 1";
...
function get_menu()

	{
		...
		$sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."menu WHERE menu_status = '1' ORDER BY menu_order ASC";
	...
	{
        $sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."pages Where page_id = '$id'";
		$query = $this->db->query($sql);
		return $query->row();
	}
	function getpage_page_seo($page_seo)
	{
        $sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."pages Where page_seo = '$page_seo'";
		$query = $this->db->query($sql);
		return $query->row();
	}
	...
	function getpages_loadmore($offset)
	{
		...
		$sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."pages  where page_home=1  ORDER BY page_id DESC LIMIT ".$offset.",3 ";
		$query = $this->db->query($sql);
		return $query->result();
	...
	function getpages_cnt()
	{
		...
		$sql="SELECT count(page_id) as a FROM ".$this->config->item('convention_texas_db_prefix')."pages where page_home=1 ORDER BY page_id";
		$query = $this->db->query($sql);
		return $query->row();
	...
	function getalbum()
	{
		$sql="SELECT DISTINCT(a.cg_ca_id) , b.* FROM ".$this->config->item('convention_texas_db_prefix')."gallery a, ".$this->config->item('convention_texas_db_prefix')."album b WHERE a.cg_ca_id = b.ca_id  ORDER BY b.ca_id DESC";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	function getgallary($id)
	{
	  ...
	  $sql="SELECT DISTINCT(b.ca_name) , a.* FROM ".$this->config->item('convention_texas_db_prefix')."gallery a, ".$this->config->item('convention_texas_db_prefix')."album b WHERE a.cg_ca_id = b.ca_id  AND a.cg_ca_id = '$id' ORDER BY RAND()  LIMIT 3";
		$query = $this->db->query($sql);
		return $query->result();
	...
	{
       $sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."gallery Where cg_ca_id = '$id' AND cg_type ='0' ORDER BY cg_id DESC";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	{
       $sql="SELECT * FROM ".$this->config->item('convention_texas_db_prefix')."gallery Where cg_ca_id = '$id' AND cg_type ='1' ORDER BY cg_id DESC";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	{
		$sql = "SELECT a.* FROM ".$this->config->item('convention_texas_db_prefix')."program_member a  WHERE pm_mm_id='".$this->session->userdata('user_id')."' ORDER BY pm_id DESC ";
		$query = $this->db->query($sql);
		return $query->result();
	}
	function get_all_medical_by_user()
	{
		$sql = "SELECT a.* FROM ".$this->config->item('convention_texas_db_prefix')."medical_form a  WHERE md_mm_id='".$this->session->userdata('user_id')."' ORDER BY md_id DESC ";		
		$query = $this->db->query($sql);
		return $query->result();
	}
