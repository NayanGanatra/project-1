...
class Dbcon_detail extends CI_Model
{
	...
	{
		$sql ="SELECT a.* FROM con_fees_member a WHERE a.mm_id IN (SELECT mm_id from member_master WHERE mm_id = '".$mm_id."')";
...

	{
		...
		$sql="SELECT a.* FROM con_fees_member a, con_fees_member_group b where a.mm_id = '".$mm_id."' and a.fm_id = b.fm_id";
...

	{
		...
		$sql="SELECT * FROM con_program_member where pm_id = '".$mm_id."'";
...

	{
		...
		$sql="SELECT * FROM con_medical_form where md_mm_id = '".$mm_id."'";
...

	{
		...
		$sql="SELECT * FROM con_fees_member where mm_id = '".$mm_id."'";
...

	{
		...
		$sql="SELECT a.* FROM con_events_member a, con_events_member_group b where a.con_mm_id = '".$mm_id."' and a.ce_mem_id = b.cem_id";
...

	{
		...
		$sql="SELECT * FROM con_events_member where con_mm_id = '".$mm_id."'";
