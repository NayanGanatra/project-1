...

{
...

	{
		...
		$this->load->model('admincp/dbpages');
...

	{
...

		{
				...
				redirect(base_url().'admincp/pages');
		...
		$this->load->view('admincp/pages/edit',$data);
...

	{
...

		{
				...
				redirect(base_url().'admincp/pages/chapter_view');
		...
		$this->load->view('admincp/pages/edit_chapter',$data);
...

	{
		...
		$this->load->view('admincp/pages/add',$data);
...

	{
		...
		$this->load->view('admincp/pages/add_chapter',$data);
...

	{
		...
		$config['base_url'] = base_url().'admincp/pages/view/';
		...
		$this->load->view('admincp/pages/view',$data);
...

	{
		...
		$data['title']='Chapter '.$this->lang->line('menu_text_manage_pages');

		$this->load->view('admincp/pages/chapter_view',$data);
...

	{
		...
		redirect(base_url().'admincp/pages/view');
