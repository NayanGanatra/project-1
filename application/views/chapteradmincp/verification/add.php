...
Use Send button from list page to start sending emails.';?>"  >
            ...
            ?>
                    ...
                    <input type="hidden" id="" name="verification_created_by" value="<?php echo $username->mm_username;?>">
...
$('div#custom_box').addClass("custom_box_css");
	...
	url: BASE_URI+"chapteradmincp/verification/user_check_uncheck/add/"+uid+"/"+m_id+"/"+action,
...
$('div#custom_box').addClass("custom_box_css");
	...
	for (var i = 0, l = ln_user; i < l; i++) {
		...
		$.ajax({
		 ...
		 url: BASE_URI+"chapteradmincp/verification/add_user/<?php echo '0' ?>/"+n_chapter+"/"+j_user,
