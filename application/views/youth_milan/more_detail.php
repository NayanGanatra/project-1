	  ...
	  <table width="100%" cellspacing="10" cellpadding="0" class="table-title-b-mai">
        <tbody>
         ...
         <!-- <tr>
		  ...
		  <tr>
            <td colspan="3" valign="top" align="left" class="DetailText"><strong>Living in </strong>:  </td>
          </tr>
		  <tr>
            <td width="33%" class="DetailText">
				<table width="100%" border="0" cellspacing="5" cellpadding="2">
          ...
          <tr>
            <td valign="top" align="left" class="DetailText" colspan="3"><strong>About Myself </strong>: <?php if(sizeof($query7_1)!=0) echo $query7_1->ym_brief_about_self; ?></td>
          </tr>
        </tbody>
      </table>
