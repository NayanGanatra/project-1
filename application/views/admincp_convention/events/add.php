  	...
  	<td>
        ...
        <hr>
            ...
            <div class="control-group <?php if(form_error('activity')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input class="input-xxlarge" type="text" id="activity" name="activity" value="<?php echo set_value('activity'); ?>">
			...
			<div class="control-group <?php if(form_error('description')){ echo "error"; } ?>" style="width:750px;">
                ...
                <div class="controls">
                    <textarea style="width:100%; min-height:300px;" name="description" id="description" ></textarea>
			...
			<div class="space10px"></div>
				...
				<label class="control-label" for="inputError">Insert Age</label>
               		<input type="text" id="fromage" name="fromage" value="<?php echo set_value('fromage'); ?>" style="width:22px;"><span> - </span>
					<input type="text" id="toage" name="toage" value="<?php echo set_value('toage'); ?>" style="width:22px;">
			...
			<div class="control-group <?php if(form_error('cost')){ echo "error";}?>">
				...
				<label class="control-label" for="inputError">Cost($)</label>
               		<input type="text" id="cost" name="cost" value="<?php echo set_value('cost'); ?>" style="width:22px;">
					<span class="help-inline"><?php echo form_error('cost'); ?></span>
                </div>
            </div>
			<div class="space10px"></div>
            <input type="hidden" id="" name="ce_created_date" value="<?php echo date("Y-m-d H:i:s"); ?>">
            <input type="hidden" id="" name="ce_created_by" value="<?php echo 'admin';?>">
...
/*function submit_form()
{
	...
	{
		alert("you can not set start age greater than an end age.");
