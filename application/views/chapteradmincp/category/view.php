    	  ...
    	  <td>
			<?php 
			 ...
			 ?>
              ...
              <td><a href="<?php echo base_url('chapteradmincp/category/edit/'.$row->category_id.'');?>" title="Edit"><i class="icon-edit"></i></a> 
        <a onclick="javascript: return del();" href="<?php echo base_url();?>chapteradmincp/category/delete/<?php echo $row->category_id; ?>"title="Delete"><i class="icon-minus-sign"></i></a></td>
    </tr>
