...
<table border="0" cellspacing="2" cellpadding="2" width="100%" class="table table-hover">
    ...
    <tr <?php if($row->latest_news_status == "1") { echo "class=''"; }else{ echo "class='error'"; } ;?>>
        ...
        <td>
        <a href="<?php echo base_url(); ?>admincp/latestnews/edit/<?php echo $row->latest_news_id; ?>" title="<?php echo $this->lang->line('misc_edit');?>" ><i class="icon-edit"></i></a>
        <a href="<?php echo base_url();?>admincp/latestnews/delete/<?php echo $row->latest_news_id; ?>" title='<?php echo $this->lang->line('misc_delete');?>' onclick="javascript: return del();" > <i class="icon-minus-sign"></i></a></td>
    </tr>
