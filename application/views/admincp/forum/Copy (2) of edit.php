...
$('div#custom_box').addClass("custom_box_css");
...

	{
		fetch_user_data='0';	
		   ...
		   data :'id='+<?php echo $item->bid; ?>+'&fetch_user_data='+fetch_user_data+'&check_uncheck_all_user_status='+$('#check_uncheck_all_user_status').val()+'&offset='+'0',
...
$('div#custom_box').removeClass("custom_box_css");
...

	{
...

		{
			...
			data :'status=edit&id='+uid+'&action=false&type='+type+'&offeset='+$('#offset').val(),
...

	{
   	...
   	$.ajax({
		  ...
		  url: BASE_URI+"admincp/forum/get_template_user/",
		    ...
		    data :'id='+<?php echo $item->bid; ?>+'&fetch_user_data='+fetch_user_data+'&check_uncheck_all_user_status='+$('#check_uncheck_all_user_status').val()+'&offset='+offset,
...
$('div#custom_box').addClass("custom_box_css");
	...
	url: BASE_URI+"admincp/forum/user_check_uncheck/"+m_id,
