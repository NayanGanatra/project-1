  	...
  	<td>
    	<div class="dotted_line">
                ...
                <div style="left:77%; position:absolute; top:65px;" >
                        <a href="<?php echo base_url('admincp_convention/form/form_edit_export_to_excel/'.$this->uri->segment(4));?>" id="exportexcel" style="width:100px;float:right;" class="dropdown-toggle" >Export to excel</a>
                </div>
