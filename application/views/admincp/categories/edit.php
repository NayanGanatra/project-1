  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1><?php echo $this->lang->line('text_categories');?> <small><?php echo $this->lang->line('text_edit_category');?></small></h1>
		</div>
        <hr />
         <?php
            ...
            <div class="control-group <?php if(form_error('covers_cat_name')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input type="text" id="covers_cat_name" name="covers_cat_name" value="<?php echo $get_page->covers_cat_name; ?>">
            ...
            <div class="control-group <?php if(form_error('covers_cat_seo')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input type="text" id="covers_cat_seo" name="covers_cat_seo" value="<?php echo $get_page->covers_cat_seo; ?>">
            ...
            <div class="control-group <?php if(form_error('covers_cat_order_by')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input class="input-mini" type="text" id="covers_cat_order_by" name="covers_cat_order_by" value="<?php echo $get_page->covers_cat_order_by; ?>">
                    <span class="help-inline"><?php echo form_error('covers_cat_order_by'); ?></span>
                </div>
            </div>
            
            <input type="hidden" name="id" value="<?php echo $get_page->covers_cat_id; ?>" />
