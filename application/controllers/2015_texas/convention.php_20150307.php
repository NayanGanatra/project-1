	...
	function registration()
	{
		...
		else
		{
				...
				$data=array(
					...
					$mm_id_text = 'L M - <b style=" border-bottom:0px solid #000; padding-bottom:3px;">'.$this->input->post('mm_id').'</b>';
            ...
            $con_title = $settings->ch_name.' Convention '.$settings->ch_year;   
				...
				$final_message = array('name' => '', 'sitename'=> $settings->cs_sitename, 'user_email' => $email, 'con_hdn_ch_name' => '', 'con_hdn_reg_number' => $rand, 'con_hdn_lm_number' => $mm_id_text, 'con_hdn_last_name' => $lname, 'con_hdn_first_name' => $fname, 'con_hdn_addr' => $address, 'con_hdn_city' => $mm_city_name, 'con_hdn_state' => $mm_state_name, 'con_hdn_phnH' => $phoneh, 'con_hdn_phnC' => $phonec, 'con_hdn_email' => $email, 'zipcode'=> $zipcode, 'con_hdn_payment_method' => $payment_type, 'con_em_name' => $con_name, 'con_em_number' => $con_number, 'member' => $mem_html, 'event' => $event_html, 'total_fees' => $total, 'activities' => $activity_html, 'activity_fee' => $activity_fee, 'logo' => $settings->cs_logo, 'logo2' => $settings->cs_logo2, 'con_title' => $con_title, 'life_member_text' => $life_member_text);
	   ...
	   if(empty($_POST['confirmCaptcha']))
		...
		else
		{
            ...
            $con_title = $settings->ch_name.' Convention '.$settings->ch_year;   	
				...
				$final_message = array('name' => '', 'sitename'=> $settings->cs_sitename, 'user_email' => $email, 'con_hdn_ch_name' => '', 'con_hdn_reg_number' => $rand,'con_hdn_lm_number' => 'N/A', 'con_hdn_last_name' => $lname, 'con_hdn_first_name' => $fname, 'con_hdn_addr' => $address, 'con_hdn_city' => $city, 'con_hdn_state' => $get_state->state_name, 'con_hdn_phnH' => $phoneh, 'con_hdn_phnC' => $phonec, 'con_hdn_email' => $email, 'zipcode'=> $zipcode, 'con_hdn_payment_method' => $p_type, 'con_em_name' => $con_name, 'con_em_number' => $con_number, 'member' => $mem_html, 'total_fees' => $total, 'activities' => $activity_html, 'activity_fee' => $activity_fee, 'logo' => $settings->cs_logo, 'logo2' => $settings->cs_logo2, 'con_title' => $con_title, 'life_member_text' => $life_member_text);
