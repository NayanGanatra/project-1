...
<?php
		if ($query1)
		{
			...
			$id = $row->fees_st_id;
			$life_member = $row->fm_life_member;
...
Attendee will have a type of wrist-band and access to only his/her chosen menu for all three days of convention</td>
           ...
           <div style="float:left; " class="ped_l">
                SPCS Chapter:<b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php if($chapter != "" && $chapter != null) echo $chapter->ch_name; ?></b>
                </div>
           </td>
           <td style="width:60%;" colspan="2">
           <div style="float:left;" class="ped_l">
                 Life Member Number : <b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php if($chapter != "" && $chapter != null) echo "L M -".$chapter->mm_life_id; ?> </b>
                </div>
           </td>
           ...
           <td colspan="3">
           		<div style="float:left;" class="ped_l">
                Secondary Email : <b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php echo $row->fm_secondary_email; ?></b>
                </div>
           </td>
           </tr>
           <tr>
		   ...
		   <td colspan="3">
               ...
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:105px; float:left">Payment Type :</label><b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php  if($payment_method == "by_check") echo "Check"; else echo " Paypal"; ?></b>
                </div>
				</div>
				</div>
           </td>
		   ...
		   <td colspan="3">
               ...
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:105px; float:left">Payment Staus :</label><input type="checkbox"  name="payment_status_check" <?php if($payment_status == 1) echo "checked"; ?>>
                </div>
				</div>
				</div>
           </td>
		   </tr>
		   <?php if($life_member == 1): ?>
		   <tr>
		   <td colspan="3">
           		 <div style="float:left;" class="ped_l">
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:155px; float:left">Life Time Member Ship :</label><b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php if($life_member == 1) echo "YES"; ?></b>
                </div>
				</div>
				</div>
           </td>
   ...
   <?php if(form_error('name[]') || form_error('rel[]') || form_error('age[]') || form_error('menu_ch[]') || form_error('age_grp[]') || form_error('fees[]')) { ?>
			...
			<input type="hidden" id="fees_total" name="fees_total" value="<?php if($life_member == 1) echo "250"; else "0"; ?>">
...
function ageof()
{
	...
	<?php if($life_member == 1) {?> t += 250; <?php } ?>
	document.getElementById('fees_total').value=t;
}
