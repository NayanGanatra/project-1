...
class Forgotpassword extends CI_Controller {
...

	{
...

		{
			...
			$this->email->message($this->parser->parse('admincp_convention_texas/user/forgot_parser', $final_message , TRUE));
			...
			//echo $this->email->print_debugger();
				...
				redirect($this->config->item('url').'admincp_convention_texas/login');
...

			{
				...
				redirect($this->config->item('url').'admincp_convention_texas/forgotpassword');
		...
		$this->load->view('admincp_convention_texas/user/forgotpassword',$data);
...

	{
...

		{
			...
			$this->email->message($this->parser->parse('admincp_convention_texas/user/newpass_parser', $final_message , TRUE));
