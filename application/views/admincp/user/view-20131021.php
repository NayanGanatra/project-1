            ...
            <div class="span5 offset sub_link" align="right">
				...
				<div class="control-group <?php if(form_error('keywords')){ echo "error";}?>">
					...
					<div class="controls">
                        ...
                        <input style="margin-top:10px;" class="input-large" type="text" id="search" name="search" placeholder="Search by name, username or email" value="<?php echo $this->session->userdata('search'); ?>">
