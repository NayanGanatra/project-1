                    ...
                    <td>
						<span class="span3">
                            <label class="checkbox">
                                 ...
                                 <input <?php $ch_to_template = $this->dbadminheader->ch_to_template($get_template->template_id,$chapter_row->ch_id); if($ch_to_template){echo 'checked="checked"'; }?>  type="checkbox" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>" />  <?php echo $chapter_row->ch_name; ?>
