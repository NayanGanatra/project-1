  ...
  <tr>
  	<td>
           ...
           <td>
                ...
                <span class="validation_star">*</span>Last name : <!--<b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php //echo $chapter->mm_lname; ?></b>-->
           ...
           <td>
                 ...
                 <span class="validation_star">*</span>First Name :  <!--<b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php //echo $chapter->mm_fname; ?></b>-->
           ...
           <td>
                ...
                <span class="validation_star">*</span>Address : <!--<b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php //echo $chapter->mm_address; ?></b>-->
           ...
           <td>
                ...
                <span class="validation_star">*</span>Phone No (H) : 
                <input type="text" placeholder="Enter Phone - 1234567890" style="width:200px; margin:0;"  id="txtphoneh" name="txtphoneh" value="<?php echo set_value('txtphoneh'); ?>"/>
                </div>
           </td>
           <td>
           		 <div style="float:left;" class="ped_l <?php if(form_error('txtphonec')) echo 'error';?>">
                <span class="validation_star">*</span>Phone No (C) :<br/>
                <input type="text" placeholder="Enter Phone - 1234567890" style="width:200px; margin:0;"  id="txtphonec" name="txtphonec" value="<?php echo set_value('txtphonec'); ?>"/>
                </div>
           </td>
            <td>
           ...
           <td colspan="1">
                ...
                <span class="validation_star">*</span>Email :<br/> 
		    ...
		    <td>
           		<div   class="ped_l <?php if(form_error('txtemail2')){ echo "error";}?>">
                Secondary Email : <br/>
            ...
            <td>
                ...
                <span class="validation_star">*</span>City : 
                <input type="text" name="mm_city_id" id="mm_city_id" placeholder="Enter City" value="<?php echo set_value('mm_city_id'); ?>" />
           ...
           <td colspan="1">
            	...
            	<div class="controls">
				<span class="validation_star">*</span>Emergency Contact Name: <br/><input type="text" style="width:200px; margin:0;" placeholder="Enter name" name="txtem_con_name" value="<?php echo set_value('txtem_con_name'); ?>"/>
				</div>
				</div>
                </div>
           </td>
		   ...
		   <td>
               ...
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:68px; float:left"><span class="validation_star">*</span>Phone : </label><br/><input type="text" style="width:200px; margin:0;" placeholder="Enter number" name="txtem_con_number" value="<?php echo set_value('txtem_con_number'); ?>"/>
		   ...
		   <td colspan="3">
           		 <div class="ped_l" style="margin-top:10px;">
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:190px; float:left; color:#ff7200; "><b>Become A Life Member :</b></label>
				<input type="checkbox" name="txtem_life_member" id="txtem_life_member" <?php if(set_value('txtem_life_member') == '1'){ ?> checked="checked" <?php } ?> class="checkbox_check" onchange="add_in_total()" style="vertical-align: sub;"/> ($250)
				<?php //echo set_value('txtem_life_member'); ?>
                </div>
				</div>
				</div>
           </td>
           ...
           <div style="width:100%; line-height:20px; margin:20px 0 5px 0px;  ">
                 ...
                 Please list and fill all details about each person registering for Convention (Including Registrant) <br /> Click on + sign to add additional attendees
           ...
           <div style="width:100%;  ">
			...
			<input type="hidden" value="<?php echo $chapter->mm_id; ?>" name="hdnids[]" class="hdnids"/>
				...
				<table width="95%" border="0" class="add_rm_before age-Group" style="margin-left:1.1%" >
					<tr>
			 ...
			 echo $total_mem_age_fee_total;
                    ...
                    <td width="24.1%"style="padding:6px;">
                     <input class="toclear " type="text" id="name[]" name="name[]" style=" width:99%; margin:0; padding:0;" value="<?php echo $total_mem_name[$i]; ?>"/>
                    </td>
          ...
          <select class="toclear guest rel rel_<?php echo $i; ?>" type="text" id="rel[]" name="rel[]" style="width:97%; margin:0; padding:0;height:22px;" onchange="ageof();" >
            ...
            <option value="Other" <?php if($total_mem_rel[$i] == "Other") { ?>selected="selected"<?php } ?> >Other</option>
                    ...
                    <td width="12%" style="padding:6px;">
                     <input class="toclear bod" onblur="datediff(this.value,this.id);" type="text" id="bod_<?php echo $i; ?>" name="bod[]" value="<?php echo $total_mem_bod[$i]; ?>" placeholder="YYYY" style=" width:99%; margin:0; padding:0;" />
                    </td>
                    <td  width="7%" style="padding:6px;">
                  <input class="toclear age" onkeyup="ageof()" id="age_<?php echo $i; ?>" onkeypress="ageof();" onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" id="age[]"  name="age[]"  type="text" value="<?php echo $total_mem_age[$i]; ?>"  style=" width:98%; margin:0; padding:0;"/>
                    
                    <input type="hidden" id="" value="">
                    </td>
                    <td width="15%" style="background-color:#7d7d7d;  padding:6px;">
                    <select class="toclear" id="menu_ch[]" name="menu_ch[]" style=" width:97%; margin:0; padding:0;height:22px;">
                    <option value="T" <?php if($total_mem_age_group[$i] == "T") echo "selected"; ?>>T</option>
                    <option value="C" <?php if($total_mem_age_group[$i] == "C") echo "selected"; ?>>C</option>
                    </select>
					...
					$total +=$amount;
					?>
                     <input class="toclear fees"  id="age_grp[]" name="age_grp[]" readonly=""  type="text" value="<?php echo $total_mem_age_group[$i]; ?>"  style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    <td width="10%" style="background-color:#b4b4b4; padding:6px;">
					<input class="toclear fees"  id="fees[]" readonly="" name="fees[]" type="text" readonly="" value="<?php echo $total_mem_age_fee[$i]; ?>"  style="width: 99%; margin: 0px; padding: 0px; text-align: right;"/>
                    </td>
				  ...
				  <a title="Add New Field" onclick="addNewField(this);" class="anchor_add_remove">
					...
					<a title="Remove This Field" onclick="removeThisField(this);" class="anchor_add_remove" style="<?php if($i > 0){echo 'display:block;';}else{ echo 'display:none;'; } ?>">
			 ...
			 ?>
			 	...
			 	<table width="95%" border="0" class="add_rm_before age-Group" style="margin-left:1.1%;">
                      <tr>
                          <td width="81%" style="color:#271471; text-align:right; padding-right:8px; color:#dd0e78;"><b>Total</b></td>
                          
                          <td width="9.4%" style="text-align:center; padding:6px;">
                          <input type="text" id="fees_total" readonly="readonly" name="fees_total" value="<?php echo $total_mem_age_fee_total; ?>" style="width: 99%; margin: 0px; padding: 0px; text-align: right;"/>
                          </td>                  
                      </tr>    
                </table>	
                  </div>
             ...
             <!-------------------------update-nirav20150120------------------------------>
		<?php /*$event_res = $this->dbconvention_registrationall->get_event_data(); 
		print_r($event_res);*/
		?>	 
<table  border="0" cellspacing="0" cellpadding="0" align="center" style=""> 
  <tr>
  	<td >
         <span style="font-weight: bold;  padding:6px; ">Activity Registration</span>
				 ...
				 <table class="tbl_class1 age-Group"  border="0" cellspacing="0" cellpadding="0" style="width:95%; margin-right:35px; margin-left: 6px;  text-align:center;" align="center"> 
					<tr>
						...
						<th class="tdfees title-bor" style="width:200px;  padding:8px 0;">Participant</th>
            <th class="tdfees title-bor" style="width:100px;  padding:8px 0;">T-Shirt Size</th>
			 ...
			 ?>
					<tr class="trodd ">
						...
						<td class="tdaligncenter" style="text-align:left !important; padding-left:8px;"><a style="  color:#271471; " href="<?php echo base_url()."2015/texas/convention/detail_page/9"; ?>" id="activity_link"><?php echo $itemsgroup->ce_activity; ?></a></td>

						<td class="tdaligncenter"><label style="line-height:32px; display:inline;"><input type="text" class="tdtxt" style="width: 20px; margin: 6px;padding:0 3px; " value="<?php echo set_value('txtpcount[]'); ?>" name="txtpcount[]" id="txtpcounta" onkeyup="ageoftotal();" onchange="ageoftotal();" onmouseout="ageoftotal();" onkeypress="return isNumber(event)"/>x $</label><?php echo $itemsgroup->ce_age_fee; ?>
            ...
            <td><?php $set_tshirt_size = set_value('tshirt_size[]'); ?><select style="width:100px;" name="tshirt_size[]">
              ...
              <option  <?php if($set_tshirt_size == "AXXL") { echo 'selected'; } ?> value="AXXL">AXXL</option>
						...
						<td class="tdaligncenter" style="padding:0 6px;"><input type="text" value="0" style="margin-bottom: 0px; width: 106px; text-align: right; padding:0 3px;" name="amount[]" readonly="" id="amount_event"/> </td>
					</tr> <?php }}?>
					<tr class="treven">
				  		<td colspan="3"><b style="float: right; margin-right: 5px; color:#dd0e78;padding:8px;">Total </b></td>
...
<div style="clear:both"></div>
             <div style=" margin-left: 20px;margin-top: 10px; float:left;"><span class="validation_star">*</span>Confirm Captcha <input size="40" type="text" name="confirmCaptcha" id="confirmCaptcha" value="" />
             
             </div>
			 <img  src="<?php  echo base_url().'images/captcha/'.$captcha['image']; ?>" style=" float:left; margin-left:10px;">
             
             <div style="clear:both;"></div>
             <div class="<?php if(form_error('confirmCaptcha')){ echo "error";}?>" style="margin-left: 20px;">
             ...
             <div style="   margin-left: 20px; text-align:center;">
             	<div class="pay_type" id="pay_type" style="">
				  ...
				  <!-- Vishal Comment 1/31/2015   <input type="radio" name="payment" id="check" value="by_check" style="vertical-align: sub;">Pay by CHECK -->
                     ...
                     <input style="margin-left:20px; vertical-align: sub;" checked="checked" type="radio" id="paypal" name="payment" value="by_paypal" >Pay by PAYPAL
...
function ageof()
{
  ...
  var rel = document.getElementsByName('rel[]');
	...
	document.getElementById('fees_total2').innerHTML=t;
