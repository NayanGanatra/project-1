...
<div class="toppest_header">
 ...
 <marquee direction="left" style="width:618px; float:left;" onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 4, 0);" >
 <ul>
...
<div class="container">
    ...
    <div class="span10 main_menu" align="right">
    	<ul class="lavaLamp">
            ...
            <li <?php if($this->uri->segment(1) == "user" || $this->uri->segment(1) == "members") { ?> class="current" <?php } ?>><a href="<?php echo base_url();?>members.html">Member Directory</a></li>
