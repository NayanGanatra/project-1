...
<div class="toppest_header">
 ...
 <marquee direction="left" onmouseover="this.setAttribute('scrollamount', 0, 0);" onmouseout="this.setAttribute('scrollamount', 4, 0);" > 
	<?php echo $query->page_latest_news; ?>   
 </marquee>
		...
		else
		{
           ...
           <span><?php echo $this->lang->line('text_welcome');?> </span> | 
            ...
            <div class="my-account-box">
              <div class="photo"><img src="<?php echo base_url(); ?>images/<?php echo $user->mm_photo;?>" height="40px" width="40px" alt="" /> </div>
              <div class="text"><span><?php echo $user->mm_username;?></span>
              <?php 
			  	$get_occupations = $this->dbheader->get_occupations($user->occupation_id);
				echo $get_occupations->occupation_name;
              ?>
              </div>              
...
<div class="container">
    ...
    <a href="http://testsite.spcsusa.org/"><img title="SPCSUSA.ORG" src="../images/logo.png" /></a></div>
