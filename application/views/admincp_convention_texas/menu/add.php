            ...
            <div id="int_menu" class="control-group <?php if(form_error('menu_int_link')){ echo "error";}?>" style="display:none;float:left;width:auto;margin-left:20px;">
                ...
                <div class="controls">
                    ...
                    <select onchange="int_menu_show()" name="menu_int_link" style="width:auto" id="all_int_menu">
                    	...
                    	<option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/welcome" id="home">home</option>
                    	
                        <option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/registration" id="registration">registration</option>

                        <option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/program" id="program">program</option>
                        
                        <option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/medical" id="medical">medical</option>

                        <option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/eventmembership" id="event">event</option>

						<option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/sponsors" id="sponsors">sponsors</option>

                        <option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/pages" id="pages">pages</option>
             ...
             <div id="int_sponsors" class="control-group <?php if(form_error('int_sponsers')){ echo "error";}?>" style="float:left;width:auto;margin-left:20px;display:none;">
                ...
                <div class="controls">
                	<select name="int_sponsors" style="width:auto" id="">
                       ...
                       <option value="<?php echo base_url().$this->config->item('convention_texas_folder_with_slash')?>convention/sponsors/corporate'; ?>" id="">Corporate Sponsors</option>
