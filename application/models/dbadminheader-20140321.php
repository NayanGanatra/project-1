...
WHERE a.template_id='".$template_id."' AND c.ch_id='".$this->session->userdata('get_chapter_id')."' AND e.mm_status='1' AND e.mm_varify='1' AND e.mm_chapter_id='0'";
...
WHERE a.email_template_id='".$email_template_id."'";
	...
	$sql="SELECT * FROM member_master WHERE FIND_IN_SET(mm_id,'".$mm_id."') AND mm_varify='1' AND mm_status='1' AND mm_chapter_id='0' ORDER BY mm_id ASC LIMIT ".$offset.", ".$num."";
...
$sql="SELECT b.ch_name FROM chapter_to_state a, chapters b WHERE a.state_id = '".$mm_state_id."' AND b.ch_id = '".$this->session->userdata('get_chapter_id')."' LIMIT 1";
...

	{
		...
		$sql = "SELECT * FROM member_master WHERE FIND_IN_SET(mm_state_id,'".$mm_state_id."') AND mm_varify='1' AND mm_status='1'  AND mm_chapter_id='0'";
...

	{
		...
		$sql="SELECT * FROM member_master WHERE  `mm_username` LIKE '%".$mm_id."%'  AND mm_varify='1' AND mm_status='1' AND mm_chapter_id='0'";
...

	{
		 ...
		 $sql="select * from  member_master where mm_id='".$mem_id."' AND FIND_IN_SET(mm_id,'".$mm_id."') AND mm_varify='1' AND mm_status='1'  AND mm_chapter_id='0'";
...
AND e.mm_chapter_id = '0'";
	...
	function count_user_search($search_key,$member_id,$event_id,$mm_type)
...
if($mm_type==0)
	...
	function get_all_user_search($search_key,$offset,$num,$member_id,$event_id,$mm_type)
	{
		if($mm_type==0)
		{
			if($search_key=='0')
			{
				$sql="SELECT * FROM member_master WHERE FIND_IN_SET(mm_id,'".$member_id."') AND mm_varify='1' AND mm_status='1' AND mm_chapter_id='0' ORDER BY mm_id ASC LIMIT ".$offset.", ".$num."";
...
WHERE c.ch_id='".$this->session->userdata('get_chapter_id')."'";
...

	{
	 ...
	 $sql="SELECT * FROM member_master WHERE FIND_IN_SET(mm_id,'".$mm_id_set."') AND mm_id='".$mm_id."' AND mm_varify='1' AND mm_status='1' AND mm_chapter_id='0' ORDER BY mm_id ASC LIMIT 1";
	...
	$sql="SELECT * FROM member_master WHERE FIND_IN_SET(mm_id,'".$mm_id."') AND mm_varify='1' AND mm_status='1' AND mm_chapter_id='0' ORDER BY mm_id ASC";
