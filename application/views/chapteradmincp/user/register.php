...
<div class="span10" style="margin:-10px 0 0 0;">
		...
		<span class="span5">            
           ...
           <div class="control-group <?php if(form_error('mm_username')){ echo "error";}?>">
			...
			<?php echo $this->lang->line('text_email');?></label>
               ...
               <!-- /*edit*/-->
                ...
                <?php
					...
					if($this->uri->segment(4)){
						...
						$cur_user = $this->dbadminheader->user_details_by_id($this->uri->segment(4));
...
<?php /*?><div class="span3" style=" margin-left:20px; margin-top:-20px;">
