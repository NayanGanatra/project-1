  ...
  <tr>
  	<td>
		<div class="dotted_line">
		        <h1>Member Blog <small>Manage</small></h1>
		</div>
		<a style="float:right;" href="<?php echo base_url(); ?>chapteradmincp/blog/mem_add">
		  ...
		  foreach ($query as $row)
		   {
		    ...
		    <tr>
		        ...
		        <td>
				<a href="<?php echo base_url('chapteradmincp/blog/mem_edit/'.$row->bid);?>" title="Edit"><i class="icon-edit"></i></a>
				<a href="<?php echo base_url('chapteradmincp/blog/mem_delete/'.$row->bid);?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
    			</tr>
