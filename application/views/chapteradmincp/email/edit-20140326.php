...
';?>">
			...
			?>
        			...
        			<input type="hidden" id="" name="email_modified_by" value="<?php echo $username->mm_username;?>">
...

{
...

	{
...

		{
			...
			//url: BASE_URI+"chapteradmincp/email/user_check_uncheck_all/edit/"+uid+"/"+n_ch+"/true/"+type+"/"+$('#offset').val(),
...
/////////////////////////////////////////////////////////////////////////end//////////////////////////////////////////////
...

	{
...

		{
			...
			//url: BASE_URI+"chapteradmincp/email/user_check_uncheck_all/edit/"+uid+"/"+n_ch+"/false/"+type+"/"+$('#offset').val(),
...
$('div#custom_box').addClass("custom_box_css");
	...
	url: BASE_URI+"chapteradmincp/email/user_check_uncheck/edit/"+uid+"/"+m_id+"/"+action,
...
$('div#custom_box').addClass("custom_box_css");
	...
	for (var i = 0, l = ln_user; i < l; i++) {
		...
		$.ajax({
		  ...
		  url: BASE_URI+"chapteradmincp/email/edit_user/<?php echo $item->uid; ?>/"+n_chapter+"/"+j_user,
