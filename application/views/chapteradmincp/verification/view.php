				...
				<?php 
...

					{
						...
						{?>
						  ...
						  <a href="<?php echo base_url().'chapteradmincp/verification/queue_mail/'.$row->uid;?>" title="send"><b>Send</b></a>
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'chapteradmincp/verification/start_mail/'.$row->uid;?>" ><center>start</center></a></div> 
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'chapteradmincp/verification/stop_mail/'.$row->uid;?>" ><center>stop</center></a></div> 
						...
						{?>
							...
							<div  id="stop"  ><a href="<?php echo base_url().'chapteradmincp/verification/resume_mail/'.$row->uid;?>" ><center>Resume</center></a></div> 
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
		  ...
		  url: BASE_URI+"chapteradmincp/verification/cron_check/"+uid,
...
$('div#custom_box').removeClass("custom_box_css");
...

					{
						...
						var url = "<?php echo base_url().'chapteradmincp/verification/edit/'?>"+uid;    
...

						{
							...
							var url = "<?php echo base_url().'chapteradmincp/verification/delete/'?>"+uid;    
