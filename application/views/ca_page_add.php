...
<div class="span10 nomargin">
	<div class="page_content">
		<?php $this->load->view('action_status'); ?>
                ...
                <div class="controls">
                <input class="input-xxlarge" type="text" id="page_title" name="page_title" placeholder="Page Title" value="<?php echo set_value('page_title'); ?>">
                ...
                <div class="span5 nomargin">
                    ...
                    <div class="controls">
                    <input class="input-xlarge" type="text" id="sub_title" name="sub_title" placeholder="Sub Title" value="<?php echo set_value('sub_title'); ?>">
                ...
                <div class="span5">
                    ...
                    <div class="controls">
                    <input class="input-xlarge" type="text" id="page_menu_name" name="page_menu_name" placeholder="Menu Name" value="<?php echo set_value('page_menu_name'); ?>">
                ...
                <div class="span4 nomargin">
                    ...
                    <div class="controls">
                    <input class="input-xlarge" type="text" id="page_seo" name="page_seo" placeholder="URL Slug" value="<?php echo set_value('page_seo'); ?>">
                ...
                <div class="span2">
                    ...
                    <div class="controls">
                    <input class="input-small" type="text" id="page_order" name="page_order" placeholder="Page Order" value="<?php echo set_value('page_order'); ?>">
                    ...
                    <div class="controls">
                        <select name="page_status" style="width:100px;">
                            <option <?php if(set_value('page_status') == 1){echo 'selected="selected"'; }?> value="1">Active</option>
                            <option <?php if(set_value('page_status') == 2){echo 'selected="selected"'; }?> value="0">Archived</option>
                        </select>
                ...
                <div class="span10 nomargin">
                    ...
                    <div class="controls">
                    <input type="hidden" name="page_ch_id" value="<?php echo $chapter->ch_id; ?>" />
