  ...
  <tr>
  	<td>
		   ...
		   <td colspan="3">
               ...
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:190px; float:left; color:#ff7200; "><b>Become A Life Member :</b></label><input type="checkbox" name="txtem_life_member" id="txtem_life_member" <?php if(set_value('txtem_life_member') == '1'){ ?> checked="checked" <?php } ?> class="checkbox_check" onchange="add_in_total()" style="vertical-align: sub;"/> ($250)
