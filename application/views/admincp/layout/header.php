                ...
                <div class="container" style="width:100%">
                  ...
                  <div class="nav-collapse subnav-collapse">
                    ...
                    <ul class="nav pull-right">
                      ...
                      <li class="dropdown <?php if($this->uri->segment(2) =='media'){echo 'active';}?>">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="<?php echo base_url(); ?>admincp/template/view">Manage Email Template</a></li>

                          <li><a href="<?php echo base_url(); ?>admincp/template/add">Add Email Template</a></li>

						  <li class="divider"></li>

						  <li><a href="<?php echo base_url(); ?>admincp/email/view">Manage Mass Email</a></li>

                           <li><a href="<?php echo base_url(); ?>admincp/email/add">Add Mass Email</a></li>

						   <li class="divider"></li>

						   <li><a href="<?php echo base_url(); ?>admincp/verification/view">Manage Member verification Email</a></li>

                          <li><a href="<?php echo base_url(); ?>admincp/verification/add">Add Member verification Email</a></li>
					  ...
					  <li class="dropdown <?php if($this->uri->segment(2) =='polls'){echo 'active';}?>">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="<?php echo base_url(); ?>admincp/polls/view">Manage Polls</a></li>

                          <li><a href="<?php echo base_url(); ?>admincp/polls/add">Add Polls</a></li>
                     ...
                     <li class="dropdown <?php if($this->uri->segment(2) =='Vendor' || $this->uri->segment(2) =='category'){echo 'active';}?>">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="<?php echo base_url(); ?>admincp/vendor/view">Manage Vendors</a></li>

                          <li><a href="<?php echo base_url(); ?>admincp/vendor/add">Add vendors</a></li>

                           <li class="divider"></li>

                           <li><a href="<?php echo base_url(); ?>admincp/category/view">Category</a></li>
                   ...
                   <!-------monita20130627-------->
                      ...
                      <li class="dropdown <?php if($this->uri->segment(2) =='pages' || $this->uri->segment(2) =='latestnews'){echo 'active';}?>">
                        ...
                        <li><a href="<?php echo base_url(); ?>admincp/latestnews/view">Manage Latestnews</a></li>

                         <li><a href="<?php echo base_url(); ?>admincp/latestnews/add">Add Latestnews</a></li>
                       ...
                       <li class="divider"></li>
							 <li><a href="<?php echo base_url(); ?>admincp/pages/chapter_view">Manage Chapter Pages</a></li>
                        <li><a href="<?php echo base_url(); ?>admincp/pages/add_chapter/0">Add New Chapter Page</a></li>
                      ...
                      <li class="dropdown <?php if($this->uri->segment(2) =='user'){echo 'active';}?>">
                        ...
                        <?php $not_varify=$this->dbadminheader->count_user_not_varify(); if($not_varify){ echo "(<b>".$not_varify."</b>)";}?>Members <b class="caret"></b></a>
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="<?php echo base_url(); ?>admincp/user/newsletter">Manage Newsletter</a></li>
						...
						<li class="divider"></li>
						<li><a href="<?php echo base_url(); ?>admincp/forum/view">Manage Forum</a></li>
                        <li><a href="<?php echo base_url(); ?>admincp/forum/add">Add Forum</a></li>
						<!--update end-->
                        </ul>

                      </li>

                      <!--update pradip 2014/01/30-->
                      <li class="dropdown <?php if($this->uri->segment(2) =='convention'){echo 'active';}?>">

                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Convention <b class="caret"></b></a>

                        <ul class="dropdown-menu">

                          <li><a href="<?php echo base_url(); ?>admincp/convention/view">Manage convention</a></li>

                          <li><a href="<?php echo base_url(); ?>admincp/convention/add">Add convention</a></li>
                      ...
                      <li class="dropdown <?php if($this->uri->segment(2) =='password'){echo 'active';}?>">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a href="<?php echo base_url(); ?>admincp/help" target="_blank">Help?</a></li>
						<!--		end-->
