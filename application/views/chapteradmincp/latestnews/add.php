  	...
  	<td>
        ...
        <div class="control-group <?php if(form_error('latest_news_tab')){ echo "error";}?>">
        	Open in new tab
				...
				<input class="" type="checkbox" id="covers_cat_name" name="latest_news_tab" value="1" style="margin-top:-2px;margin-left:20px;">
       ...
       <div class="space10px"></div>
        ...
        <?php 
			...
			{		
		?>
        		<input type="hidden" id="" name="latest_news_created_by" value="<?php echo $username->mm_username;?>">
        <?php
			}
        ?>
