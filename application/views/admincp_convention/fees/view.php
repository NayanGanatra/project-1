		  ...
		  foreach ($query as $row)
		   {
		    ...
		    <tr>
		        ...
		        <td>
				<a href="<?php echo base_url('admincp_convention/fees/edit/'.$row->fees_st_id);?>" title="Edit"><i class="icon-edit"></i></a>
				<!--<a href="<?php //echo base_url('admincp_convention/fees/delete/'.$row->fees_st_id);?>" title="Delete"><i class="icon-minus-sign"></i></a>--></td>
    			</tr>
