        ...
        <div class="control-group <?php if(form_error('menu_type')){ echo "error";}?>" style="float:left;width:auto;">
                ...
                <div class="controls">
                    ...
                    <select name="menu_type" onchange="menu_type_val(this.value)" style="width:100px;">
						...
						<option <?php if(set_value('menu_type') == '0') { ?> selected="selected" <?php } ?> value="0" id="">Internal</option>

                        <option <?php if(set_value('menu_type') == '1') { ?> selected="selected" <?php } ?> value="1" id="">External</option>
            ...
            <div id="int_menu" class="control-group <?php if(form_error('menu_int_link')){ echo "error";}?>" style="display:none;float:left;width:auto;margin-left:20px;">

            	<label class="control-label" for="inputError">Internal Menu</label>

                <div class="controls">

                    <select onchange="int_menu_show()" name="menu_int_link" style="width:auto" id="all_int_menu">
                    
                    	<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/welcome" id="home">home</option>
                    	
                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/registration" id="registration">registration</option>

                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/program" id="program">program</option>
                        
                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/medical" id="medical">medical</option>

                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/eventmembership" id="event">event</option>

						<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/sponsors" id="sponsors">sponsors</option>

                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/pages" id="pages">pages</option>
            ...
            <div id="int_pages" class="control-group <?php if(form_error('int_page')){ echo "error";}?>" style="float:left;width:auto;margin-left:20px;display:none;">
             ...
             <div id="int_sponsors" class="control-group <?php if(form_error('int_sponsers')){ echo "error";}?>" style="float:left;width:auto;margin-left:20px;display:none;">
                ...
                <div class="controls">
                	<select name="int_sponsors" style="width:auto" id="">
                       ...
                       <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/sponsors/corporate'; ?>" id="">Corporate Sponsors</option>
            ...
            <div id="menu_link" class="control-group <?php if(form_error('menu_ext_link')){ echo "error";}?>" style="display:none;float:left;margin-left:20px;">

			<label class="control-label" for="inputError">Menu Link</label>

				<div class="controls">

                    <input class="input-xxlarge" type="text" id="covers_cat_name" name="menu_ext_link" value="<?php echo set_value('menu_ext_link'); ?>" placeholder="Enter Menu Name">
</br>
             ...
             <a id="" title="Add New Field" onclick="addNewField(this);">
                ...
                <table width="100%"   border="1" >
                   ...
                   <select class="submenuclass toclear" id="sub_menu_type-<?php echo $i;?>" name="sub_menu_type[]" onchange="show1(this.value,this.id);" style="width:99.5%;margin:0; padding:0;height:22px;">
                   	 ...
                   	 <option <?php if(set_value('sub_menu_type[]') == '0') { ?> selected="selected" <?php } ?> class="sub1"  value="0" id="sub_internal-<?php echo $i;?>">Internal</option>

					 <option <?php if(set_value('sub_menu_type[]') == '1') { ?> selected="selected" <?php } ?> class="sub2"  value="1" id="sub_external-<?php echo $i;?>">External</option>
