  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1>Fees structure <small>Add</small></h1>
		</div>
        <hr>
            <?php
...
Attendee will have a type of wrist‐band and access to only his/her chosen menu for all three days of convention</td>
					...
					<tr>
				  		<td class="tdfees"><input type="text" id="txtmenu1" class="tdtxt" name="txtmenu1" value="<?php echo set_value('txtmenu1'); ?>"/></td>
						<td><input type="text" id="txttrad" class="tdtxt" name="txttrad" value="<?php echo set_value('txttrad'); ?>" style="width:98%;"/></td>
					</tr>
					<tr>
				  		<td class="tdfees"><input type="text" id="txtmenu2" class="tdtxt" name="txtmenu2" value="<?php echo set_value('txtmenu2'); ?>"/></td>
						<td><input type="text" id="txtcont" class="tdtxt" name="txtcont" value="<?php echo set_value('txtcont'); ?>" style="width:98%;"/></td>
					</tr>
				</table>
				 <div class="space10px"></div> 
				 <table  border="1" cellspacing="0" cellpadding="5" style="min-height:300px; width:930px; background-color:#CCEBFF;"> 
					...
					<tr>
				  		<td class="tdfees" colspan="2"><span style="float: left; padding-top: 4px;">Post Marked by</span> <input type="text" id="txtdate" class="tdtxt" name="txtdate" value="<?php echo set_value('txtdate'); ?>" style="width:50%; float:left; margin-left:5px;"/></td>
						<td class="tdfees" colspan="2">After <span id="txtdateafter"></span></td>
					</tr>
					<tr>
					...
					<tr>
				  		<td><b>A</b> – Kids under <span id="txtchildage">6</span> years old</td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtchildfee" value="0"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtnonchildfee" value="0"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtchildlatefee" value="0"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtnonchildlatefee" value="0"/></td>
					</tr>
					<tr>
				  		<td><b>B</b> – Kids and Young Adults <input type="text" id="txtyoungagefrom" class="tdtxt" name="txtyoungagefrom" value="6" style="width:20px;"/>-<input type="text" id="txtyoungageto" class="tdtxt" name="txtyoungageto" value="25" style="width:20px;" /> years</td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtmemfee" value="<?php echo set_value('txtmemfee'); ?>"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtnonmemfee" value="<?php echo set_value('txtnonmemfee'); ?>"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtmemlatefee" value="<?php echo set_value('txtmemlatefee'); ?>"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtnonmemlatefee" value="<?php echo set_value('txtnonmemlatefee'); ?>"/></td>
					</tr>
					<tr>
				  		<td><b>C</b> – Adults <span id="txtadultage">26</span> years and up</td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtmemfeeadult" value="<?php echo set_value('txtmemfeeadult'); ?>"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtnonmemfeeadult" value="<?php echo set_value('txtnonmemfeeadult'); ?>"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtmemlatefeeadult" value="<?php echo set_value('txtmemlatefeeadult'); ?>"/></td>
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;">$</label><input type="text" class="tdtxt" name="txtnonmemlatefeeadult" value="<?php echo set_value('txtnonmemlatefeeadult'); ?>"/></td>
					</tr>
					<tr>
