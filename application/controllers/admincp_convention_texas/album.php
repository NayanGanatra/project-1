...

{
...

	{
		...
		$this->load->model('admincp_convention_texas/dbalbum');
...

	{
		...
		$config['base_url'] = base_url().'admincp_convention_texas/album/view/';
		...
		$this->load->view('admincp_convention_texas/album/view',$data);
...

	{
		...
		else
	    {
			...
			redirect(base_url().'admincp_convention_texas/album');
		}

		$data['title']='Add Media';

		$this->load->view('admincp_convention_texas/album/add',$data);
...

	{
		...
		$this->load->view('admincp_convention_texas/album/edit',$data);
...

	{
...

		{
			...
			redirect(base_url('admincp_convention_texas/album/view'));
