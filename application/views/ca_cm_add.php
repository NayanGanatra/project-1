...
<div class="span10 nomargin">
	<div class="page_content">
		<?php $this->load->view('action_status'); ?>
                ...
                <select name="cm_mm_id" data-placeholder="Select a Member..." class="chzn-select" style="width:285px;" tabindex="1">
                  ...
                  <?php
					...
					foreach($members as $members_row)
					{
						...
						<option <?php if(set_value('cm_mm_id') == $members_row->mm_id) { ;?> selected="selected" <?php }?> value="<?php echo $members_row->mm_id; ?>"><?php echo $members_row->mm_fname.' '.$members_row->mm_lname; ?></option>
                        <?php 
					}
				  ?>                  
                </select>
                ...
                <div class="controls">
                <input class="input-small" type="text" id="cm_order" name="cm_order" placeholder="Order" value="<?php echo set_value('cm_order'); ?>">
