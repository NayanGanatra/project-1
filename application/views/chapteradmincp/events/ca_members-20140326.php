...
function chkalluser(uid,type)
{
	...
	if(status=='yes')
	{
		...
		if(id!='')
		{
			...
			url: BASE_URI+"chapteradmincp/events/user_check_uncheck_all/",
				data :'status=edit&id='+uid+'&ch_id='+n_ch+'&action=true&type='+type+'&offeset='+$('#offset').val()+'&mm_type='+mm_type,
	...
	else
	{
		...
		if(id!='')
		{
			...
			url: BASE_URI+"chapteradmincp/events/user_check_uncheck_all/",
			data :'status=edit&id='+uid+'&ch_id='+n_ch+'&action=false&type='+type+'&offeset='+$('#offset').val()+'&mm_type='+mm_type,
				success: function(data) {
