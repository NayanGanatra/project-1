...
<div class="photogallery">
	...
	<div class="logo-text2"><img align="absmiddle" alt="" src="<?php echo base_url();?>images/youth_milan/register-icon.png">Search Profile</div>
	<!--updated by ketan 20130924-->	
	
	<table style="margin:auto; width:90%;" class="headertable" cellpadding="5">
	<tr>
		<th class="txtBlack13Arial"><strong>Gender</strong></th>
		<th class="txtBlack13Arial"><strong>Criteria</strong></th>
		</tr>
		<?php
    ...
    ?>
		...
		<span style="margin-left:2px;" class="txtBlack13Arial">Show profiles matching all the criteria</span><br />
		<input type="radio" name="rdcriteria" value='anycriteria'/>
		<span style="margin-left:2px;" class="txtBlack13Arial">Show profiles matching any of the criteria</span></td>
		</tr>
	<tr>
	<th class="txtBlack13Arial"><strong>Status</strong> </th>
	<th class="txtBlack13Arial"><strong>Body Type</strong></th>
	<th class="txtBlack13Arial"><strong>Height</strong></th>
	<th class="txtBlack13Arial"><strong>Weight</strong></th>
	</tr>
	...
	<th class="txtBlack13Arial"><strong>Religion</strong></th>
	<th class="txtBlack13Arial"><strong>Cast</strong></th>
	<th class="txtBlack13Arial"><strong>Sub Cast</strong></th>
	<th class="txtBlack13Arial"><strong>Name</strong></th>
	</tr>
	<tr>
	...
	<td class="txtBlack13Arial">
		...
		<tr>
		<th class="txtBlack13Arial"><strong>Age</strong></th>
		</tr>
		<tr>
	...
	<?php 
		...
		?>
			...
			<div style="background-color:#0088CC; color:#fff;line-height:35px; margin-top:15px; vertical-align:middle; width:95%;margin-left:26px; padding-left:11px; padding-top:4px">Profile Search Result</div>
				<ul class="table-grid">
								...
								<tr>
                						...
                						<tbody>
											<tr>
                								<td width="13%" valign="middle" align="center">
													<a title="<?php echo $photo1; ?>" href="<?php echo base_url(); ?>images/youth_milan/profile/big/<?php echo $photo1; ?>" rel="lightbox">
														<img onload="display_in_size(this.id)" style="display:none" id="profile_image_<?php echo $i;?>"  src="<?php echo base_url(); ?>images/youth_milan/profile/thumbs/<?php echo $photo1; ?>" />
														<img src="<?php echo base_url(); ?>images/youth_milan/loader.gif" style="display:block" id="img_loader_<?php echo $i;?>">
													</a>
												</td>
                 							</tr>
                 							<tr>
                 							...
                 							<tr>
												<td align="center">	
													<a class="LinksMainSite" href="<?php echo base_url(); ?>youth_milan/registration/more_detail/<?php echo $row->ym_id; ?>"> View Detail</a></td>
											</tr>
                 						</tbody>
										</table>
									</td>
                					...
                					<td width="85%">
                    					<table width="100%" cellspacing="0" cellpadding="2">
          								<tbody>
											<tr>
					                        	<td width="33%" valign="top" align="left" class="listText"><b>Name</b> : <?php echo $row->ym_name; ?></td>
					                            <td width="33%" valign="top" align="left" class="listText"><b>Gender</b> : <?php echo $row->ym_gender; ?></td>
					                            <td width="34%" valign="top" align="left" class="listText"><b>Marital Status</b> : <?php echo $row->ym_marital_status; ?></td>
                      						</tr>
                        					<tr>
					                        	<td width="33%" valign="top" align="left" class="listText"><b>Height</b> : <?php echo $row->ym_height." "."cms"; ?></td>
					                            <td valign="top" class="listText"><b>Weight</b> : <?php if($row->ym_weight!="0"){ echo $row->ym_weight." "."kgs / ".round($row->ym_weight*2.20462)." lbs";}else {echo "";} ?></td>
					                            <td valign="top" align="left" class="listText"><b>Occupation</b> : <?php $occupation=$this->dbyouthmilan->check_exists_id4($row->ym_id);
													if($occupation)
													{
					                        ...
					                        <tr>
					                            <td valign="top" class="listText"><b>Caste</b> : <?php $caste=$this->dbyouthmilan->check_exists_id2($row->ym_id);
													if($caste)
													{
														echo $caste->ym_caste;
													}
					                            ...
					                            <td valign="top" align="left" class="listText"><b>Age</b> : <?php $age=$this->dbyouthmilan->check_exists_id3($row->ym_id);
													if($age)
													{
														if($age->ym_age=="0")
														{
					                            ...
					                            <td valign="top" class="listText"><b>Education</b> : <?php $education=$this->dbyouthmilan->check_exists_id4($row->ym_id);
													if($education)
													{
														echo $education->ym_degree_level;
													}
													else
													{
														echo '';
	...
	<?php
		...
		?>
			<!--updated by ketan 20130924-->
			<div style="width: 92%;  background-color:#e0f3ff; color:000; line-height:40px;  margin-top:15px; padding-left:5%; margin-left:19px">
			No result found!!!
			</div>
...
function display_in_size(id)
{
	...
	$("#"+id).css("height",height1);  
	$("#"+id).css("width",width1);
	$("#img_loader_"+id1[2]).css("display","none");
