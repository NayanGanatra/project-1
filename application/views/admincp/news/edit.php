  ...
  <tr>
  	<td>
        ...
        <hr />
                ...
                <div class="controls">
                <input class="input-large" type="text" id="datetimepicker" name="news_create" placeholder="Date" value="<?php echo $query->news_create; ?>">
                        ...
                        <td>
                            <span class="span3">
                                <label class="checkbox">
                                     ...
                                     <input <?php $ch_to_news = $this->dbadminheader->ch_to_news($query->news_id,$chapter_row->ch_id); if($ch_to_news){echo 'checked="checked"'; }?>  type="checkbox" class="check" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>" />  <?php echo $chapter_row->ch_name; ?>
                ...
                <div class="controls">
                    <select name="news_status" style="width:100px;">
                        ...
                        <option <?php if($query->news_status == '0'){echo 'selected="selected"'; }?> value="0">Deactive</option>
                    </select>
                    <span class="help-inline"><?php echo form_error('news_status'); ?></span>
                </div>
            	</div>
                
                  <input type="hidden" name="news_id" value="<?php echo $query->news_id; ?>" />
                <div class="control-group">
                <div class="controls">
                <?php date_default_timezone_set("Asia/Kolkata"); ?>
                <input type="hidden" id="" name="news_created_date" value="<?php echo $query->news_created_date; ?>">
                <input type="hidden" id="" name="news_created_by" value="<?php echo $query->news_created_by; ?>">
                <input type="hidden" id="" name="news_modified_date" value="<?php echo date("Y-m-d H:i:s"); ?>">
                <input type="hidden" id="" name="news_modified_by" value="<?php echo 'admin';?>">
