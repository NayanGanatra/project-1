...
class Forgotpassword extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			$this->email->message($this->parser->parse('admincp/user/forgot_parser', $final_message , TRUE));
			...
			//echo $this->email->print_debugger();
				...
				redirect($this->config->item('url').'admincp/login');
			}
			else
			{
				...
				redirect($this->config->item('url').'admincp/forgotpassword');
			}
		}
	
	
		$data['title']=$this->lang->line('text_forgot_password');
		$this->load->view('admincp/user/forgotpassword',$data);
	}
	...
	function reset()
	{
		...
		if($get_data)
		{
			...
			$this->email->message($this->parser->parse('admincp/user/newpass_parser', $final_message , TRUE));
