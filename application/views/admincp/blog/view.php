		  ...
		  foreach ($query as $row)
		   {
		    ...
		    <tr>
		        ...
		        <td>
				<a href="<?php echo base_url('admincp/blog/edit/'.$row->bid);?>" title="Edit"><i class="icon-edit"></i></a>
				<a href="<?php echo base_url('admincp/blog/delete/'.$row->bid);?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
    			</tr>
