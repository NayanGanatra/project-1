  ...
  <tr>
  	...
  	<td>
        ...
        <div class="control-group <?php if(form_error('menu_type')){ echo "error";}?>" style="float:left;width:auto;">
            ...
            <div id="int_menu" class="control-group <?php if(form_error('menu_int_link')){ echo "error";}?>" <?php if($get_menu->menu_type == '0'){ ?> style="float:left;width:auto;margin-left:20px;" <?php }else {?> style="display:none;float:left;width:auto;margin-left:20px;" <?php } ?>>
                ...
                <div class="controls">
                    ...
                    <select name="menu_int_link" onchange="int_menu_show()" style="float:left;width:auto;" id="all_int_menu">
                    	...
                    	<option <?php if($get_menu->menu_type == '0' && $get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/welcome') { ?> selected="selected" <?php } ?>  value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/welcome" class="sub_home" id="home">home</option>
                    	
                        <option <?php if($get_menu->menu_type == '0' && $get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/registration') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/registration" id="registration">registration</option>

                        <option <?php if($get_menu->menu_type == '0' && $get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/program') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/program" id="program">program</option>
                       
                        <option <?php if($get_menu->menu_type == '0' && $get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/medical') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/medical" id="medical">medical</option>

                        <option <?php if($get_menu->menu_type == '0' && $get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/event') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/eventmembership" id="event">event</option>
				...
				?>
                		<option <?php if($get_menu->menu_type == '0' && $newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/sponsors" id="sponsors">sponsors</option>
                        
                        <option <?php if($get_menu->menu_type == '0' && $newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/pages" id="pages">pages</option>
            ...
            <div id="int_pages" class="control-group <?php if(form_error('int_page')){ echo "error";}?>" <?php if($get_menu->menu_type == '0' && $newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page') { ?> style="float:left;width:auto;margin-left:20px;" <?php } else { ?> style="float:left;width:auto;margin-left:20px;display:none;" <?php }?>>
                ...
                <div class="controls">
					...
					?>
                        ...
                        <option <?php if($get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page/'.$allpages->page_id) { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page/'.$allpages->page_id; ?>" id=""><?php echo $allpages->page_title; ?></option>
            ...
            <div id="int_sponsors" class="control-group <?php if(form_error('int_sponsors')){ echo "error";}?>" <?php if($get_menu->menu_type == '0' && $newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors') { ?> style="float:left;width:auto;margin-left:20px;" <?php } else { ?> style="float:left;width:auto;margin-left:20px;display:none;" <?php }?> >
                ...
                <div class="controls">
                	<select name="int_sponsors" style="width:auto" id="">
                       ...
                       <option <?php if($get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/all') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/all'; ?>" id="">Sponsors</option>
                    	
                       <option <?php if($get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/corporate') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/corporate'; ?>" id="">Corporate Sponsors</option>

                       <option <?php if($get_menu->menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/individual') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/individual'; ?>" id="">Individual Sponsors</option>
             ...
             <a id="" title="Add New Field" onclick="addNewField(this);">
                ...
                <table width="100%"   border="1" >
                   ...
                   <select class="submenuclass toclear" id="sub_menu_type-<?php echo $i;?>" name="sub_menu_type[]" onchange="show1(this.value,this.id);" style="width:99.5%;margin:0; padding:0;height:22px;">
                    ...
                    <select name="sub_menu_int_link[]" id="sub_menu_int_link-<?php echo $i;?>" class="submenuclass1" onchange="show(this.value,this.id);" style="width:40%;margin:0; padding:0;height:22px;">
                    	...
                    	<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/welcome" class="sub_home" id="sub_home-<?php echo $i;?>">home</option>
                    
                    	<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/registration" class="sub_registration" id="sub_registration-<?php echo $i;?>">registration</option>

                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/program" class="sub_program" id="sub_program-<?php echo $i;?>">program</option>
                        
                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/medical" class="sub_medical" id="sub_medical-<?php echo $i;?>">medical</option>

                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/eventmembership" class="sub_event" id="sub_event-<?php echo $i;?>">event</option>

						<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/sponsors" class="sub_sponsors" id="sub_sponsors-<?php echo $i;?>">sponsors</option>

                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash')?>convention/pages" class="sub_pages" id="sub_pages-<?php echo $i;?>">pages</option>
					...
					?>
                        ...
                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page/'.$allpages->page_id; ?>" id=""><?php echo $allpages->page_title; ?></option>
              ...
              <?php } ?>
                    ...
                    <select name="sub_int_sponsors[]" class="sub_int_sponsors" style="width:40%;margin:0; padding:0;height:22px;display:none;" id="sub_int_sponsors-<?php echo $i;?>">
						<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/all'; ?>" id="">Sponsors</option>
                        
                    	<option value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/corporate'; ?>" id="">Corporat Sponsors</option>
                    	
                        <option value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/individual'; ?>" id="">Individual Sponsors</option>
	   ...
	   ?>
             ...
             <a title="Add New Field" onclick="addNewField(this);">
				...
				<i class="icon-edit" style="background-position:0 -96px;float:right;margin-right:-20px;"></i>
                   ...
                   <select class="submenuclass toclear" id="sub_menu_type-<?php echo $i;?>" name="sub_menu_type[]" onchange="show1(this.value,this.id);" style="width:99.5%;margin:0; padding:0;height:22px;">
                    ...
                    <select name="sub_menu_int_link[]" id="sub_menu_int_link-<?php echo $i;?>" class="submenuclass1" onchange="show(this.value,this.id);" style="width:40%;margin:0; padding:0;height:22px;" id="">
                        ...
                        <option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/welcome') { ?> selected="selected" <?php } ?>  value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/welcome" class="sub_home" id="sub_home-<?php echo $i;?>">home</option>
                        
                        <option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/registration') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/registration" class="sub_registration" id="sub_registration-<?php echo $i;?>">registration</option>

                        <option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/program') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/program" class="sub_program" id="sub_program-<?php echo $i;?>">program</option>
                        
                        <option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/medical') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/medical" class="sub_medical" id="sub_medical-<?php echo $i;?>">medical</option>

                        <option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/eventmembership') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/eventmembership" class="sub_event"  id="sub_event-<?php echo $i;?>">event</option>
				...
				?>
                		<option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $sub_newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/sponsors" class="sub_sponsors" id="sub_sponsors-<?php echo $i;?>">sponsors</option>
                        
                        
                        <option <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $sub_newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash');?>convention/pages" class="sub_pages" id="sub_pages-<?php echo $i;?>">pages</option>

                    </select>
                    
                   <select name="sub_int_pages[]" class="sub_int_pages" <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $sub_newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page') { ?> style="width:40%;margin:0; padding:0;height:22px;" <?php } else { ?> style="width:40%;margin:0; padding:0;height:22px;display:none;" <?php } ?> id="sub_int_pages-<?php echo $i; ?>" >
					...
					?>
                        ...
                        <option <?php if($total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page/'.$allpages->page_id) { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/detail_page/'.$allpages->page_id; ?>" id=""><?php echo $allpages->page_title; ?> </option>
              ...
              <?php } ?>
                    ...
                    <select name="sub_int_sponsors[]" class="sub_int_sponsors" <?php if($total_submenu[$i-1]->sub_menu_type == '0' && $sub_newurl == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors') { ?> style="width:40%;margin:0; padding:0;height:22px;" <?php } else { ?> style="width:40%;margin:0; padding:0;height:22px;display:none;" <?php } ?> id="sub_int_sponsors-<?php echo $i;?>">
                    
						<option <?php if($total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/all') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/all'; ?>" id="">Sponsors</option>
                        
                    	<option <?php if($total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/corporate') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/corporate'; ?>" id="">Corporat Sponsors</option>
                    	
                        <option <?php if($total_submenu[$i-1]->sub_menu_link == base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/individual') { ?> selected="selected" <?php } ?> value="<?php echo base_url().$this->config->item('convention_folder_with_slash').'convention/sponsors/individual'; ?>" id="">Individual Sponsors</option>
