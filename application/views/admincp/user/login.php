...
<h1><?php echo $this->lang->line('text_admin_login');?></h1>

<p><?php echo $this->lang->line('text_admin_login_note');?></p>

<?php if(form_error('username') || form_error('password')) { ?>
<div class="alert alert-error"><?php echo form_error('username'); ?> <?php echo form_error('password'); ?></div>
<?php } ?>
