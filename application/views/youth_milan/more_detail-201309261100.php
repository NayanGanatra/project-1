            ...
            <div id="tabs">
					  ...
					  <td>
						  ...
						  <table width="100%" cellspacing="2" cellpadding="5" align="center">
							...
							<tbody>
                              ...
                              <tr>
                                <td></td>
                                <td align="left"><input type="button" class="btn btn-primary" value="Next" onclick="update1()">
                                </td>
                              </tr>
              ...
              <div id="tabs-2">
                ...
                <tr>
              	  	<td></td>
           	 		<td align="left">
						<input type="button" class="btn btn-primary" value="Next" onclick="update2()">
					</td>
   			 	</tr>
             ...
             <div id="tabs-3">
                ...
                <tbody>
				<tr bgcolor="#E6E6E6">
                    <td class="SubTitle BorderBtm" colspan="2">Astrological Information </td>
              	</tr>
                ...
                <tr>
              	  	<td></td>
           	 		<td align="left">
						<input type="button" class="btn btn-primary" value="Next" onclick="update3()">
					</td>
   			 	</tr>
            ...
            <div id="tabs-4">
                ...
                <tr>
              		<td></td>
						...
						<input type="button" class="btn btn-primary" value="Next" onclick="update4()">
					</td>
   			 	</tr>
              ...
              <div id="tabs-5">
			    ...
			    <tr>
			        <td></td>
			        <td align="left">
						<input type="button" class="btn btn-primary" value="Next" onclick="update5()">
					</td>
			    </tr>
              ...
              <div id="tabs-6">
				...
				<tr bgcolor="#E6E6E6">
        			<td class="SubTitle BorderBtm" colspan="2">Location / Contact Information</td>
    			</tr>
				...
				<tr>
        			<td></td>
        			<td align="left" colspan="2">
						<input type="submit" class="btn btn-primary" value="Next" onclick="update6()">
					</td>
    			</tr>
              ...
              <div id="tabs-7">
				...
				<tr bgcolor="#E6E6E6">
        			<td class="SubTitle BorderBtm" colspan="3">Brief About his/her self</td>
    			</tr>
