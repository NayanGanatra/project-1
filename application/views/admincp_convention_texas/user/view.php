				...
				<div class="control-group <?php if(form_error('keywords')){ echo "error";}?>">
                    ...
                    <div >
                        ...
                        <ul class="dropdown-menu" style="" >
                          ...
                          <li><a style="text-align:left;" href="<?php echo base_url('admincp_convention_texas/user/user_export_to_excel/1');?>" onclick="">All Members</a></li>

                          <li><a style="text-align:left;" href="<?php echo base_url('admincp_convention_texas/user/user_export_to_excel/2');?>" onclick="">Assigned Members</a></li>
                          
                          <li><a style="text-align:left;" href="<?php echo base_url('admincp_convention_texas/user/user_export_to_excel/3');?>" onclick="">Un-Assigned Members</a></li>
                          
                          <li><a style="text-align:left;" href="<?php echo base_url('admincp_convention_texas/user/user_export_to_excel/4');?>" onclick="">verified Members</a></li>
                          
                          <li><a style="text-align:left;" href="<?php echo base_url('admincp_convention_texas/user/user_export_to_excel/5');?>" onclick="">Un-verified Members</a></li>
...
<!--update end-->
        ...
        <a href="<?php echo base_url('admincp_convention_texas/user/status/'.$row->mm_id.'');?>" title="status">
        ...
        <td><a href="<?php echo base_url('admincp_convention_texas/user/edit/'.$row->mm_id.'');?>" title="Edit"><i class="icon-edit"></i></a> 

        <a onclick="javascript: return del();" href="<?php echo base_url('admincp_convention_texas/user/delete/'.$row->mm_id.'');?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
