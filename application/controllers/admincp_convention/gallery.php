...

{
...

	{
		...
		$this->load->model('admincp_convention/dbgallery');
		$this->load->model('admincp_convention/dbsettings');
		//$this->load->model('admincp_convention/dbadminheader');/////update_monita20130919
...

	{
		...
		$config['base_url'] = base_url().'admincp_convention/gallery/view/';
		...
		$this->load->view('admincp_convention/gallery/view',$data);
...
*/
			...
			redirect(base_url().'admincp_convention/gallery');
		...
		$this->load->view('admincp_convention/gallery/add',$data);
...
*/
		...
		$this->load->view('admincp_convention/gallery/edit',$data);
...

	{
...

		{
			...
			redirect(base_url('admincp_convention/gallery/view'));
