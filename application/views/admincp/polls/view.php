...
<table border="0" cellspacing="2" cellpadding="2" width="100%" class="table table-hover">
    ...
    <tr>
        ...
        <td><a href="<?php echo base_url('admincp/polls/edit/'.$query[$index][0][0]->poll_id.'');?>" title="Edit"><i class="icon-edit"></i></a> 
        <a onclick="javascript: return del();" href="<?php echo base_url('admincp/polls/delete/'.$query[$index][0][0]->poll_id.'');?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
    </tr>
