...
<table border="0" cellspacing="2" cellpadding="2" width="100%" class="table table-hover">
    ...
    <tr>
        ...
        <td><a href="<?php echo base_url(); ?>chapteradmincp/news/edit/<?php echo $row->news_id; ?>" title="<?php echo $this->lang->line('misc_edit');?>"><i class="icon-edit"></i></a>
        <a href="<?php echo base_url();?>chapteradmincp/news/delete/<?php echo $row->news_id; ?>" title='<?php echo $this->lang->line('misc_delete');?>' onclick="javascript: return del();"><i class="icon-minus-sign"></i></a></td>
    </tr>
