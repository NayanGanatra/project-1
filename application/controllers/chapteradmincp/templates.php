...
class Templates extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('chapteradmincp/dbtemplates');
	...
	public function view()
	{
		...
		$config['base_url'] = base_url().'chapteradmincp/templates/view/';
		...
		$this->load->view('chapteradmincp/templates/view',$data);
	}
	...
	public function add()
	{
		...
		// Image upload start
			...
			else
			{
				...
				redirect(base_url().'chapteradmincp/templates/adddimention/'.$last_id->templates_id);
			}
		}
		$data['title']="Add New Templates";
		$this->load->view('chapteradmincp/templates/add',$data);
	}
	...
	public function adddimention($id)
	{
		...
		if(isset($_POST['submit']))
		{
			...
			redirect(base_url().'chapteradmincp/templates/view/');
		}
		
		$data['query']=$numofpics;
		$data['title']="Add New Templates";
		$this->load->view('chapteradmincp/templates/adddimention',$data);
	}
