		   ...
		   <tr>
			   <td >
						...
						<th><label class="pink_colored"
							style="width: 200px; font-width: bold;"><b>Become A Life Member :</b></label></th><?php } ?>
						<th><label class="pink_colored"
			 ...
			 ?>
			 	<table width="93%" border="0" class="add_rm_before age-Group" style="margin-left: 3.1%; width: 701px;float: left;">
                      <tr>
                          ...
                          <input type="hidden" id="registrationfeeshidden" name="registrationfeeshidden" value="0"/>
                          </td>                  
                      </tr>    
                </table>	
                  </div>
            ...
            <td><?php $set_tshirt_size = set_value('tshirt_size[]'); ?><select style="width:100px;" name="tshirt_size[]">
              ...
              <option  <?php if($set_tshirt_size == "AXXL") { echo 'selected'; } ?> value="AXXL">AXXL</option>
					...
					<tr class="treven">
						...
						<input type="hidden" id="totalamounthidden" name="totalamounthidden" value="0">
						</tr>
					</table>
				 <div class="space10px"></div> 
             ...
             <div style="width:100%; float:left; margin-left: 20px;">
             	<div class="pay_type" id="pay_type" style="">
				  ...
				  <!-- Vishal Comment 1/31/2015  <input type="radio" name="payment" id="check" value="by_check" style="vertical-align: sub;">Pay by CHECK -->
                     ...
                     <input style="margin-left:20px; vertical-align: sub;" type="radio" checked="checked" id="paypal" name="payment" value="by_paypal" >Pay by PAYPAL (Account not required) or Credit/Debit Card
...
function ageof()
{
    ...
    document.getElementById('fees_total').value='';
	...
	if(document.getElementById("txtem_life_member")!= undefined) {
	...
	//set the value of total reistation fees + memebrship fees before adding sponser fees.
	$('#registrationfeeshidden').val(total_price);
