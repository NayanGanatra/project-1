                               ...
                               <td colspan="2">
                                 ...
                                 <div style="float:left; ">
                                  <div id="check_uncheck_all_user"  style="float:right;width: 140px;"  ><a href="javascript:void(0)">Check All user</a></div>
                                    ...
                                    <option value="1" <?php //if($this->input->get('mm_type') == 1){ echo 'selected="selected"'; } ?>>Primary Members</option>
...
///////////pradip_20140314////////
			data :'status=edit&id='+uid+'&ch_id='+n_ch+'&action=true&type='+type+'&offeset='+$('#offset').val()+'&m_type='+$('#mm_type').val(),
//////////end///////////////////////
