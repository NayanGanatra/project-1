...

{
...

	{
		...
		$this->load->model('admincp_convention/dbprogram');
...

	{
		...
		redirect(base_url().'admincp_convention/program');
	...
	public function destroy()
	{
		...
		redirect(base_url()."admincp_convention/program/view");
	}
...

	{
		...
		{
			$search_key = 0;
			$config['base_url'] = base_url().'admincp_convention/program/view/'.$search_key.'/';
		}
		else
		{
			$config['base_url'] = base_url().'admincp_convention/program/view/'.$search_key.'/';
		...
		$this->load->view('admincp_convention/program/view',$data);
...

	{
		...
		$this->load->view('admincp_convention/program/edit',$data);
	...
	public function add()
	{
...

		{
					...
					$data=array(
						...
						'pm_modified_date'=>$this->input->post('pm_created_date'),

						'pm_modified_by'=>$this->input->post('pm_created_by')
		...
		$this->load->view('admincp_convention/program/add',$data);
	}
