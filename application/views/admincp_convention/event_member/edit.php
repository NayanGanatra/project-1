        ...
        <hr>
            ...
            ?>
				 ...
				 <table class="tbl_class1"  border="1" cellspacing="0" cellpadding="0" style="width:57%; text-align:center;"> 
					...
					$member_data = $this->dbevent_member->get_member_event_group_detail_by_id($ce_mem_id,$itemsgroup->ce_id);
					if($member_data){
					?>
					<tr class="trodd">
						...
						<td class="tdaligncenter"><label style="line-height:32px; display:inline;"><input type="text" class="tdtxt" style="width: 20px; margin-right: 2px;" name="txtpcount[]" id="txtpcounta" value="<?php echo $member_data->ce_mem_num_participant; ?>" onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();"/>x $</label><?php echo $itemsgroup->ce_age_fee; ?>
						...
						<td class="tdaligncenter"><input type="text" value="<?php echo $member_data->ce_mem_amount; ?>" style="margin-bottom: 0px; width: 106px; text-align: center;" name="amount[]" readonly=""/> </td>
					</tr> <?php 
					$total += $member_data->ce_mem_amount;
					}}} ?>
					<tr class="treven">
