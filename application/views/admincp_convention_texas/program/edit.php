  	...
  	<td>
    	...
    	<div class="dotted_line">
            ...
            <div >
                        ...
                        <a href="<?php echo base_url('admincp_convention_texas/program/program_detail_export_to_excel/'.$get_program->pm_id.'');?>" id="exportexcel" style="width:100px;float:right;" class="dropdown-toggle" >Export to excel</a>
	...
	<div class="row">
		...
		<div class="control-group <?php if(form_error('pm_length')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;">
			...
			<div class="controls">
				...
				<input class="" type="text" id="covers_cat_name" name="pm_length" value="<?php echo $get_program->pm_length; ?>" placeholder="MM:SS">
</br>
        ...
        <div class="control-group <?php if(form_error('pm_desc1')){ echo "error";}?>">
            <label style="" class="control-label <?php if(form_error('pm_desc1')){ echo "error";}?>" for="inputError">Description(1st Choice)</label>
				<div class="controls" style="">
                    ...
                    <textarea class="" style="width:60%; height:116px;" id="pm_desc1" name="pm_desc1"><?php echo $get_program->pm_ch1; ?></textarea>
          ...
          <label style="" class="control-label <?php if(form_error('pm_desc2')){ echo "error";}?>" for="inputError">Description(2nd Choice)</label>   
                <div class="controls" style="">
                    ...
                    <textarea id="pm_desc2" class="" style="width:60%;  height:116px;"  name="pm_desc2"><?php echo $get_program->pm_ch2; ?></textarea>
