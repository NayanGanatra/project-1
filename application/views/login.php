...
<div class="span10" style="margin:0;">
            ...
            <input class="input-xlarge" type="password" id="mm_password" name="mm_password" placeholder="<?php echo $this->lang->line('text_password');?>" value="<?php echo set_value('mm_password'); ?>">
