  	...
  	<td>
    	...
    	<div class="dotted_line">
			...
			<div >
                        ...
                        <a href="<?php echo base_url('admincp_convention/medical/medical_detail_export_to_excel/'.$get_details->md_id);?>" id="exportexcel" style="width:100px;float:right;" class="dropdown-toggle" >Export to excel</a>
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/<?php echo $get_details->md_state;?>/<?php echo $get_details->md_city;?>',
...
$('#mm_state_id').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/'+$('#mm_state_id').val(),
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/<?php echo $get_details->md_state1;?>/<?php echo $get_details->md_city1;?>',
...
$('#mm_state_id1').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/'+$('#mm_state_id1').val(),
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/<?php echo $get_details->md_state2;?>/<?php echo $get_details->md_city2;?>',
...
$('#mm_state_id2').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/'+$('#mm_state_id2').val(),
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/<?php echo $get_details->md_dr_state3;?>/<?php echo $get_details->md_dr_city3;?>',
...
$('#mm_state_id3').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/medical/get_city/'+$('#mm_state_id3').val(),
