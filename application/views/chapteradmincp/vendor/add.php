  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1>Vendors&nbsp;<small>Add Vendor</small></h1>
		</div>
        <hr />
                ...
                <div class="controls">
                <input class="input-xxlarge" type="text" id="vender_name" name="vender_name" placeholder="Vendor Name" value="<?php echo set_value('vender_name'); ?>">
                ...
                <div class="controls">
                <input class="input-xxlarge" type="text" id="vender_email" name="vender_email" placeholder="Vendor Email" value="<?php echo set_value('vender_email'); ?>">
                ...
                <div class="controls">
                 <textarea name="vender_address" id="vender_address" style="min-width:530px; width:auto; min-height:100px;"><?php echo set_value('vender_address'); ?></textarea>
                 ...
                 <div class="controls">
                    ...
                    <option value="select category">---Select-Category---</option>
                        <?php
							...
							{
								if(set_value('category_id') == $row->category_id)
								{
								?>
                ...
                <div class="controls">
                    <textarea name="vender_desc" id="vender_desc" style="width:100%; min-height:300px;"><?php echo set_value('vender_desc'); ?></textarea>
                    <span class="help-inline"><?php echo form_error('vender_desc'); ?></span>
                </div>
            	</div>
                 <!-- End of update by monita20130725-->
                <?php date_default_timezone_set("Asia/Kolkata"); ?>	
                <input type="hidden" id="" name="vendor_created_date" value="<?php echo date("Y-m-d H:i:s"); ?>">
                <?php 
                    ...
                    {		
                ?>
                        <input type="hidden" id="" name="vendor_created_by" value="<?php echo $username->mm_username;?>">
                <?php
                    }
                ?>
