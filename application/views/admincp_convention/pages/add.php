        ...
        <hr />
           ...
           <div class="control-group <?php if(form_error('page_seo')){ echo "error";}?>">
			...
			<div class="controls">
	            ...
	            <option <?php if(set_value('page_home') == '2'){ echo 'selected="selected"'; } ?> value="2">No</option>
                <option <?php if(set_value('page_home') == '1'){ echo 'selected="selected"'; } ?> value="1">Yes</option>
				</select>
            ...
            <input type="hidden" id="" name="type" value="<?php echo 'convention';?>">
