...
<div id="tabs" style="width:100%;height:10px !important;">
      ...
      <div id="tabs-1" >
      <?php	$this->load->view('admincp_convention/fees/add'); ?>
      </div>
      <div id="tabs-2" >
      <?php	$this->load->view('admincp_convention/form/add'); ?>
      ...
      <div id="tabs-4" >
      <?php	$this->load->view('admincp_convention/program/add'); ?>
      </div>
      <div id="tabs-5" >
      <?php	$this->load->view('admincp_convention/events/add'); ?>
      </div>
      <div id="tabs-6" >
