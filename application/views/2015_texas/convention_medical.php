...
$('#mm_state_id').change(function() {
	...
	$.ajax({
	  ...
	  url: '<?php echo base_url().$this->config->item("convention_texas_folder");?>convention/get_city/'+$('#mm_state_id').val(),
...
$('#mm_state_id1').change(function() {
	...
	$.ajax({
	  ...
	  url: '<?php echo base_url().$this->config->item("convention_texas_folder");?>convention/get_city/'+$('#mm_state_id1').val(),
...
$('#mm_state_id2').change(function() {
	...
	$.ajax({
	  ...
	  url: '<?php echo base_url().$this->config->item("convention_texas_folder");?>convention/get_city/'+$('#mm_state_id2').val(),
...
$('#mm_state_id3').change(function() {
	...
	$.ajax({
	  ...
	  url: '<?php echo base_url().$this->config->item("convention_texas_folder");?>convention/get_city/'+$('#mm_state_id3').val(),
