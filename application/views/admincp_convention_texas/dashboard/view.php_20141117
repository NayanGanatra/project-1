...
<div class="dotted_line">
            ...
            <div class="span5 offset sub_link" align="right">
                ...
                echo form_open(base_url() . 'admincp_convention_texas/dashboard/view', $form_attributes);
            ...
            <div >
                        ...
                        <a href="<?php echo base_url('admincp_convention_texas/convention_detail/view');?>" id="exportexcel" style="width:200px;float:right;" class="dropdown-toggle" >Registration Detail</a>
