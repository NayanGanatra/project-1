<script type="text/javascript">
	   ...
	   url:'<?php echo base_url().$this->config->item("convention_folder");?>convention/pages1',
			...
			foreach($allpages as $allpages)
			{
				?>
                        ...
                        <h2 style="font-size:24px;"><?php echo $allpages->page_title;?></h2>
                         ...
                         <p class="small"><a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/detail_page/'.$allpages->page_id.""); ?>">Read More</a>
