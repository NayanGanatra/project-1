...
jQuery.fn.colourPicker = function (conf) {
	...
	var config = jQuery.extend({
		...
		speed:		10,					// Speed of dialogue-animation
	...
	return this.each(function () {
		...
		var icon	= jQuery('<a id="colorpicker_btn" class="colorpicker_btn" href="#"><img src="' + config.ico + '" alt="' + config.openTxt + '" /></a>').insertAfter(select);
		var input	= jQuery('<input class="colorpicker_input" type="text" name="' + select.attr('name') + '"  id="' + select.attr('name') + '" value="' + select.val() + '" size="6" style="width:34px;" />').insertAfter(select);
		var loc		= '';
