 <ul class="unit-rating" style="width: <?php echo $units*$rating_unitwidth ?>px;">
    <li class="current-rating" style="width: <?php echo @number_format($current_rating/$count,2)*$rating_unitwidth ?>px;">Current rating.</li>
