...
<div  id="save_cancle" style="float:left; margin-left:6px;"  ><a onclick="document.getElementById('quote').style.visibility='hidden';document.getElementById('fade1').style.display='none'" href="javascript:void(0)" class="quote-close">Cancel</a>
