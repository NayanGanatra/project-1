       ...
       <div class="row-fluid">
           ...
           <div id="content_gallery">
             ...
             <?php $count=count($image); 
			  if($count!=0)
			  {?>
             <!--  <p class="small"><a href="<?php //echo base_url($this->config->item('convention_texas_folder_with_slash').'convention/image/'.$this->uri->segment(5)); ?>">Read More</a></p>--><!-------------------update-monita20130920--------------------->
               <?php
			    }
				else
				{
           ...
           <hr width="85%!important"></hr>
            ...
            <?php $count=count($video);
				  ...
				  {
			      ?>
          <!--  <p class="small"><a href="<?php //echo base_url($this->config->item('convention_texas_folder_with_slash').'convention/video/'.$this->uri->segment(5)); ?>">Read More</a></p>--><!-------------------update-monita20130920--------------------->
           <?php } 
		        else
				{
