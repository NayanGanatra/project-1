...
function __construct()
	...
	function view()
	{
		...
		///////////////////////end///////////////////////
			$data['query'] = $this->dbchapter->get_all_ch_cm_by_current_year($data['chapter']->ch_id,date('Y'),date('Y', strtotime('+1 year')));
			
			$data['title'] = 'Committee';
			$data['sub_title'] = $data['chapter']->ch_name.' Committee Members';
			$data['description'] = "";
			$data['keywords'] = "";
