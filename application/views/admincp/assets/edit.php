  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1><?php echo $this->lang->line('text_asset');?> <small><?php echo $this->lang->line('text_edit_asset');?></small></h1>
		</div>
        <hr />
         <?php
            ...
            <div class="control-group <?php if(form_error('assets_name')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input type="text" id="assets_name" name="assets_name" value="<?php echo $get_item->assets_name; ?>">
            ...
            <div class="control-group <?php if(form_error('assets_cat_id')){ echo "error";}?>">
                ...
                <div class="controls">
                    ...
                    <?php
						...
						{
							if($get_item->assets_cat_id == $cats_row->assets_cat_id)
							{
						?>
            ...
            <input type="hidden" value="<?php echo $get_item->assets_image; ?>" name="old_image" />
