  ...
  <tr>
  	<td>
           ...
           <td colspan="3">
            	...
            	<div class="controls">
				Emergency Contact Name(Not Listed Below) :<input type="text" placeholder="Enter name" style="width:424px;margin:0;" name="txtem_con_name" value="<?php echo set_value('txtem_con_name'); ?>"/>
				</div>
				</div>
                </div>
           </td>
		   ...
		   <td colspan="3">
               ...
               <div class="<?php if(form_error('txtem_con_name')){ echo "error";}?>">
            	<div class="controls">
				<label style="width:68px; float:left">Phone :</label><input type="text" placeholder="Enter number" style="width:424px;margin-left:218px;" name="txtem_con_number" value="<?php echo set_value('txtem_con_number'); ?>"/>
                </div>
				</div>
				</div>
           </td>
           ...
           <div style="width:100%;  float:left;">
            <table width="93%"  border="1" style="margin-left:3.1%;" >
			 ...
			 <div style="width:20px; float:left;"><input type="checkbox" style="float: left; margin-right: 1%;" name="chkbx<?php echo $chapter->mm_id; ?>" value="<?php echo $chapter->mm_id; ?>" class="hdnids"/>
			<input type="hidden" value="<?php echo $chapter->mm_id; ?>" name="hdnids[]" class="hdnids"/>
				...
				<table width="93%" border="1" class="add_rm_before" style="margin-left:3.1%" >
                    ...
                    <input class="toclear"  onkeyup="ageof()" readonly="" onkeypress="ageof();"  onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" id="age[]"  name="age[]"  type="text" value="<?php $age = date("Y")-$chapter->mm_birth_year; echo $age; ?>"  style=" width:100%; margin:0; padding:0;"/>
                    </td>
			 ...
			 ?>
              <div  class="controls addremove mystyle"  style="height: 25px;">
           		<input type="checkbox" style="float: left; margin-right: 1%;" name="chkbx<?php echo $family->mm_id; ?>" value="<?php echo $family->mm_id; ?>" class="hdnids"/>
				...
				<table width="93%" border="1" class="add_rm_before tbl_class1" style="margin-left:3.1%"  >
				 ...
				 <input class="toclear"  onkeyup="ageof()" readonly="" onkeypress="ageof();"  onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" id="age[]"  name="age[]"  type="text" value="<?php $age = date("Y")-$family->mm_birth_year; echo $age; ?>"  style=" width:100%; margin:0; padding:0;"/>
			 ...
			 ?>
			 	<table width="93%" border="1" class="add_rm_before" style="margin-left:3.1%;">
                      <tr>
                          ...
                          <input disabled="disabled"  id="fees_total" type="text"  name="fees_total" value="<?php echo $total; ?>"  style="width: 99%; margin: 0px; padding: 0px; text-align: right;"/>
                          </td>                  
                      </tr>    
                </table>	
                  </div>
             ...
             <?php if(form_error('rel[]') || form_error('age[]') || form_error('menu_ch[]') || form_error('age_grp[]') || form_error('fees[]')) { ?>
