...
/************update_monita20130928****************/
	...
	<div class="photogallery">
      	...
      	<div class="logo-text2"><img align="absmiddle" alt="" src="<?php echo base_url();?>images/youth_milan/register-icon.png"> Registration	</div>
       <!-- update pradip 2013/11/15-->
		
       <?php if(isset($family_member)){
	   if(count($family_member)>0 ) { ?>
       <div class="" style="color: #0088CC;float: left;font-size: 18px;margin: 0 50px 5px;padding: 0 0 10px;width: 97%;"> Family Member</div>
      
	   <table align="center" border="1" bordercolor="#CCCCCC" cellpadding="" cellspacing="" width=50% style="margin-left:310px;">
			<tr style="background-color:#0597E0;">
        	<th scope="col" align="center">Name</th>
            <th scope="col" align="center">Email</th>
            <th scope="col" align="center">Status</th>
            <th scope="col" align="center">Action</th>
            </tr>
	 <?php  foreach($family_member as $child) { ?>
        	<tr>
            <td align="center"><?php echo $child->mm_fname." ".$child->mm_lname; ?></td>
            <td align="center"><?php echo $child->mm_email; ?></td>
            
            <?php $is_registered = $this->dbyouthmilan->is_registered($child->mm_id); ?>
            <td align="center"><?php 
			if($is_registered!=NULL && $is_registered!=''){
			if($is_registered->ym_status!=0){ ?><img src="<?php echo base_url()?>images/approve_icon.gif" width="16" height="16" /><?php } else { ?><img src="<?php echo base_url()?>images/disapprove_icon.gif" width="16" height="16" /><?php } } ?></td>
            <td align="center"><?php if(count($is_registered)==0) { ?><a href="<?php echo base_url();?>youth_milan/registration/view/<?php echo $child->mm_id; ?>"><span style="color:#09F">Add</span></a><?php } else { ?><a href="<?php echo base_url();?>youth_milan/registration/view/<?php echo $child->mm_id; ?>"><span style="color:#09F">Edit </span></a> <?php } ?></td>
			</tr>
          ...
          <form method="post" action="" id="frmBasicInfo" name="frmBasicInfo">-->
            ...
            <div id="tabs_ym">
			  ...
			  <ul>
				...
				<li><a href="#tabs-8">Setting<br /></a></li>
					  ...
					  <td>
						  ...
						  <table width="100%" cellspacing="2" cellpadding="5" align="center">
							...
							<tbody>
							  ...
							  <tr valign="top"> 
								<td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="2">Basic Information/ Physical Attributes</td>
							  </tr>
                              ...
                              <tr>
                                ...
                                <td class="txtBlack13Arial">
									<input type="text" readonly="readonly" value="<?php if(!$check1) { echo $query1->ym_name; } else {echo $query8->mm_fname." ".$query8->mm_lname;}?>" class="textBox_Admin" id="ym_name" name="ym_name" placeholder="Name">	
                              ...
                              <tr>
                                ...
                                <select id="ym_height" name="ym_height">
									...
									<option id="4 ft 0 in/121cms" <?php if($check1){echo set_select('ym_height','121');} elseif($query1->ym_height=="121") {echo 'selected="selected"';}?> value="121">4 ft 0 in/121cms</option>
							  ...
							  <tr>
							   	<td width="33%" valign="top" align="right" class="txtBlack13Arial"></td>
								<td class="txtBlack13Arial">
                              ...
                              <tr>
                                ...
                                <td align="left"><input type="submit" class="btn btn-primary" value="Update" id="ym_update1" name="ym_update1">
                                  &nbsp;
                                  <input type="button" onclick="window.location='<?php echo base_url().'youth_milan/registration/view'; ?>'" class="btn btn-danger" value="Cancel" id="ym_cancel1" name="ym_cancel1"></td>
                              </tr>
             ...
             Field=PhysicalStatusID|Alias=Physical Status|Validate=Combo" name="Validation">-->
              ...
              <div id="tabs-2">
               ...
               <?php
                ...
                <tbody>
				<tr>
                    <td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="2">Religious/ Social Background </td>
              	</tr>
                ...
                <tr>
                    ...
                    <td class="txtBlack13Arial">
                    	<select  class="combo" id="ym_caste" name="ym_caste">
							...
							<option id="Intercaste" <?php if($check2){echo set_select('ym_caste','Intercaste');} elseif($query2->ym_caste=="Intercaste") echo "selected='selected'"; ?> value="Intercaste">Intercaste</option>
                ...
                <tr>
					...
					<input type="button" onclick="window.location='<?php echo base_url().'youth_milan/registration/view'; ?>'" class="btn btn-danger" value="Cancel" id="Cancel" name="Cancel"></td>
   			 	</tr>
              ...
              <div id="tabs-3">
               ...
               <table width="100%" cellspacing="2" cellpadding="5" align="center" class="tblBorder">
				...
				<tr>
                    <td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="4">Astrological Information </td>
              	</tr>
				...
				<tr>
                    ...
                    <td class="txtBlack13Arial" colspan="3">
                    	<input type="text" value="<?php if(!$check3) {if($query3->ym_age!="0"){ echo $query3->ym_age; } else {echo "";}} else { echo set_value("ym_age");}?>" class="textBox_Admin" id="ym_age" name="ym_age">
                ...
                <tr>
					...
					<input type="radio" <?php if($check3){echo set_radio('ym_manglik','Not applicable');} elseif($query3->ym_manglik=="Not applicable") {echo 'checked="checked"'; } ?> value="Not applicable" id="ym_manglik_na" name="ym_manglik" style="margin:0 2px 0 15px ;">Not applicable
                ...
                <tr>
              		<td></td>
						...
						<input type="button" onclick="window.location='<?php echo base_url().'youth_milan/registration/view'; ?>'" class="btn btn-danger" value="Cancel" id="Cancel" name="Cancel">
					</td>
   			 	</tr>
            ...
            <div id="tabs-4">
				...
				<tr>
                    <td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="3">Educational and Professional Information </td>
              	</tr>
                ...
                <tr>
                   ...
                   <td class="BlueNormal13" colspan="2"><input type="text" value="<?php if(!$check4) echo $query4->ym_annual_income; ?>" class="textBox_Admin" id="ym_annual_income" name="ym_annual_income">
						...
						<!--end-->
				   		...
				   		<br>
                   		<strong>Example:</strong> 100,000 USD/year.
                   </td>
                </tr>
              ...
              <div id="tabs-5">
				...
				<tr>
        			<td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="2">Life Style </td>
    			</tr>
              ...
              <div id="tabs-6">
				...
				<tr>
        			<td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="4">Location / Contact Information</td>
    			</tr>
				...
				<tr>
        			...
        			<!--<td class="txtBlack13Arial labelup" colspan="2">Example : support@xyz.com</td>-->
              ...
              <div id="tabs-7">
				...
				<tr>
        			<td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="3">Brief About Yourself</td>
    			</tr>
				...
				<tr>
				  	<td colspan="2">
						...
						<div style="color: #B94A48"><?php if($file_size_error) echo "Photo should be less than or equals to 1MB.";?></div>
						<!--------------end---------------->
						<div class="sucess">
            ...
            <div id="tabs-8">
				...
				<tr>
        			<td class="SubTitle BorderBtm" style="background-color:#0597e0; color:#fff; border:0px solid #0597e0; border-radius:5px;" colspan="2">Profile Setting</td>
  				</tr>
				...
				<tr>
				  	<td colspan="2">
						<div style="color: #B94A48">
							<?php echo $this->session->userdata('tab_msg8_error'); $this->session->unset_userdata('tab_msg8_error');?>
						</div>
						<div class="sucess">
						<?php echo $this->session->userdata('tab_msg8'); $this->session->unset_userdata('tab_msg8');?>		
						</div>
					</td>
				</tr>
	
				<tr>
        			<td width="31%" align="right" class="txtBlack13Arial"><strong>Status <span class="err">*</span></strong></td>
        			 	<td class="txtBlack13Arial">
								
                                <select id="ym_status" name="ym_status">
                                 
									<option id="Active" <?php if(!$check1){if($query1->ym_status=="1") {echo 'selected="selected"';}}?> value="1">Active</option>
                                	<option id="Inactive" <?php if(!$check1){if($query1->ym_status=="0") {echo 'selected="selected"';}}?> value="0">Inactive</option>
