  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1>Latest News <small>Edit Latest News</small></h1>
		</div>
            ...
            <div class="control-group <?php if(form_error('latest_news_title')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="latest_news_title" value="<?php echo $get_latestnews->latest_news_title; ?>">
            ...
            <div class="control-group <?php if(form_error('latest_news_link')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input class="input-xxlarge" type="text" id="covers_cat_name" name="latest_news_link" value="<?php echo $get_latestnews->latest_news_link ; ?>">
            ...
            <div class="control-group <?php if(form_error('latest_news_tab')){ echo "error";}?>">
                Open in new tab
                    <input class="" type="checkbox" id="covers_cat_name" name="latest_news_tab" <?php if($get_latestnews->latest_news_tab == 1){ echo 'checked="checked"'; }?> value="1" style="margin-top:-2px;margin-left:20px;">
			...
			<div class="control-group <?php if(form_error('latest_news_status')){ echo "error";}?>">
                ...
                <div class="controls">
                    ...
                    <option <?php if($get_latestnews->latest_news_status == '1'){ echo 'selected="selected"'; } ?> value="1"><?php echo $this->lang->line('misc_active'); ?></option>
                    <option <?php if($get_latestnews->latest_news_status == '0'){ echo 'selected="selected"'; } ?> value="0"><?php echo $this->lang->line('misc_deactive'); ?></option>
                    </select>
           ...
           <?php date_default_timezone_set("Asia/Kolkata"); ?>
            <input type="hidden" id="" name="latest_news_created_date" value="<?php echo $get_latestnews->latest_news_created_date; ?>">
            <input type="hidden" id="" name="latest_news_created_by" value="<?php echo $get_latestnews->latest_news_created_by; ?>">
            <input type="hidden" id="" name="latest_news_modified_date" value="<?php echo date("Y-m-d H:i:s"); ?>">
            <?php 
				...
				{
			?>
        			<input type="hidden" id="" name="latest_news_modified_by" value="<?php echo $username->mm_username;?>">
        	<?php
                }
       	 	?>
           		
            <input type="hidden" name="latest_news_id" value="<?php echo $get_latestnews->latest_news_id; ?>" />
