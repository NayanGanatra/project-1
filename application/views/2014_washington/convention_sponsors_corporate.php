...
<img src="<?php echo base_url(); ?>images/spcs_convention/post-icon.png" alt="" align="absmiddle" />&nbsp;Corporate Sponsors
</div>
       ...
       <div class="row-fluid">
		...
		{ 
           ...
           <a 	target="_blank" href="<?php echo $grandsponsors->cs_link ?>"><img src="<?php echo base_url(); ?>images/convention/sponsors/<?php echo $grandsponsors->cs_code; ?>" alt="" /></a>
			...
			{ ?>
			<table border="1" style="margin: 10px 0px 0px 0px; width:100%;" class="table">
			<tr style="background-color:#CCBA28;">
