...
$sql="SELECT b.ch_name FROM chapter_to_state a, chapters b WHERE a.state_id = '".$mm_state_id."' AND b.ch_id = '".$this->session->userdata('get_chapter_id')."' LIMIT 1";
	...
	function user_details_state_for_email($mm_state_id)

	{

		$sql = "SELECT * FROM member_master WHERE FIND_IN_SET(mm_state_id,'".$mm_state_id."')";
...
/////////////////////////////////////////////////////pradip_201403260330///////////////////////////////////////////////////
	...
	function user_details_pagination_with_check_all_for_event($mm_id,$mm_type,$search_key)

	{
		...
		if($mm_type==0)
		{
			...
			{
				$sql = "SELECT * FROM member_master WHERE FIND_IN_SET(mm_id,'".$mm_id."') AND mm_varify='1' AND  (mm_username like '%".$search_key."%'
		...
		elseif($mm_type==1)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC";
				
	
			}
			else
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' AND  (b.mm_username like '%".$search_key."%'
		...
		elseif($mm_type==2)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE isrsvp = '1' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC";
				
	
			}
			else
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE isrsvp = '1' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' AND  (b.mm_username like '%".$search_key."%'
		...
		elseif($mm_type==3)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE  status_id = '1' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC";
				
	
			}
			else
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE  status_id = '1' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' AND  (b.mm_username like '%".$search_key."%'
		...
		elseif($mm_type==4)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE status_id = '2' AND   a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC";
				
	
			}
			else
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE status_id = '2' AND   a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' AND  (b.mm_username like '%".$search_key."%'
		...
		elseif($mm_type==5)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE status_id = '3' AND   a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC";
				
	
			}
			else
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE status_id = '3' AND   a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' AND  (b.mm_username like '%".$search_key."%'
		...
		elseif($mm_type==6)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE isrsvp = '0' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC";
				
	
			}
			else
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE isrsvp = '0' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' AND  (b.mm_username like '%".$search_key."%'
	...
	function user_details_pagination_with_check_all_page_for_event($mm_id,$offset,$num,$mm_type,$search_key)

	{
	 ...
	 if($mm_type==0)
		...
		elseif($mm_type==1)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC LIMIT ".$offset.", ".$num." ";
		...
		elseif($mm_type==2)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE isrsvp = '1' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC LIMIT ".$offset.", ".$num." ";
		...
		elseif($mm_type==3)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE  status_id = '1' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC LIMIT ".$offset.", ".$num." ";
		...
		elseif($mm_type==4)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE status_id = '2' AND   a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC LIMIT ".$offset.", ".$num." ";
		...
		elseif($mm_type==5)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE status_id = '3' AND   a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC LIMIT ".$offset.", ".$num." ";
		...
		elseif($mm_type==6)
		{
			if($search_key=='0')
			{
				$sql="SELECT a.*,b.* FROM event_invitation a, member_master b WHERE isrsvp = '0' AND  a.event_id = '".$event_id."' AND a.mm_id=b.mm_id AND FIND_IN_SET(a.mm_id,'".$mm_id."') AND b.mm_varify='1' ORDER BY a.mm_id ASC LIMIT ".$offset.", ".$num." ";
...
//added by ketan 20130730
	...
	////////////////////////pradip_20140324//////////////////////////	
	function user_details_for_edit($id)
	{
		$sql="SELECT * FROM email_template_to_member WHERE email_template_id = '".$id."' ORDER BY email_template_to_member_id ASC";
		$query = $this->db->query($sql);
		return $query->result();
	}
	function user_details_for_edit_verification($id)
	{
		$sql="SELECT * FROM verification_template_to_member WHERE email_template_id = '".$id."' ORDER BY email_template_to_member_id ASC";
		$query = $this->db->query($sql);
		return $query->result();
	}
	
	function user_details_for_edit_invitation($id)
	{
		$sql="SELECT * FROM  events_to_member WHERE email_template_id = '".$id."' ORDER BY email_template_to_member_id ASC";
		$query = $this->db->query($sql);
		return $query->result();
	}
