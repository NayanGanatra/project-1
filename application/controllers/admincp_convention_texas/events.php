...
class Events extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('admincp_convention_texas/dbevents');
	...
	public function destroy()
	{
		...
		redirect(base_url()."admincp_convention_texas/events/view");
	}
	function view()
	{
		...
		//$config['base_url'] = base_url().'admincp_convention_texas/events/view/';
		
		if($search_key == "")
		{
			$search_key = 0;
			$config['base_url'] = base_url().'admincp_convention_texas/events/view/'.$search_key.'/';
		}
		else
		{
			$config['base_url'] = base_url().'admincp_convention_texas/events/view/'.$search_key.'/';
		...
		$data['title'] = 'Event';		
		$this->load->view('admincp_convention_texas/events/view',$data);
	}
	function add()
	{
		...
		else
		{
				...
				redirect(base_url().'admincp_convention_texas/events');
		}
		$data['title'] = 'Add Event';		
		$this->load->view('admincp_convention_texas/events/add',$data);
	}
	...
	function edit($id)
	{
		...
		if(!$data['item']){redirect(base_url().'admincp_convention_texas/events');}
		$this->form_validation->set_rules('activity', 'Activity', 'required');
		$this->form_validation->set_rules('description', 'Description', 'required');
		$this->form_validation->set_rules('fromage', 'Start age', 'required|numeric|callback__countusers');
		$this->form_validation->set_rules('toage', 'End age', 'required|numeric');
		...
		$this->load->view('admincp_convention_texas/events/edit',$data);
	}
