  ...
  <tr>
  	...
  	<td>
            ...
            <div class="span5 offset sub_link" align="right">
                ...
                echo form_open(base_url() . 'admincp_convention/medical/view', $form_attributes);
				...
				<div class="control-group <?php if(form_error('keywords')){ echo "error";}?>">
                    ...
                    <div >
                        ...
                        <a href="<?php echo base_url('admincp_convention/medical/medical_export_to_excel/');?>" id="exportexcel" style="width:100px;float:right;" class="dropdown-toggle" >Export to excel</a>
   ...
   <tfoot>
    ...
    <tr >
       ...
       ?>
        ...
        <a href="<?php echo base_url(); ?>admincp_convention/medical/edit/<?php echo $row->md_id; ?>" title="<?php echo $this->lang->line('misc_edit');?>" ><i class="icon-edit"></i></a>

        <a href="<?php echo base_url();?>admincp_convention/medical/delete/<?php echo $row->md_id; ?>" title='<?php echo $this->lang->line('misc_delete');?>' onclick="javascript: return del();" > <i class="icon-minus-sign"></i></a></td>
