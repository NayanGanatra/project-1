   ...
   <tfoot>
    ...
    <tr >
       ...
       <td><?php echo $row->menu_created_by; ?></td>
        ...
        <a href="<?php echo base_url(); ?>admincp_convention/menu/edit/<?php echo $row->menu_id; ?>" title="<?php echo $this->lang->line('misc_edit');?>" ><i class="icon-edit"></i></a>

        <a href="<?php echo base_url();?>admincp_convention/menu/delete/<?php echo $row->menu_id; ?>" title='<?php echo $this->lang->line('misc_delete');?>' onclick="javascript: return del();" > <i class="icon-minus-sign"></i></a></td>
