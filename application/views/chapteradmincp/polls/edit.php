                        ...
                        <td>
                            <span class="span3">
                                <label class="checkbox">
                                     ...
                                     <input <?php if(in_array($chapter_row->ch_id,$CheckedChap)){echo 'checked="checked"'; }?>  type="checkbox" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>" disabled="disabled"/>  <?php echo $chapter_row->ch_name; ?>
