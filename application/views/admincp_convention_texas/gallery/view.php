...

			{
...

				{
					...
					?>
                        ...
                        <span><a title="Edit" href="<?php echo base_url('admincp_convention_texas/gallery/edit/'.$row->cg_id.'/'.friendlyURL($row->cg_title).'.html');?>"><i class="icon-edit"></i></a></span>
                        <span><a onclick="javascript: return del();" title="Delete" href="<?php echo base_url('admincp_convention_texas/gallery/delete/'.$row->cg_id.'/'.friendlyURL($row->cg_title).'.html');?>"><i class="icon-minus-sign"></i></a></span>
 </li>  <!-------------------------------------chepters---------------------------------------->
                        <?php
