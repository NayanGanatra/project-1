...
<link href="<?php echo base_url(); ?>css/avgrund.css" rel="stylesheet" type="text/css">
    ...
    ?>			
     ...
     ?>
...

		{
            ...
            <a href="<?php echo base_url('user/register.html'); ?>"><?php echo $this->lang->line('btn_register');?></a>
            </div>
            </div>
            ...
            <div class="login-box">
              ...
              <form name="myform" id="myform" action = '<?php echo base_url()?>user/login' method="post">

              

             <input class="" style="height:10px;width:100px;font-size:11px;" type="text" id="mm_email" name="mm_email" placeholder="Email or Username" value="<?php echo set_value('mm_email'); ?>">
             <input class="" style="height:10px;width:100px;font-size:11px;" type="password" id="mm_password" name="mm_password" placeholder="<?php echo $this->lang->line('text_password');?>" value="<?php echo set_value('mm_password'); ?>">
             <input type="submit" style="" value="<?php echo $this->lang->line('btn_login');?>" class="btn1 btn1-primary" />
             <span class="help-inline" style="margin-bottom:10px;"><a href="<?php echo base_url('user/forgot_password.html');?>" data-tip1="<?php  echo 'Forgot Password?';?>"><img style="height:20px; width:20px;" src="<?php echo base_url(); ?>images/forgot_password.png"></a></span>
...
<div class="container">
    ...
    <div class="span10 main_menu" align="right"  style="width:715px;">
    	...
    	<ul class="lavaLamp">
          ...
          <!--added by ketan 20130807-->
			...
			<li><a href="<?php echo base_url();?>info/convention">Texas Convention 2015</a></li>
			<!--update end-->
