<?php error_reporting(0);		
 ...
 $this->load->view('admincp_convention/layout/header'); 
		...
		<?php 
...

					{
						...
						{?>
						  ...
						  <a href="<?php echo base_url().'admincp_convention/user/queue_mail/'.$row->uid;?>" title="send"><b>Send</b></a>
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'admincp_convention/user/start_mail/'.$row->uid;?>" ><center>start</center></a></div> 
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'admincp_convention/user/stop_mail/'.$row->uid;?>" ><center>stop</center></a></div> 
						...
						{?>
							...
							<div  id="stop"  ><a href="<?php echo base_url().'admincp_convention/user/resume_mail/'.$row->uid;?>" ><center>Resume</center></a></div> 
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
		  ...
		  url: BASE_URI+"admincp_convention/user/cron_check/"+uid,
		  ...
		  success: function(data) {
...

					{
						...
						var url = "<?php echo base_url().'admincp_convention/user/edit_newsletter/'?>"+uid;    
...

						{
							...
							var url = "<?php echo base_url().'admincp_convention/user/delete_newsletter/'?>"+uid;    
