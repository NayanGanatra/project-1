     ...
     <tr>
          ...
          <td></td>
		   ...
		   <td colspan="3">
               ...
               <div class="">
            	<div class="controls">
				<label style="width:200px; font-width:bold; "><b>Become A Life Member  Nutan:</b></label><input type="checkbox" name="txtem_life_member" id="txtem_life_member" onchange="add_in_total()" style="vertical-align: sub;"/> (250$)
