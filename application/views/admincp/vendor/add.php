  ...
  <tr>
  	<td>
        ...
        <hr />
                ...
                <div class="controls">
                  <textarea name="vender_address" id="vender_address" class="input-xxlarge" style="min-width:530px; width:auto; min-height:100px;"><?php echo set_value('vender_address'); ?></textarea>
                ...
                <input type="hidden" id="" name="vendor_created_by" value="<?php echo 'admin';?>">
