...
<table border="0" cellspacing="2" cellpadding="2" width="100%" class="table table-hover">
    ...
    <tr <?php if($row->ads_status == "1") { echo "class=''"; }else{ echo "class='error'"; } ;?>>
        ...
        <td><a href="<?php echo base_url(); ?>chapteradmincp/advertisements/edit/<?php echo $row->ads_id; ?>" title="<?php echo $this->lang->line('misc_edit');?>"><?php echo $this->lang->line('misc_edit');?></a></td>
        <td><a href="<?php echo base_url();?>chapteradmincp/advertisements/delete/<?php echo $row->ads_id; ?>" title='<?php echo $this->lang->line('misc_delete');?>' onclick="javascript: return del();"><?php echo $this->lang->line('misc_delete');?></a></td>
    </tr>
