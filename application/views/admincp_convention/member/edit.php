             ...
             <div  class="controls addremove"  style="height: 25px;">
           		<table width="100%"   border="1" >
                    ...
                    <td width="30%" style="background-color:#FAFCD9;">
                     <input class="toclear" type="text" id="name[]"  name="name[]"  value="<?php echo $row->fees_att_name; ?>"  style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    <td width="12%" style="background-color:#FAFCD9;">
                     <input class="toclear" type="text" id="rel[]"  name="rel[]"  value="<?php echo $row->fees_mm_rel; ?>"  style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    <td  width="8%" style="background-color:#FAFCD9;">
                 	<input class="toclear"  onkeyup="ageof()" onkeypress="ageof()"  id="age[]"  name="age[]"  type="text" value="<?php echo $row->fees_mm_age; ?>"  style=" width:98%; margin:0; padding:0;"/>
                    </td>
                    <td width="15%" style="background-color:#FFCC99;">
                     <input class="toclear" type="text"  id="menu_ch[]"  name="menu_ch[]" value="<?php echo $row->fees_menu_choice; ?>"  style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    <td width="15%" style="background-color:#CCEBFF;">
                     <input class="toclear"  id="age_grp[]" name="age_grp[]"  type="text" value="<?php echo $row->fees_age_grp; ?>"  style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    <td width="10%" style="background-color:#CCEBFF;">
                     <input class="toclear"    id="fees[]"  name="fees[]" type="text"  value="<?php echo $row->fees; ?>"  style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    </tr>   
                  </table>
