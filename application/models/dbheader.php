...

{
	...
	{
		$sql="select * from con_texas_fees_allmember where fm_reg_num = '".$username."' and fm_email='".$email."' LIMIT 1";
	...
	//update pradip 2013/10/30
	function get_con()

	{

		$sql = "SELECT * FROM admin_convention WHERE '".date("Y-m-d H:i:s")."' > con_start_date AND '".date("Y-m-d H:i:s")."' < con_end_date AND con_status !=0 ORDER BY con_id";
