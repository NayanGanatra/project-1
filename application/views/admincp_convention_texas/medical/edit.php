  ...
  <tr>
  	...
  	<td>
    	...
    	<div class="dotted_line">
		        ...
		        <h1>Medical Release Form <small>Edit Medical Release Form</small></h1>
			...
			<div >
                        ...
                        <a href="<?php echo base_url('admincp_convention_texas/medical/medical_detail_export_to_excel/'.$get_details->md_id);?>" id="exportexcel" style="width:100px;float:right;" class="dropdown-toggle" >Export to excel</a>
                ...
                <select name="md_mm_id" data-placeholder="Select a Member..." class="chzn-select" style="width:400px;" tabindex="1">
                  ...
                  <?php
...

					{
						...
						<option <?php if($get_details->md_mm_id == $con_members_row->mm_id) { ;?> selected="selected" <?php }?> value="<?php echo $con_members_row->mm_id; ?>"><?php echo $con_members_row->mm_fname.' '.$con_members_row->mm_lname.' - '.$con_members_row->mm_email; ?></option>
		...
		<div class="control-group <?php if(form_error('md_name')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Name</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_name" value="<?php echo $get_details->md_name; ?>" placeholder="Enter Name">
</br>
    ...
    <div style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
            ...
            <div class="controls">
            	...
            	<select tabindex="15" class="input-small" name="md_birth_month">
                	...
                	<option <?php if($get_details->md_birth_month == 1){ echo 'selected="selected"';}?> value="1">Jan</option>

                    <option <?php if($get_details->md_birth_month == 2){ echo 'selected="selected"';}?> value="2">Feb</option>

                    <option <?php if($get_details->md_birth_month == 3){ echo 'selected="selected"';}?> value="3">Mar</option>

                    <option <?php if($get_details->md_birth_month == 4){ echo 'selected="selected"';}?> value="4">Apr</option>

                    <option <?php if($get_details->md_birth_month == 5){ echo 'selected="selected"';}?> value="5">May</option>

                    <option <?php if($get_details->md_birth_month == 6){ echo 'selected="selected"';}?> value="6">Jun</option>

                    <option <?php if($get_details->md_birth_month == 7){ echo 'selected="selected"';}?> value="7">Jul</option>

                    <option <?php if($get_details->md_birth_month == 8){ echo 'selected="selected"';}?> value="8">Aug</option>

                    <option <?php if($get_details->md_birth_month == 9){ echo 'selected="selected"';}?> value="9">Sep</option>

                    <option <?php if($get_details->md_birth_month == 10){ echo 'selected="selected"';}?> value="10">Oct</option>

                    <option <?php if($get_details->md_birth_month == 11){ echo 'selected="selected"';}?> value="11">Nov</option>

                    <option <?php if($get_details->md_birth_month == 12){ echo 'selected="selected"';}?> value="12">Dec</option>
            ...
            <input tabindex="16" class="span1" type="text" id="mm_birth_year" name="md_birth_year" placeholder="Year" value="<?php echo $get_details->md_birth_year; ?>">
            ...
            <div class="controls">
            	...
            	<select tabindex="18" class="input-small" name="md_sex">
                	...
                	<option <?php if($get_details->md_sex == 0){ echo 'selected="selected"';}?> value="0">Male</option>

                    <option <?php if($get_details->md_sex == 1){ echo 'selected="selected"';}?> value="1">Female</option>
    ...
    <div class="row">
    	...
    	<div class="control-group <?php if(form_error('md_address')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Address</label>
				...
				<div class="controls">
                    ...
                    <textarea class="input-xlarge" id="covers_cat_name" name="md_address" placeholder="Enter Address"><?php echo $get_details->md_address; ?></textarea>
</br>
        ...
        <div class="control-group <?php if(form_error('md_home_phone')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Home Phone</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_home_phone" value="<?php echo $get_details->md_home_phone; ?>" placeholder="Enter home phone">
</br>
		...
		<div class="control-group <?php if(form_error('md_cellphone')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<div class="controls">
				...
				<input class="input-xlarge" type="text" id="covers_cat_name" name="md_cellphone" value="<?php echo $get_details->md_cellphone; ?>" placeholder="Enter cell phone">
</br>
    ...
    <div class="row">
               ...
               <!-- /*edit*/-->
                ...
                <?php
...

					{
                        ...
                        <option <?php if($get_details->md_state == $get_states_row->state_id){ echo 'selected="selected"';}?> value="<?php echo $get_states_row->state_id; ?>"><?php echo $get_states_row->state_name; ?></option>
            ...
            <div class="control-group <?php if(form_error('md_zip')){ echo "error";}?>" style="float:left;width:auto;margin-left:45px;margin-bottom:0px;">

            <label class="control-label">Zip</label>

            <div class="controls">

            	<input class="" type="text" id="covers_cat_name" name="md_zip" value="<?php echo $get_details->md_zip; ?>" placeholder="Enter Zip Code">
		...
		<div class="control-group <?php if(form_error('md_name1')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Name</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_name1" value="<?php echo $get_details->md_name1; ?>" placeholder="Enter Name">
</br>
    ...
    <div class="control-group <?php if(form_error('md_rel1')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
            ...
            <div class="controls">
            	...
            	<select tabindex="17" class="input-small" name="md_rel1">
                    ...
                    <option <?php if($get_details->md_rel1 == 'Wife'){ echo 'selected="selected"';}?> value="Wife">Wife</option>

                    <?php //} else { ?>

                    <option <?php if($get_details->md_rel1 == 'Husband'){ echo 'selected="selected"';}?> value="Husband">Husband</option>

                    <?php //} ?>

                    <option <?php if($get_details->md_rel1 == 'Father'){ echo 'selected="selected"';}?> value="Father">Father</option>

                    <option <?php if($get_details->md_rel1 == 'Mother'){ echo 'selected="selected"';}?> value="Mother">Mother</option>

                    <option <?php if($get_details->md_rel1 == 'Brother'){ echo 'selected="selected"';}?> value="Brother">Brother</option>

                    <option <?php if($get_details->md_rel1 == 'Sister'){ echo 'selected="selected"';}?> value="Sister">Sister</option>

                    <option <?php if($get_details->md_rel1 == 'Son'){ echo 'selected="selected"';}?> value="Son">Son</option>

                    <option <?php if($get_details->md_rel1 == 'Daughter'){ echo 'selected="selected"';}?> value="Daughter">Daughter</option>
    ...
    <div class="row">
    	...
    	<div class="control-group <?php if(form_error('md_address1')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Address</label>
				...
				<div class="controls">
                    ...
                    <textarea class="input-xlarge" id="covers_cat_name" name="md_address1" placeholder="Enter Address"><?php echo $get_details->md_address1; ?></textarea>
</br>
        ...
        <div class="control-group <?php if(form_error('md_home_phone1')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Home Phone</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_home_phone1" value="<?php echo $get_details->md_home_phone1; ?>" placeholder="Enter home phone">
</br>
		...
		<div class="control-group <?php if(form_error('md_cellphone1')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<div class="controls">
				...
				<input class="input-xlarge" type="text" id="covers_cat_name" name="md_cellphone1" value="<?php echo $get_details->md_cellphone1; ?>" placeholder="Enter cell phone">
</br>
    ...
    <div class="row">
               ...
               <!-- /*edit*/-->
                ...
                <?php
...

					{
                        ...
                        <option <?php if($get_details->md_state1 == $get_states_row->state_id){ echo 'selected="selected"';}?> value="<?php echo $get_states_row->state_id; ?>"><?php echo $get_states_row->state_name; ?></option>
            ...
            <div class="controls">
            	...
            	<input class="" type="text" id="covers_cat_name" name="md_zip1" value="<?php echo $get_details->md_zip1; ?>" placeholder="Enter Zip Code">
		...
		<div class="control-group <?php if(form_error('md_name2')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Name</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_name2" value="<?php echo $get_details->md_name2; ?>" placeholder="Enter Name">
</br>
    ...
    <div class="control-group <?php if(form_error('md_rel2')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
            ...
            <div class="controls">
            	...
            	<select tabindex="17" class="input-small" name="md_rel2">
                    ...
                    <option <?php if($get_details->md_rel2 == 'Wife'){ echo 'selected="selected"';}?> value="Wife">Wife</option>

                    <?php //} else { ?>

                    <option <?php if($get_details->md_rel2 == 'Husband'){ echo 'selected="selected"';}?> value="Husband">Husband</option>

                    <?php //} ?>

                    <option <?php if($get_details->md_rel2 == 'Father'){ echo 'selected="selected"';}?> value="Father">Father</option>

                    <option <?php if($get_details->md_rel2 == 'Mother'){ echo 'selected="selected"';}?> value="Mother">Mother</option>

                    <option <?php if($get_details->md_rel2 == 'Brother'){ echo 'selected="selected"';}?> value="Brother">Brother</option>

                    <option <?php if($get_details->md_rel2 == 'Sister'){ echo 'selected="selected"';}?> value="Sister">Sister</option>

                    <option <?php if($get_details->md_rel2 == 'Son'){ echo 'selected="selected"';}?> value="Son">Son</option>

                    <option <?php if($get_details->md_rel2 == 'Daughter'){ echo 'selected="selected"';}?> value="Daughter">Daughter</option>
    ...
    <div class="row">
    	...
    	<div class="control-group <?php if(form_error('md_address2')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Address</label>
				...
				<div class="controls">
                    ...
                    <textarea class="input-xlarge" id="covers_cat_name" name="md_address2" placeholder="Enter Address"><?php echo $get_details->md_address2; ?></textarea>
</br>
        ...
        <div class="control-group <?php if(form_error('md_home_phone2')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Home Phone</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_home_phone2" value="<?php echo $get_details->md_home_phone2; ?>" placeholder="Enter home phone">
</br>
		...
		<div class="control-group <?php if(form_error('md_cellphone2')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<div class="controls">
				...
				<input class="input-xlarge" type="text" id="covers_cat_name" name="md_cellphone2" value="<?php echo $get_details->md_cellphone2; ?>" placeholder="Enter cell phone">
</br>
    ...
    <div class="row">
               ...
               <!-- /*edit*/-->
                ...
                <?php
...

					{
                        ...
                        <option <?php if($get_details->md_state2 == $get_states_row->state_id){ echo 'selected="selected"';}?> value="<?php echo $get_states_row->state_id; ?>"><?php echo $get_states_row->state_name; ?></option>
            ...
            <div class="controls">
            	...
            	<input class="" type="text" id="covers_cat_name" name="md_zip2" value="<?php echo $get_details->md_zip2; ?>" placeholder="Enter Zip Code">
    	...
    	<div class="control-group <?php if(form_error('md_dr_name3')){ echo "error";}?>" style="margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Name</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_dr_name3" value="<?php echo $get_details->md_dr_name3; ?>" placeholder="Enter Name">
</br>
    	...
    	<div class="control-group <?php if(form_error('md_dr_address3')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Address</label>
				...
				<div class="controls">
                    ...
                    <textarea class="input-xlarge" id="covers_cat_name" name="md_dr_address3"><?php echo $get_details->md_dr_address3; ?></textarea>
</br>
        ...
        <div class="control-group <?php if(form_error('md_dr_phone3')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Phone</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_dr_phone3" value="<?php echo $get_details->md_dr_phone3; ?>" placeholder="Enter home phone">
</br>
    ...
    <div class="row">
               ...
               <!-- /*edit*/-->
                ...
                <?php
...

					{
                        ...
                        <option <?php if($get_details->md_dr_state3 == $get_states_row->state_id){ echo 'selected="selected"';}?> value="<?php echo $get_states_row->state_id; ?>"><?php echo $get_states_row->state_name; ?></option>
            ...
            <div class="controls">
            	...
            	<input class="" type="text" id="covers_cat_name" name="md_dr_zip3" value="<?php echo $get_details->md_dr_zip3; ?>" placeholder="Enter Zip Code">
     ...
     <div class="row">  
       <div class="control-group <?php if(form_error('radio')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
            ...
            <div class="controls" style="float:left;margin-left:20px;">
            	...
            	<input class="" style="margin-top:-1px;" type="radio" id="" name="radio" value="1" <?php if($get_details->md_lim_activities == '1'){?> checked="checked" <?php } ?>> yes
                
                <input class="" style="margin-top:-1px;margin-left:5px;" type="radio" id="" name="radio" value="0" <?php if($get_details->md_lim_activities == '0'){?> checked="checked" <?php } ?>> No
    ...
    <div class="row">  
       <div class="control-group <?php if(form_error('radio1')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
            ...
            <div class="controls" style="float:left;margin-left:20px;">
            	...
            	<input class="" style="margin-top:-1px;" type="radio" id="" name="radio1" value="1" <?php if($get_details->md_allergic == '1'){?> checked="checked" <?php } ?>> yes
                
                <input class="" style="margin-top:-1px;margin-left:5px;" type="radio" id="" name="radio1" value="0" <?php if($get_details->md_allergic == '0'){?> checked="checked" <?php } ?>> No
    ...
    <div class="row">  
       <div class="control-group <?php if(form_error('radio2')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
            ...
            <div class="controls" style="float:left;margin-left:20px;">
            	...
            	<input class="" style="margin-top:-1px;" type="radio" id="" name="radio2" value="1" <?php if($get_details->md_take_med == '1'){?> checked="checked" <?php } ?>> yes
                
                <input class="" style="margin-top:-1px;margin-left:5px;" type="radio" id="" name="radio2" value="0" <?php if($get_details->md_take_med == '0'){?> checked="checked" <?php } ?>> No
    ...
    <div class="row">  
       <div class="control-group <?php if(form_error('radio3')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
            ...
            <div class="controls" style="float:left;margin-left:20px;">
            	...
            	<input class="" style="margin-top:-1px;" type="radio" id="" name="radio3" value="1" <?php if($get_details->md_other_med_info == '1'){?> checked="checked" <?php } ?>> yes
                
                <input class="" style="margin-top:-1px;margin-left:5px;" type="radio" id="" name="radio3" value="0" <?php if($get_details->md_other_med_info == '0'){?> checked="checked" <?php } ?>> No
   ...
   <div class="row">     
        <div class="control-group <?php if(form_error('md_insurance_cmp_name')){ echo "error";}?>" style="float:left;width:auto;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Company Name</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_insurance_cmp_name" value="<?php echo $get_details->md_insurance_cmp_name; ?>" placeholder="Enter home phone">
</br>
        ...
        <div class="control-group <?php if(form_error('md_insurance_plc_no')){ echo "error";}?>" style="float:left;width:auto;margin-left:50px;margin-bottom:0px;">
			...
			<label class="control-label" for="inputError">Policy Number</label>
				...
				<div class="controls">
                    ...
                    <input class="input-xlarge" type="text" id="covers_cat_name" name="md_insurance_plc_no" value="<?php echo $get_details->md_insurance_plc_no; ?>" placeholder="Enter policy number">
</br>
       ...
       <?php date_default_timezone_set("Asia/Kolkata"); ?>    
        ...
        <input type="hidden" id="" name="md_created_date" value="<?php echo $get_details->md_created_date; ?>">

        <input type="hidden" id="" name="md_created_by" value="<?php echo $get_details->md_created_by; ?>">
		
        <input type="hidden" id="" name="md_modified_date" value="<?php echo date("Y-m-d H:i:s"); ?>">

        <input type="hidden" id="" name="md_modified_by" value="<?php echo 'admin';?>">
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/<?php echo $get_details->md_state;?>/<?php echo $get_details->md_city;?>',
...
$('#mm_state_id').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/'+$('#mm_state_id').val(),
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/<?php echo $get_details->md_state1;?>/<?php echo $get_details->md_city1;?>',
...
$('#mm_state_id1').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/'+$('#mm_state_id1').val(),
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/<?php echo $get_details->md_state2;?>/<?php echo $get_details->md_city2;?>',
...
$('#mm_state_id2').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/'+$('#mm_state_id2').val(),
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/<?php echo $get_details->md_dr_state3;?>/<?php echo $get_details->md_dr_city3;?>',
...
$('#mm_state_id3').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/medical/get_city/'+$('#mm_state_id3').val(),
