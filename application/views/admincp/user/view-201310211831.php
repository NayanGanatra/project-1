  	...
  	<td>
        ...
        <div class="dotted_line">
            ...
            <div class="span5 offset sub_link" align="right">
            	...
            	<select class="input-xlarge" name="member_chapter" id="member_chapter" style="width:130px; margin:0;">
				...
				?>
                        ...
                        <input style="margin-top:10px;" class="input-large" type="text" id="member_search" name="member_search" placeholder="Search by name, username or email" value="<?php echo $this->session->userdata('search'); ?>">
...
<!--update end-->
        ...
        <td><a href="mailto:<?php echo $rowB->mm_email; ?>"><?php echo $row->mm_email; ?></a></td>
