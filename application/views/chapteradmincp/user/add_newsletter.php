...
<table width="1020" border="0" cellspacing="0" cellpadding="0" align="center" style="min-height:300px;"> 
 ...
 <b>User Info:</b>{userinfo}<br />
            ...
            <label class="control-label">Queued Newsletter</label>
                ...
                <div  style="width:150px; height:26px"class="controls" data-tip1="<?php  echo 'First Option Only Save Data';?>"  >
            ...
            <?php 
                ...
                {		
            ?>
                    <input type="hidden" id="" name="newsletter_created_by" value="<?php echo $username->mm_username;?>">
            <?php
                }
            ?>
