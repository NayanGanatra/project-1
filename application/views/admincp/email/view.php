		    ...
		    <tr>
				...
				$chapter = $this->dbadminheader->get_chapters();
...

                    {
						...
						$ch_to_email = $this->dbadminheader->ch_to_email($row->uid,$chapter_row->ch_id); 
				...
				<?php 
...

					{
						...
						{?>
						  ...
						  <a href="<?php echo base_url().'admincp/email/queue_mail/'.$row->uid;?>" title="send"><b>Send</b></a>
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'admincp/email/start_mail/'.$row->uid;?>" ><center>start</center></a></div> 
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'admincp/email/stop_mail/'.$row->uid;?>" ><center>stop</center></a></div> 
						...
						{?>
							...
							<div  id="stop"  ><a href="<?php echo base_url().'admincp/email/resume_mail/'.$row->uid;?>" ><center>Resume</center></a></div> 
		        ...
		        <a onclick="check(<?php echo $row->uid;?>,'delete')" id="delete"  href="javascript:void(0)" title="Delete"><i class="icon-minus-sign"></i></a></td>
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
		  ...
		  url: BASE_URI+"admincp/email/cron_check/"+uid,
		  ...
		  success: function(data) {
...

					{
						...
						var url = "<?php echo base_url().'admincp/email/edit/'?>"+uid;    
...

						{
							...
							var url = "<?php echo base_url().'admincp/email/delete/'?>"+uid;    
