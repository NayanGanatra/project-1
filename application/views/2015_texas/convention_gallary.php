     ...
     <!------update_monita20130924-------------->       
              ...
              ?>
                   ...
                   <div style="margin-bottom:35px; margin-top:15px!important;" align="center"><span><strong><?php echo $row->ca_name; ?></strong></span></div> 
                     ...
                     <a class="thums_hovers" title="<?php //	echo $gallery->cg_title; ?>" href="<?php echo base_url($this->config->item('convention_texas_folder_with_slash').'convention/convention_gallarypage/'.$row->ca_id.""); ?>" style="margin-top:-9px;">
