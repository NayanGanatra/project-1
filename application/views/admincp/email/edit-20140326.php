  ...
  <tr>
  	...
  	<td>
    	...
    	<div class="dotted_line">
		    ...
		    <h1>Mass <?php echo $this->lang->line('text_email');?> <small>Edit</small></h1>
        ...
        <hr>
            ...
            <div class="control-group <?php if(form_error('html')){ echo "error";}?>" style="float:left; width:950px;"  >
                ...
                <div style="position: absolute;    right: 288px;    top: 280px;    width: 97px;" id="email_preview" ><a data-tip1="<?php  echo 'Press Here To See Email Preview.';?>" href="javascript:void(0)" ><center>Email Preview</center></a></div>
                    ...
                    <td>
						...
						<span class="span3">
                            ...
                            <label class="checkbox">
                                 ...
                                 <input <?php $ch_to_template_id = $this->dbadminheader->ch_to_template_id($item->uid,$chapter_row->ch_id);  if($ch_to_template_id){array_push($arr_ch_id,$chapter_row->ch_id);$ij++;echo 'checked="checked"'; }?>  type="checkbox" id="chapter[]" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>"  />  <?php echo $chapter_row->ch_name; ?>
                            ...
                            <div style='float:left;'  class="span111">
                             ...
                             <div id="top_data">
                                ...
                                <th colspan="4">
                                 ...
                                 <b><center>Member Details<center></b></th>
...
<?php /////////////////////////////////////////////////////////////////////////pradip_201403211130//////////////////////////////////////////////?>                                    
 ...
 <?php 
			 ...
			 $mm_id_edit = $this->dbadminheader->fetch_user_for_edit_email($item->uid);
    ...
    <div  id="cnt_user" style="float:left; width:auto" ><a  href="javascript:void(0)" data-tip1="<?php  echo 'Please Select At Least One Chapter Before Select User. Press Here To See List Of user.';?>" ><center>Select user</center></a></div>
    <div id="cnt_sel_user" style=" float:left;padding:3px 0 0 15px;  color:#F00; font-weight:bold; font-size:13px" ><?php echo $i?> User Selected</div>
...
';?>">
            ...
            <input type="hidden" id="" name="email_created_date" value="<?php echo $item->email_created_date; ?>">

            <input type="hidden" id="" name="email_created_by" value="<?php echo $item->email_created_by; ?>">

            <input type="hidden" id="" name="email_modified_date" value="<?php echo date("Y-m-d H:i:s"); ?>">

            <input type="hidden" id="" name="email_modified_by" value="<?php echo 'admin';?>">
            ...
            <input type="hidden" id="status_check" value="" />
            <?php /////////////////////////////////////////////////////////////////////////end//////////////////////////////////////////////?>
...

	{
...

		{
			...
			$.ajax({
				...
				//url: BASE_URI+"admincp/email/user_check_uncheck_all/edit/"+uid+"/"+n_ch+"/true/"+type+"/"+$('#offset').val(),

				url: BASE_URI+"admincp/email/user_check_uncheck_all/",
				
	 /////////////////////////////////////////////////////////////////////////pradip_201403211130//////////////////////////////////////////////
				data :'status=edit&id='+uid+'&ch_id='+n_ch+'&action=true&type='+type+'&offeset='+$('#offset').val()+'&m_type='+$('#m_type').val()+'&m_search='+$('#username').val(),
	/////////////////////////////////////////////////////////////////////////end//////////////////////////////////////////////
...
$('div#custom_box').removeClass("custom_box_css");
...

	{
...

		{
			...
			data :'status=edit&id='+uid+'&ch_id='+n_ch+'&action=false&type='+type+'&offeset='+$('#offset').val()+'&m_type='+$('#m_type').val()+'&m_search='+$('#username').val(),
...
var mm_type=document.getElementById('mm_type').value;
			...
			url: BASE_URI+"admincp/email/get_template_user/",

			data :'mm_type='+mm_type+'&username='+username+'&id='+<?php echo $item->uid; ?>+'&ch_id='+ n+'&offset='+0+'&fetch_user_data='+fetch_user_data+'&check_uncheck_all_user_status='+$('#check_uncheck_all_user_status').val(),
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp/email/check_uncheck_all_user/'+$('#check_uncheck_all_user_status').val(),
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp/email/check_uncheck_all_user/'+$('#chkall_check').val(),
   ...
   var mm_type=document.getElementById('mm_type').value;
   	...
   	$.ajax({
		  ...
		  url: BASE_URI+"admincp/email/get_template_user/",
		   ...
		   data :'mm_type='+mm_type+'&username='+username+'&id='+<?php echo $item->uid; ?>+'&ch_id='+ n+'&offset='+offset+'&fetch_user_data='+fetch_user_data+'&check_uncheck_all_user_status='+$('#check_uncheck_all_user_status').val(),
...
$('div#custom_box').addClass("custom_box_css");
	...
	url: BASE_URI+"admincp/email/user_check_uncheck/edit/"+uid+"/"+m_id+"/"+action,
...
$('div#custom_box').addClass("custom_box_css");
	...
	for (var i = 0, l = ln_user; i < l; i++) {
		...
		$.ajax({
		  ...
		  url: BASE_URI+"admincp/email/edit_user/<?php echo $item->uid; ?>/"+n_chapter+"/"+j_user,
		  ...
		  success: function(data) {
			...
			$('#status_check').val(document.getElementById('check_uncheck_all_user_status').value);
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
		   ...
		   url: BASE_URI+"admincp/email/email_info/",
