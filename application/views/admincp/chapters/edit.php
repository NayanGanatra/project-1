  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1>Chapter <small>Edit</small></h1>
		</div>
        <hr />
         <?php
            ...
            <div class="control-group <?php if(form_error('ch_name')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input type="text" id="ch_name" name="ch_name" value="<?php echo $get_page->ch_name; ?>">
            ...
            <div class="control-group <?php if(form_error('ch_seo')){ echo "error";}?>">
                ...
                <div class="controls">
                    <input type="text" id="ch_seo" name="ch_seo" value="<?php echo $get_page->ch_seo; ?>">
            ...
            <div class="controls">
                <textarea style="width:80%; min-height:100px;"name="ch_desc" id="ch_desc"><?php echo $get_page->ch_desc; ?></textarea>
            ...
            <input type="hidden" name="ch_id" value="<?php //echo $get_ads->ch_id; ?>" />
