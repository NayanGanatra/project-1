		   ...
		   <td colspan="3">
               ...
               <div class="">
				...
				<tr>
					...
					<td colspan="10"><label style="width:200px; font-width:bold; "><b>Become Sponsor :</b></label></Td>
				</tr>
				<tr>
				<Td><input type="radio" name="txtem_life_member" id="txtem_life_member" onchange="add_in_total()" style="vertical-align: sub;"/>(250$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(600$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(800$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(1200$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(2000$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total2()" style="vertical-align: sub;"/>(5000$)</Td>
				</tr>
				<Tr>
				<Td></Td>
				
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total2()" style="vertical-align: sub;"/>(7500$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(12500$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(15000$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(20000$)</Td>
				<Td><input type="radio" name="sponsor_member" id="sponsor_member" onchange="add_in_total()" style="vertical-align: sub;"/>(30000$)</Td>
				</tr></table>
                </div>
				</div>
				</div>
...
function add_in_total2()
{
	var n = $("#sponsor_member").prop('checked');
