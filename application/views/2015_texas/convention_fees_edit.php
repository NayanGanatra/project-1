  ...
  <tr>
  	<td>
    	 	<?php
                ...
                //echo form_open(base_url().$this->config->item('convention_texas_folder_with_slash').'convention/registration/'.$query1->fm_id, $form_attributes);

            ?>
            <form name="myform" id="myform" action = <?php echo base_url().$this->config->item('convention_texas_folder_with_slash'); ?>convention/registration/<?php echo $query1->fm_id; ?> method="post">
        <?php
			if ($query1)
			{
		...
		?>
           ...
           <td>
				<div style="float:left;" class="ped_l">
                Address1 : <b style=" border-bottom:0px solid #000; padding-bottom:3px;"><?php echo $chapter->mm_address; ?></b>
                </div>
           </td>
           </tr>
           <tr>
		...
		if ($query)
		{
			...
			<input type="hidden" value="<?php echo $row->fm_rel_mm_id; ?>" name="hdnids[]" class="hdnids"/>
				...
				<table width="93%" border="1" class="add_rm_before" style="margin-left:3.1%" >
                    ...
                    <td width="30%" style="">
                     <input class="toclear" type="text" id="name[]" readonly="" name="name[]" value="<?php echo $row->fmg_att_name; ?>" style=" width:99%; margin:0; padding:0;"/>
                    </td>
                    <td width="14%" style="">
                    ...
                    <input class="toclear" onkeyup="ageof()" readonly="" onkeypress="ageof();"  onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" id="age_<?php echo $row->fm_rel_mm_id; ?>"  name="age[]"  type="text" value="<?php echo $row->fmg_mm_age; ?>"  style=" width:100%; margin:0; padding:0;"/>
                    ...
                    <option value="T" <?php if($row->fmg_menu_choice=='T'){ ?> selected="selected" <?php } ?>>T</option>
                    <option value="C" <?php if($row->fmg_menu_choice=='C'){ ?> selected="selected" <?php } ?>>C</option>
                    </select>
			...
			<input type="hidden" value="<?php echo $chapter->mm_id; ?>" name="hdnids[]" class="hdnids"/>
				...
				<table width="93%" border="1" class="add_rm_before" style="margin-left:3.1%" >
                    ...
                    <input class="toclear" id="age_<?php echo $chapter->mm_id; ?>" onkeyup="ageof()" readonly="" onkeypress="ageof();" onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" id="age[]"  name="age[]"  type="text" value=""  style=" width:100%; margin:0; padding:0;"/>						
			...
			?>
			  <div  class="controls addremove mystyle"  style="height: 25px;">
				...
				<table width="93%" border="1" class="add_rm_before" style="margin-left:3.1%" >
                    ...
                    <td width="15%" style="background-color:#7d7d7d;">
                    <select class="toclear" id="menu_ch[]" name="menu_ch[]" style=" width:99%; margin:0; padding:0;height:22px;">
                    <option value="T" <?php if($row1->fmg_menu_choice=='T'){ ?> selected="selected" <?php } ?>>T</option>
                    <option value="C" <?php if($row1->fmg_menu_choice=='C'){ ?> selected="selected" <?php } ?>>C</option>
                    </select>
