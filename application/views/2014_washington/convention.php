<?php $this->load->view($this->config->item('convention_folder').'convention_header'); ?>
<div class="container">
...
<a style="margin-left:12px;" href="<?php echo base_url($this->config->item('convention_folder_with_slash').'help/index.html');?>" data-tip1="<?php  echo 'help?';?>" target="_blank" ><img style="border-radius: 10px 10px 10px 10px; height:20px; width:20px;" src="<?php echo base_url(); ?>images/help.jpg"></a>
              </div> 
...
<div class="container" onmouseover="hoverout()">
    ...
    <a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/welcome.html'); ?>"><img title="SPCSUSA.ORG" src="<?php echo base_url(); ?>images/spcs_convention/<?php echo $settings->cs_logo2; ?>" /></a></div>
    <div  style="padding:50px 0 0 0px; text-align:center; float:left; width:68%;  " ><h1 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif"><?php echo $settings->ch_name; ?> Convention  <?php echo $settings->ch_year ; ?></h1></div>
...
<div class="span10 nomargin" style="width: 775px !important;">
 <div class="page_content">
	<!--updated by ketan 201309201600-->
		<?php  $this->load->view($this->config->item('convention_folder').'convention_slider'); ?>
		  <!--update end-->
    <!-- End Elastislide Carousel --> 
    <div class="clear"></div>
    <div class="welcome-title-logo-top" style="width:100%">
    <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='welcome')  { $this->load->view($this->config->item('convention_folder').'convention_welcome'); }?>
    <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='program')  { $this->load->view($this->config->item('convention_folder').'convention_program'); }?>
    <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='medical')  { $this->load->view($this->config->item('convention_folder').'convention_medical'); }?>
    
	<?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='registration')  { $this->load->view($this->config->item('convention_folder').'convention_fees_form'); } ?>
	<?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='eventmembership')  { $this->load->view($this->config->item('convention_folder').'convention_event_form'); } ?>
	<?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='corporate_sponsors')  { $this->load->view($this->config->item('convention_folder').'corporate_sponsors'); }?>
  	<?php if($this->uri->segment(3)=='convention'  && $this->uri->segment(4)=='convention_welcomepage')   { $this->load->view($this->config->item('convention_folder').'convention_welcomepage'); }?>
    <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='detail_page')   { $this->load->view($this->config->item('convention_folder').'convention_detailpage'); }?>
    <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='pages')   { $this->load->view($this->config->item('convention_folder').'convention_pages'); }?>
    <!--added by ketan 201309181120-->
    <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='sponsors' && $this->uri->segment(5)=='all')  { $this->load->view($this->config->item('convention_folder').'convention_sponsors_all'); }?>
	<?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='sponsors' && $this->uri->segment(5)=='individual')  { $this->load->view($this->config->item('convention_folder').'convention_sponsors_individual');}?>
	<?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='sponsors' && $this->uri->segment(5)=='corporate')  { $this->load->view($this->config->item('convention_folder').'convention_sponsors_corporate'); }?>
	<!--update end-->
     <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='gallery')   { $this->load->view($this->config->item('convention_folder').'convention_gallary'); }?>
     <?php  if($this->uri->segment(3)=='convention' && $this->uri->segment(4)=='convention_gallarypage')   { $this->load->view($this->config->item('convention_folder').'convention_gallarypage'); } ?>
...
<div class="span3" style=" margin-left:13px; margin-top:-20px;width:234px;">
	...
	<strong>Register Early & Save Money.</strong> Register now for USA's largest kathiawadi conventionin <strong>Washington-DC America, Convention 2014</strong></p>
	
    <div class="space10px"></div>
    <?php
    if(!$this->session->userdata('user_id'))
	{?>
    <a href="<?php echo base_url('/user/login/convention_registration');?>"><input name="" type="image" src="<?php echo base_url(); ?>images/spcs_convention/register-now-btn.png" class="fr" /></a>
    <?php
	}
	else
	{?>
    <a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/registration.html'.'');?>"><input name="" type="image" src="<?php echo base_url(); ?>images/spcs_convention/register-now-btn.png" class="fr" /></a>
    <?php
	}?>
    <div class="clear"></div>
    </div>
...
<?php }
else  if($this->uri->segment(3)=='convention' && ($this->uri->segment(4)=='registration' || $this->uri->segment(4)=='program' || $this->uri->segment(4)=='medical' || $this->uri->segment(4)=='eventmembership')){
?>
<div class="span3" style=" margin-left:13px; margin-top:-20px;width:234px;">
    <div class="sidebar">
                <div class="bs-docs-sidebar">
                    <ul class="nav nav-list bs-docs-sidenav">
                                  <li <?php if($this->uri->segment(4)=='registration') { ?> class="active" <?php } ?>>
                                    <a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/registration.html'.'');?>">
                                    ...
                                    <li <?php if($this->uri->segment(4)=='eventmembership') { ?> class="active" <?php } ?>><a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/eventmembership.html'.'');?>">
                                    ...
                                    <li <?php if($this->uri->segment(4)=='program') { ?> class="active" <?php } ?>><a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/program.html'.'');?>">
                                    ...
                                    <li <?php if($this->uri->segment(4)=='medical') { ?> class="active" <?php } ?>><a href="<?php echo base_url($this->config->item('convention_folder_with_slash').'convention/medical.html'.'');?>">
...
<?php }?>        
<?php $this->load->view($this->config->item('convention_folder').'convention_sponsors'); ?>
<div class="clear"></div>
</div></div>
 </div>
<div class="clear"></div></div>
</div>
<?php $this->load->view($this->config->item('convention_folder').'convention_countdown'); ?>
<?php $this->load->view($this->config->item('convention_folder').'convention_footer'); ?>

</body>
</html>
<style>
[data-tip1]:after  {
    background: none repeat scroll 0 0 #F4F5B8;
    border-radius: 3px;
    bottom: 15px;
    color: #000000;
