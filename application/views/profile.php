...
<div class="span10 nomargin">
	...
	<div class="page_content">
        ...
        <div class="span7 nomargin">
            ...
            <p><?php if($user->mm_gender == '0') { echo 'Male';}else{ echo 'Female';} if($user->mm_disp_birth == '1') { echo ' - '.$user->mm_birth_month.', '.$user->mm_birth_year; } else { echo ""; }?>

            <br/><?php if($user->mm_hphone != '') { echo 'Phone : '.$user->mm_hphone;} if($user->mm_cphone != '') { echo ' Mobile : '.$user->mm_cphone;} ?></p>

          <!--  <p><a href="<?php //echo base_url('user/edit_profile.html'); ?>">Edit Profile</a></p>-->
        ...
        <?php
			...
			<?php
...

				{
					...
					<?php
						if($get_relationship_row->mm_disp_birth == '1')
						{
					...
					<?php
						...
						?>
                        	...
                        	<a href="<?php echo base_url('user/edit_profile/'.$get_relationship_row->mm_id.'.html'); ?>" title="<?php echo $this->lang->line('misc_edit');?>"><i class="icon-edit"></i></a>
