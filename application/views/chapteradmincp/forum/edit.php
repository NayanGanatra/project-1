							...
							<td>
								<span class="span3">
									<label class="checkbox">
										<input disabled="" type="checkbox" class="check" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>" <?php $chk = $this->dbadminheader->ch_to_blog($item->bid,$chapter_row->ch_id); if($chk){ echo 'checked="checked"'; } ?> />  <?php echo $chapter_row->ch_name; ?>
									</label>
								</span>
							</td>
							<?php
...
<!--updated by ketan 20130814-->
			<form action="<?php echo base_url().'chapteradmincp/forum/edit_comment/'.$item->bid; ?>" method="POST" id="savecommentreply">
			<div class="space10px"></div>
    ...
    <span id="fade1" class="black_overlay"></span>
        ...
        <tr class="show2">
			...
			<th scope="col" width="10%" style="border-top:0 none;">Type</th>
		...
		foreach($user_detail as $user_details)
		{
			...
			<td style="width:38%;">
                    <span class="span3 commreply" style="width:250px;" data-tip1="<?php echo ($user_details->text); ?>"><?php echo character_limiter($user_details->text,30); ?></span>
                </td>
                <td style="width:23%;">
		...
		foreach($reply_details as $reply_detail)
		{
			...
			<td style="width:38%;">
                    <span style="width:250px;" class="span3 commreply" data-tip1="<?php echo ($reply_detail->text); ?>"><?php echo character_limiter($reply_detail->text,30); ?></span>
                </td>
                <td style="width:23%;">
...
$('div#custom_box').addClass("custom_box_css");
			...
			url: BASE_URI+"chapteradmincp/forum/get_template_user/",
...
function edit_comment_one(com_rep_id,type,action)
{
	if(type=='comment')
	{
		...
		$.ajax({
			...
			url: BASE_URI+"chapteradmincp/forum/edit_comment_one/",
