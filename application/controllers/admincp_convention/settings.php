...

{
...

	{
...

		{
			...
			redirect(base_url().'admincp_convention/settings');
		}
        $data['settings'] = $this->dbsettings->getsetting();
		$data['title']=$this->lang->line('text_settings');
		
		$this->load->view('admincp_convention/layout/settings',$data);
	}
...

	{
		...
		$config['base_url'] = base_url().'admincp_convention/settings/slider/';
		...
		$this->load->view('admincp_convention/slider/view',$data);
...

	{
...

		{
			...
			redirect(base_url().'admincp_convention/settings/slider');
		...
		$this->load->view('admincp_convention/slider/add',$data);
...

	{
		...
		$this->load->view('admincp_convention/slider/edit',$data);
