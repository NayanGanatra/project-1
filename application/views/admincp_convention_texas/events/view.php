  ...
  <tr>
  	<td>
        ...
        <div class="span5 offset sub_link" align="right">
                ...
                echo form_open(base_url() . 'admincp_convention_texas/events/view', $form_attributes);
				...
				<div class="control-group <?php if(form_error('keywords')){ echo "error";}?>">
                    ...
                    <div >
                        ...
                        <a href="<?php echo base_url('admincp_convention_texas/events/event_export_to_excel/');?>" id="exportexcel" style="width:100px;float:right;" class="dropdown-toggle" >Export to excel</a>
		  ...
		  foreach ($query as $row)
		   {
		    ...
		    <tr>
		        ...
		        <td>
				<a href="<?php echo base_url('admincp_convention_texas/events/edit/'.$row->ce_id);?>" title="Edit"><i class="icon-edit"></i></a>
				<a href="<?php echo base_url('admincp_convention_texas/events/delete/'.$row->ce_id);?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
    			</tr>
