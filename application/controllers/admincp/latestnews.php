...
class Latestnews extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('admincp/dblatestnews');
	...
	public function edit($id)
	{
		...
		else
		{
					...
					redirect(base_url().'admincp/latestnews');
				
		}
	
	
		$data['title']="Edit Latest News";
		$this->load->view('admincp/latestnews/edit',$data);
	}
	...
	public function add()
	{
		...
		$this->load->view('admincp/latestnews/add',$data);
	}
	...
	public function view()
	{
		...
		$config['base_url'] = base_url().'admincp/latestnews/view/';
		...
		$this->load->view('admincp/latestnews/view',$data);
	...
	public function delete($id)
	{
		...
		redirect(base_url().'admincp/latestnews/view');
	}
