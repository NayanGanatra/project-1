  	...
  	<td>
        ...
        <span class="span5"> 
            ...
            <span class="help-inline"><?php echo form_error('chapter'); ?></span>
				...
				<?php if($user->mm_chapter_id!=0 || $user->mm_chapter_id==0){ ?>

			   <span class="span5 nomargin">

            <div class="control-group <?php if(form_error('asadmin')){ echo "error";}?>">

            <label class="checkbox">

                <input <?php $admin = $this->dbuser->get_admin_user($user->mm_email); if($admin){ echo 'checked="checked"';}?> type="checkbox" name="asadmin" value="1" /> Assign As Admin
...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/user/get_city/<?php echo $user->mm_state_id;?>/<?php echo $user->mm_city_id;?>',
...
$('#mm_state_id').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention_texas/user/get_city/'+$('#mm_state_id').val(),
