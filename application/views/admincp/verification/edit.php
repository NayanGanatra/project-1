                    ...
                    <td>
						...
						<span class="span3">
                            ...
                            <label class="checkbox">
                                 ...
                                 <input <?php $ch_to_template_id = $this->dbadminheader->ch_to_template_id_verification($item->uid,$chapter_row->ch_id);  if($ch_to_template_id){array_push($arr_ch_id,$chapter_row->ch_id);$ij++;echo 'checked="checked"'; }?>  type="checkbox" id="chapter[]" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>"  />  <?php echo $chapter_row->ch_name; ?>
...
Use Send button from list page to start sending emails.';?>"  >
            ...
            <input type="hidden" id="" name="verification_modified_by" value="<?php echo 'admin';?>">
...
$('div#custom_box').removeClass("custom_box_css");
...

	{
...

		{
			...
			//url: BASE_URI+"admincp/verification/user_check_uncheck_all/edit/"+uid+"/"+n_ch+"/false/"+type+"/"+$('#offset').val(),
...
$('div#custom_box').addClass("custom_box_css");
	...
	url: BASE_URI+"admincp/verification/user_check_uncheck/edit/"+uid+"/"+m_id+"/"+action,
...
//$('#save_user_data').click(function() {
	...
	for (var i = 0, l = ln_user; i < l; i++) {
		...
		$.ajax({
		  ...
		  url: BASE_URI+"admincp/verification/edit_user/<?php echo $item->uid; ?>/"+n_chapter+"/"+j_user,
