  ...
  <tr>
  	...
  	<td>
    	...
    	<div class="dotted_line">
		        ...
		        <h1>Chapter <small><?php echo $this->lang->line('text_edit_page');?></small></h1>
                        ...
                        <td>
                            ...
                            <span class="span3">
                                ...
                                <label class="checkbox">
                                     ...
                                     <input <?php $ch_to_pages = $this->dbadminheader->ch_to_pages($get_page->page_id,$chapter_row->ch_id); if($ch_to_pages ){echo 'checked="checked"'; }?>  type="checkbox" class="check" name="chapter[]" value="<?php echo $chapter_row->ch_id; ?>" />  <?php echo $chapter_row->ch_name; ?>
