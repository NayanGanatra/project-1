	...
	<div class="page_content">
        ...
        <?php
			if($query)
			{
                ...
                <div class="controls">
                <input class="input-xlarge" type="text" id="event_name" name="event_name" placeholder="Event Title" value="<?php echo $query->event_name; ?>">
                ...
                <div class="controls">
                    <select name="event_status" style="width:100px;">
                        <option <?php if($query->event_status == 1){echo 'selected="selected"'; }?> value="1">Active</option>
                        <option <?php if($query->event_status == 2){echo 'selected="selected"'; }?> value="2">Archived</option>
                        <option <?php if($query->event_status == 0){echo 'selected="selected"'; }?> value="0">Inactive</option>
                    </select>
