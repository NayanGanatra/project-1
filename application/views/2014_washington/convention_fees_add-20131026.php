           ...
           <div style="width:100%;  float:left;">
			...
			<input type="hidden" value="<?php echo $chapter->mm_id; ?>" name="hdnids[]" class="hdnids"/>
				...
				<table width="93%" border="1" class="add_rm_before" style="margin-left:3.1%" >
                    ...
                    <input class="toclear"  onkeyup="ageof()" id="age_<?php echo $chapter->mm_id; ?>" readonly="" onkeypress="ageof();" onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" id="age[]"  name="age[]"  type="text" value="<?php $age = date("Y")-$chapter->mm_birth_year; echo $age; ?>"  style=" width:100%; margin:0; padding:0;"/>
			 ...
			 ?>
              <div  class="controls addremove mystyle"  style="height: 25px;">
           		<input type="checkbox" style="float: left; margin-right: 1%;" id="chk_<?php echo $family->mm_id; ?>" checked="checked" onclick="is_check(this.value);" name="chkbx<?php echo $family->mm_id; ?>" value="<?php echo $family->mm_id; ?>" class="hdnids"/>
				...
				<table width="93%" border="1" class="add_rm_before tbl_class1" style="margin-left:3.1%"  >
				 ...
				 <input class="toclear" id="age_<?php echo $family->mm_id; ?>" onkeyup="ageof()" readonly="" onkeypress="ageof();"  onkeyup="ageof();" onchange="ageof();" onmouseout="ageof();" name="age[]"  type="text" value="<?php $age = date("Y")-$family->mm_birth_year; echo $age; ?>"  style=" width:100%; margin:0; padding:0;"/>
