...
$(document).ready(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/user/get_city/<?php echo $user->mm_state_id;?>/<?php echo $user->mm_city_id;?>',
...
$('#mm_state_id').change(function() {
	...
	$.ajax({
	  ...
	  url: BASE_URI+'admincp_convention/user/get_city/'+$('#mm_state_id').val(),
