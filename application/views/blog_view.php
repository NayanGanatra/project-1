...
<a href="<?php echo base_url('blogs/add_blog'); ?>" style="float:right;"><button class="btn btn-primary">Add Blog</button></a>
		  ...
		  foreach ($query as $row)
		   {
		    ...
		    <tr>
		        ...
		        <td>
				<a href="<?php echo base_url('blogs/edit_blog/'.$row->bid);?>" title="Edit"><i class="icon-edit"></i></a>
				<a href="<?php echo base_url('blogs/delete_blog/'.$row->bid);?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
    			</tr>
