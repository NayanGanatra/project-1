...
<table  border="0" cellspacing="0" cellpadding="0" align="center" style="min-height:300px; float:left"> 
 ...
 <b>User Info:</b>{userinfo}<br />
    ...
    <div  id="cnt_user" style="float:left; width:auto" ><a href="javascript:void(0)" 
    data-tip1="<?php  echo 'Please Select At Least One Chapter Before Select User. Press Here To See List Of user.';?>" ><center>Select user</center></a></div>
...
';?>"  >
 ...
 <div class="space20px"></div>   
            ...
            <input type="hidden" id="" name="email_created_by" value="<?php echo 'admin';?>">
...

{
	...
	/////////////////////////////////////////////////////////////////////////pradip_201403211130//////////////////////////////////////////////
			...
			data :'status=add&id='+uid+'&ch_id='+n_ch+'&action=true&type='+type+'&offeset='+$('#offset').val()+'&m_type='+$('#m_type').val()+'&m_search='+$('#username').val()+'&fetch_user_data='+fetch_user_data+'&just_use='+just_use+'&fetch_user_data_after_save='+fetch_user_data_after_save,
/////////////////////////////////////////////////////////////////////////end//////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////pradip_201403211130//////////////////////////////////////////////
			...
			data :'status=add&id='+uid+'&ch_id='+n_ch+'&action=false&type='+type+'&offeset='+$('#offset').val()+'&m_type='+$('#m_type').val()+'&m_search='+$('#username').val()+'&fetch_user_data='+fetch_user_data+'&just_use='+just_use+'&fetch_user_data_after_save='+fetch_user_data_after_save,
/////////////////////////////////////////////////////////////////////////end//////////////////////////////////////////////
...
$('div#custom_box').addClass("custom_box_css");
	...
	url: BASE_URI+"admincp/email/user_check_uncheck/add/"+uid+"/"+m_id+"/"+action,
...
$('div#custom_box').addClass("custom_box_css");
	...
	for (var i = 0, l = ln_user; i < l; i++) {
		...
		$.ajax({
		  ...
		  url: BASE_URI+"admincp/email/add_user/<?php echo '0' ?>/"+n_chapter+"/"+j_user,
