...
class Chapters extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('chapteradmincp/dbchapters');
	...
	/*public function edit($id)
	{
		...
		$this->load->view('chapteradmincp/chapters/show',$data);
	}*/
	public function show($id)
	{
		if($this->session->userdata('get_chapter_id')==$id)
		{
			$data['get_page'] = $this->dbchapters->get_item($id);
	...
	public function add()
	{
		...
		$this->load->view('chapteradmincp/chapters/add',$data);
	}
	...
	public function view()
	{
		...
		$config['base_url'] = base_url().'chapteradmincp/chapters/view/';
		...
		$data['title']='Chapters';
		$this->load->view('chapteradmincp/chapters/view',$data);
	...
	public function delete($id)
	{
		...
		if ($this->agent->is_referral())
			...
			{
				redirect(base_url('chapteradmincp/chapters/view'));
			}
	}
