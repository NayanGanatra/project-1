                    	...
                    	<div class="thumbnail">
                            ...
                            <div style="height:107px;"><img src="<?php echo base_url();?>images/convention/slider/<?php echo $row->cs_image; ?>" width="230" border="0" style="height:140px; "/></div>
                                ...
                                <div class="btn-group" align="center">
                               	...
                               	<a  class="btn" href="<?php echo base_url();?>admincp_convention_texas/settings/edit_slider/<?php echo $row->cs_id; ?>" title='<?php echo $this->lang->line('misc_edit');?>'><?php echo $this->lang->line('misc_edit');?></a>

                                <a onclick="javascript: return del();" class="btn btn-danger" href="<?php echo base_url();?>admincp_convention_texas/settings/delete_slider/<?php echo $row->cs_id; ?>" title='<?php echo $this->lang->line('misc_delete');?>'><?php echo $this->lang->line('misc_delete');?></a> 
