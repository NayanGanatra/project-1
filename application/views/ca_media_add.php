...
<div class="span10 nomargin">
	<div class="page_content">
		<?php $this->load->view('action_status'); ?>
                ...
                <div class="control-group" id="photo_holder" <?php if($this->input->post('media_type') == 1){echo 'style="display:none;"';}?> >
                ...
                <div class="control-group <?php if(form_error('media_data')){ echo "error";}?>" id="media_data_holder" <?php if($this->input->post('media_type') == 1){echo 'style="display:block;"';} else { ?>style="display:none;" <?php } ?> >
                ...
                <div class="control-group" id="thumb_holder" <?php if($this->input->post('media_type') == 1){echo 'style="display:block;"';} else { ?>style="display:none;" <?php } ?>>
