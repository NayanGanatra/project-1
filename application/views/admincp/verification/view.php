  ...
  <tr>
  	...
  	<td>
		...
		<div class="dotted_line">
		        ...
		        <h1>Member Verification Email <small>Manage</small></h1>
		    ...
		    <tr>
				...
				$chapter = $this->dbadminheader->get_chapters();
...

                    {
						...
						$ch_to_email = $this->dbadminheader->ch_to_verification($row->uid,$chapter_row->ch_id); 
		        ...
		        <td><?php $tot_sub = $this->dbverification->countemailSubscribers($row->uid); echo $row->startNum.'/'.$tot_sub; ?></td>
				...
				<?php 
...

					{
						...
						{?>
						  ...
						  <a href="<?php echo base_url().'admincp/verification/queue_mail/'.$row->uid;?>" title="send"><b>Send</b></a>
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'admincp/verification/start_mail/'.$row->uid;?>" ><center>start</center></a></div> 
						...
						?>
							...
							<div  id="stop" ><a href="<?php echo base_url().'admincp/verification/stop_mail/'.$row->uid;?>" ><center>stop</center></a></div> 
						...
						{?>
							...
							<div  id="stop"  ><a href="<?php echo base_url().'admincp/verification/resume_mail/'.$row->uid;?>" ><center>Resume</center></a></div> 
                ...
                ?>
                 ...
                 <td><?php echo $row->verification_created_by; ?></td>

                <td><?php echo $row->verification_created_date; ?></td>

                <td><?php echo $row->verification_modified_by; ?></td>

                <td><?php echo $row->verification_modified_date; ?></td>
		        ...
		        <a onclick="check(<?php echo $row->uid;?>,'delete')"   href="javascript:void(0)" title="Delete"><i class="icon-minus-sign"></i></a></td>
...
function check(uid,status)
{
	var result = confirm("Are you sure you want to delete this item?");
	if (result==true) {
	   check_cron(uid,status);
	}
}
...
$('div#custom_box').addClass("custom_box_css");
	...
	$.ajax({
		  ...
		  url: BASE_URI+"admincp/verification/cron_check/"+uid,
		  ...
		  success: function(data) {
...

					{
						...
						var url = "<?php echo base_url().'admincp/verification/edit/'?>"+uid;    
...

						{
							...
							var url = "<?php echo base_url().'admincp/verification/delete/'?>"+uid;    
