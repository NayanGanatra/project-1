 <?php 
              ...
              ?>
                   ...
                   ?>
                    ...
                    <li class="span2">
                            <a class="thumbnail myrotation<?php echo $count; ?>" title="<?php echo $gallery->cg_title; ?>" href="<?php echo base_url($this->config->item('convention_texas_folder_with_slash').'convention/convention_gallarypage/'.$gallery->cg_ca_id.""); ?>" style="height:90px !important; width:150px !important;">
