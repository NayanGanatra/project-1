...
<div class="span10 nomargin">
	<div class="page_content">
		<?php $this->load->view('action_status'); ?>
                ...
                <div class="controls">
                <input class="input-xlarge" type="text" id="news_title" name="news_title" placeholder="News Title" value="<?php echo set_value('news_title'); ?>">
                ...
                <div class="controls">
                <input class="input-large" type="text" id="datepicker" name="news_create" placeholder="Date" value="<?php echo set_value('news_create'); ?>">
                ...
                <div class="controls">
                    <select name="news_status" style="width:100px;">
                        ...
                        <option <?php if(set_value('news_status') == 0){echo 'selected="selected"'; }?> value="0">Inactive</option>
                    </select>
