...
class Member extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('admincp_convention_texas/dbmember');
	...
	public function edit($id)
	{
		...
		else
		{
				...
				redirect(base_url().'admincp_convention_texas/member');
		...
		$this->load->view('admincp_convention_texas/member/edit',$data);
	...
	public function add()
	{
		...
		$this->load->view('admincp_convention_texas/member/add',$data);
	}
	public function view()
	{
		...
		$config['base_url'] = base_url().'admincp_convention_texas/member/view/';
		...
		$this->load->view('admincp_convention_texas/member/view',$data);
...

	{
		...
		redirect(base_url().'admincp_convention_texas/member/view');
