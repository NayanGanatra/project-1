...
<table width="980" border="0" cellspacing="0" cellpadding="0" align="center" style="min-height:300px;"> 
  <tr>
  	<td>
		...
		<a style="float:right;" href="<?php echo base_url(); ?>admincp/blog/mem_add">
		  ...
		  foreach ($query as $row)
		   {
		    ...
		    <tr>
		        ...
		        <td>
				<a href="<?php echo base_url('admincp/blog/mem_edit/'.$row->bid);?>" title="Edit"><i class="icon-edit"></i></a>
				<a href="<?php echo base_url('admincp/blog/mem_delete/'.$row->bid);?>" title="Delete"><i class="icon-minus-sign"></i></a></td>
    			</tr>
