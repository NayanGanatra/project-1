...

{
...

	{
		...
		$sql = "SELECT a.page_id,b.ch_id FROM pages a , chapter_to_pages b WHERE type=1 AND a.page_id = b.page_id AND b.ch_id = '".$this->session->userdata('get_chapter_id')."'";
...

	{
		...
		$sql="SELECT a.*,b.* FROM pages a,chapter_to_pages b WHERE  type=1  AND a.page_id = b.page_id AND b.ch_id = '".$this->session->userdata('get_chapter_id')."' ORDER BY page_sub_id DESC LIMIT ".$offset.", ".$num."";
