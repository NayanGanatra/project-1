...
function __construct()
	...
	function view()
	{
		...
		$num_rec = count($this->dbchapter->count_ch_news($data['chapter']->ch_id));
			...
			$data['query'] = $this->dbchapter->get_all_news($segment,$config['per_page'],$data['chapter']->ch_id);
			
			$this->pagination->initialize($config);
			
			$data['title'] = $data['chapter']->ch_name.' News';
			$data['sub_title'] = 'Latest News';
			$data['description'] = "";
			$data['keywords'] = "";
	...
	function view_all()
	{		
			$num_rec = count($this->dbchapter->count_all_news());
			...
			$data['query'] = $this->dbchapter->get_all_all_news($segment,$config['per_page']);
			
			$this->pagination->initialize($config);
			
			$data['title'] = 'National News';
			$data['sub_title'] = 'Latest News';
			$data['description'] = "";
			$data['keywords'] = "";
			$this->load->view('news',$data);
