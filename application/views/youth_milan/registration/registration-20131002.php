...
<?php $this->load->view('youth_milan/layout/header'); ?>
     <div id="loading" align="center" style="margin-top:350px!important;"><img src="<?php echo base_url();?>images/youth_milan/10.gif" /></div><!-------update-monita20130928--------->
							...
							<tbody>
                              ...
                              <tr>
                                ...
                                <select id="ym_height" name="ym_height">
                                    ...
                                    <option id="4 ft 0 in/121cms" <?php if($check1){echo set_select('ym_height','4 ft 0 in/121cms');} elseif($query1->ym_height=="4 ft 0 in/121cms") {echo 'selected="selected"';}?> value="4 ft 0 in/121cms">4 ft 0 in/121cms</option>
									<option id="4 ft 1 in/124cms" <?php if($check1){echo set_select('ym_height','4 ft 1 in/124cms');} elseif($query1->ym_height=="4 ft 1 in/124cms") {echo 'selected="selected"';}?> value="4 ft 1 in/124cms">4 ft 1 in/124cms</option>
									<option id="4 ft 2 in/127cms" <?php if($check1){echo set_select('ym_height','4 ft 2 in/127cms');} elseif($query1->ym_height=="4 ft 2 in/127cms") {echo 'selected="selected"';}?> value="4 ft 2 in/127cms">4 ft 2 in/127cms</option>
									<option id="4 ft 3 in/129cms" <?php if($check1){echo set_select('ym_height',' ft 3 in/129cms');} elseif($query1->ym_height=="4 ft 3 in/129cms") {echo 'selected="selected"';}?> value="4 ft 3 in/129cms">4 ft 3 in/129cms</option>
									<option id="4 ft 4 in/132cms" <?php if($check1){echo set_select('ym_height','4 ft 4 in/132cms');} elseif($query1->ym_height=="4 ft 4 in/132cms") {echo 'selected="selected"';}?> value="4 ft 4 in/132cms">4 ft 4 in/132cms</option>
									<option id="4 ft 5 in/134cms" <?php if($check1){echo set_select('ym_height','4 ft 5 in/134cms');} elseif($query1->ym_height=="4 ft 5 in/134cms") {echo 'selected="selected"';}?> value="4 ft 5 in/134cms">4 ft 5 in/134cms</option>
									<option id="4 ft 6 in/137cms" <?php if($check1){echo set_select('ym_height','4 ft 6 in/137cms');} elseif($query1->ym_height=="4 ft 6 in/137cms") {echo 'selected="selected"';}?> value="4 ft 6 in/137cms">4 ft 6 in/137cms</option>
									<option id="4 ft 7 in/139cms" <?php if($check1){echo set_select('ym_height','4 ft 7 in/139cms');} elseif($query1->ym_height=="4 ft 7 in/139cms") {echo 'selected="selected"';}?> value="4 ft 7 in/139cms">4 ft 7 in/139cms</option>
									<option id="4 ft 8 in/142cms" <?php if($check1){echo set_select('ym_height','4 ft 8 in/142cms');} elseif($query1->ym_height=="4 ft 8 in/142cms") {echo 'selected="selected"';}?> value="4 ft 8 in/142cms">4 ft 8 in/142cms</option>
									<option id="4 ft 9 in/144cms" <?php if($check1){echo set_select('ym_height','4 ft 9 in/144cms');} elseif($query1->ym_height=="4 ft 9 in/144cms") {echo 'selected="selected"';}?> value="4 ft 9 in/144cms">4 ft 9 in/144cms</option>
									<option id="4 ft 10 in/147cms" <?php if($check1){echo set_select('ym_height','4 ft 10 in/147cms');} elseif($query1->ym_height=="4 ft 10 in/147cms") {echo 'selected="selected"';}?> value="4 ft 10 in/147cms">4 ft 10 in/147cms</option>
									<option id="4 ft 11 in/149cms" <?php if($check1){echo set_select('ym_height','4 ft 11 in/149cms');} elseif($query1->ym_height=="4 ft 11 in/149cms") {echo 'selected="selected"';}?> value="4 ft 11 in/149cms">4 ft 11 in/149cms</option>
									<option id="5 ft 0 in/152cms" <?php if($check1){echo set_select('ym_height','5 ft 0 in/152cms');} elseif($query1->ym_height=="5 ft 0 in/152cms") {echo 'selected="selected"';}?> value="5 ft 0 in/152cms">5 ft 0 in/152cms</option>
									<option id="5 ft 1 in/154cms" <?php if($check1){echo set_select('ym_height','5 ft 1 in/154cms');} elseif($query1->ym_height=="5 ft 1 in/154cms") {echo 'selected="selected"';}?> value="5 ft 1 in/154cms">5 ft 1 in/154cms</option>
									<option id="5 ft 2 in/157cms" <?php if($check1){echo set_select('ym_height','5 ft 2 in/157cms');} elseif($query1->ym_height=="5 ft 2 in/157cms") {echo 'selected="selected"';}?> value="5 ft 2 in/157cms">5 ft 2 in/157cms</option>
									<option id="5 ft 3 in/160cms" <?php if($check1){echo set_select('ym_height','5 ft 3 in/160cms');} elseif($query1->ym_height=="5 ft 3 in/160cms") {echo 'selected="selected"';}?> value="5 ft 3 in/160cms">5 ft 3 in/160cms</option>
									<option id="5 ft 4 in/162cms" <?php if($check1){echo set_select('ym_height','5 ft 4 in/162cms');} elseif($query1->ym_height=="5 ft 4 in/162cms") {echo 'selected="selected"';}?> value="5 ft 4 in/162cms">5 ft 4 in/162cms</option>
									<option id="5 ft 5 in/165cms" <?php if($check1){echo set_select('ym_height','5 ft 5 in/165cms');} elseif($query1->ym_height=="5 ft 5 in/165cms") {echo 'selected="selected"';}?> value="5 ft 5 in/165cms">5 ft 5 in/165cms</option>
									<option id="5 ft 6 in/167cms" <?php if($check1){echo set_select('ym_height','5 ft 6 in/167cms');} elseif($query1->ym_height=="5 ft 6 in/167cms") {echo 'selected="selected"';}?> value="5 ft 6 in/167cms">5 ft 6 in/167cms</option>
									<option id="5 ft 7 in/170cms" <?php if($check1){echo set_select('ym_height','5 ft 7 in/170cms');} elseif($query1->ym_height=="5 ft 7 in/170cms") {echo 'selected="selected"';}?> value="5 ft 7 in/170cms">5 ft 7 in/170cms</option>
									<option id="5 ft 8 in/172cms" <?php if($check1){echo set_select('ym_height','5 ft 8 in/172cms');} elseif($query1->ym_height=="5 ft 8 in/172cms") {echo 'selected="selected"';}?> value="5 ft 8 in/172cms">5 ft 8 in/172cms</option>
									<option id="5 ft 9 in/175cms" <?php if($check1){echo set_select('ym_height','5 ft 9 in/175cms');} elseif($query1->ym_height=="5 ft 9 in/175cms") {echo 'selected="selected"';}?> value="5 ft 9 in/175cms">5 ft 9 in/175cms</option>
									<option id="5 ft 10 in/177cms" <?php if($check1){echo set_select('ym_height','5 ft 10 in/177cms');} elseif($query1->ym_height=="5 ft 10 in/177cms") {echo 'selected="selected"';}?> value="5 ft 10 in/177cms">5 ft 10 in/177cms</option>
									<option id="5 ft 11 in/180cms" <?php if($check1){echo set_select('ym_height','5 ft 11 in/180cms');} elseif($query1->ym_height=="5 ft 11 in/180cms") {echo 'selected="selected"';}?> value="5 ft 11 in/180cms">5 ft 11 in/180cms</option>
									<option id="6 ft 0 in/182cms" <?php if($check1){echo set_select('ym_height','6 ft 0 in/182cms');} elseif($query1->ym_height=="6 ft 0 in/182cms") {echo 'selected="selected"';}?> value="6 ft 0 in/182cms">6 ft 0 in/182cms</option>
									<option id="6 ft 1 in/185cms" <?php if($check1){echo set_select('ym_height','6 ft 1 in/185cms');} elseif($query1->ym_height=="6 ft 1 in/185cms") {echo 'selected="selected"';}?> value="6 ft 1 in/185cms">6 ft 1 in/185cms</option>
									<option id="6 ft 2 in/187cms" <?php if($check1){echo set_select('ym_height','6 ft 2 in/187cms');} elseif($query1->ym_height=="6 ft 2 in/187cms") {echo 'selected="selected"';}?> value="6 ft 2 in/187cms">6 ft 2 in/187cms</option>
									<option id="6 ft 3 in/190cms" <?php if($check1){echo set_select('ym_height','6 ft 3 in/190cms');} elseif($query1->ym_height=="6 ft 3 in/190cms") {echo 'selected="selected"';}?> value="6 ft 3 in/190cms">6 ft 3 in/190cms</option>
									<option id="6 ft 4 in/193cms" <?php if($check1){echo set_select('ym_height','6 ft 4 in/193cms');} elseif($query1->ym_height=="6 ft 4 in/193cms") {echo 'selected="selected"';}?> value="6 ft 4 in/193cms">6 ft 4 in/193cms</option>
									<option id="6 ft 5 in/195cms" <?php if($check1){echo set_select('ym_height','6 ft 5 in/195cms');} elseif($query1->ym_height=="6 ft 5 in/195cms") {echo 'selected="selected"';}?> value="6 ft 5 in/195cms">6 ft 5 in/195cms</option>
									<option id="6 ft 6 in/198cms" <?php if($check1){echo set_select('ym_height','6 ft 6 in/198cms');} elseif($query1->ym_height=="6 ft 6 in/198cms") {echo 'selected="selected"';}?> value="6 ft 6 in/198cms">6 ft 6 in/198cms</option>
									<option id="6 ft 7 in/200cms" <?php if($check1){echo set_select('ym_height','6 ft 7 in/200cms');} elseif($query1->ym_height=="6 ft 7 in/200cms") {echo 'selected="selected"';}?> value="6 ft 7 in/200cms">6 ft 7 in/200cms</option>
									<option id="6 ft 8 in/203cms" <?php if($check1){echo set_select('ym_height','6 ft 8 in/203cms');} elseif($query1->ym_height=="6 ft 8 in/203cms") {echo 'selected="selected"';}?> value="6 ft 8 in/203cms">6 ft 8 in/203cms</option>
									<option id="6 ft 9 in/205cms" <?php if($check1){echo set_select('ym_height','6 ft 9 in/205cms');} elseif($query1->ym_height=="6 ft 9 in/205cms") {echo 'selected="selected"';}?> value="6 ft 9 in/205cms">6 ft 9 in/205cms</option>
									<option id="6 ft 10 in/208cms" <?php if($check1){echo set_select('ym_height','6 ft 10 in/208cms');} elseif($query1->ym_height=="6 ft 10 in/208cms") {echo 'selected="selected"';}?> value="6 ft 10 in/208cms">6 ft 10 in/208cms</option>
									<option id="6 ft 11 in/210cms" <?php if($check1){echo set_select('ym_height','6 ft 11 in/210cms');} elseif($query1->ym_height=="6 ft 11 in/210cms") {echo 'selected="selected"';}?> value="6 ft 11 in/210cms">6 ft 11 in/210cms</option>
									<option id="7 ft 0 in/213cms" <?php if($check1){echo set_select('ym_height','7 ft 0 in/213cms');} elseif($query1->ym_height=="7 ft 0 in/213cms") {echo 'selected="selected"';}?> value="7 ft 0 in/213cms">7 ft 0 in/213cms</option>
                                </select>
                              ...
                              <tr>
								...
								<select id="ym_weight" name="ym_weight">
                                    ...
                                    <option id="40 kgs/ 88 lbs" <?php if($check1){} elseif($query1->ym_weight=="40 kgs/ 88 lbs") echo "selected='selected'"; ?> value="40 kgs/ 88 lbs" >40 kgs/ 88 lbs</option>
									<option id="41 kgs/ 90 lbs" <?php if($check1){} elseif($query1->ym_weight=="41 kgs/ 90 lbs") echo "selected='selected'"; ?> value="41 kgs/ 90 lbs">41 kgs/ 90 lbs</option>
									<option id="42 kgs/ 92 lbs" <?php if($check1){} elseif($query1->ym_weight=="42 kgs/ 92 lbs") echo "selected='selected'"; ?> value="42 kgs/ 92 lbs">42 kgs/ 92 lbs</option>
									<option id="43 kgs/ 94 lbs" <?php if($check1){} elseif($query1->ym_weight=="43 kgs/ 94 lbs") echo "selected='selected'"; ?> value="43 kgs/ 94 lbs">43 kgs/ 94 lbs</option>
									<option id="44 kgs/ 97 lbs" <?php if($check1){} elseif($query1->ym_weight=="44 kgs/ 97 lbs") echo "selected='selected'"; ?> value="44 kgs/ 97 lbs">44 kgs/ 97 lbs</option>
									<option id="45 kgs/ 99 lbs" <?php if($check1){} elseif($query1->ym_weight=="45 kgs/ 99 lbs") echo "selected='selected'"; ?> value="45 kgs/ 99 lbs">45 kgs/ 99 lbs</option>
									<option id="46 kgs/ 101 lbs" <?php if($check1){} elseif($query1->ym_weight=="46 kgs/ 101 lbs") echo "selected='selected'"; ?> value="46 kgs/ 101 lbs">46 kgs/ 101 lbs</option>
									<option id="47 kgs/ 103 lbs" <?php if($check1){} elseif($query1->ym_weight=="47 kgs/ 103 lbs") echo "selected='selected'"; ?> value="47 kgs/ 103 lbs">47 kgs/ 103 lbs</option>
									<option id="48 kgs/ 105 lbs" <?php if($check1){} elseif($query1->ym_weight=="48 kgs/ 105 lbs") echo "selected='selected'"; ?> value="48 kgs/ 105 lbs">48 kgs/ 105 lbs</option>
									<option id="49 kgs/ 108 lbs" <?php if($check1){} elseif($query1->ym_weight=="49 kgs/ 108 lbs") echo "selected='selected'"; ?> value="49 kgs/ 108 lbs">49 kgs/ 108 lbs</option>
									<option id="50 kgs/ 110 lbs" <?php if($check1){} elseif($query1->ym_weight=="50 kgs/ 110 lbs") echo "selected='selected'"; ?> value="50 kgs/ 110 lbs">50 kgs/ 110 lbs</option>
									<option id="51 kgs/ 112 lbs" <?php if($check1){} elseif($query1->ym_weight=="51 kgs/ 112 lbs") echo "selected='selected'"; ?> value="51 kgs/ 112 lbs">51 kgs/ 112 lbs</option>
									<option id="52 kgs/ 114 lbs" <?php if($check1){} elseif($query1->ym_weight=="52 kgs/ 114 lbs") echo "selected='selected'"; ?> value="52 kgs/ 114 lbs">52 kgs/ 114 lbs</option>
									<option id="53 kgs/ 116 lbs" <?php if($check1){} elseif($query1->ym_weight=="53 kgs/ 116 lbs") echo "selected='selected'"; ?> value="53 kgs/ 116 lbs">53 kgs/ 116 lbs</option>
									<option id="54 kgs/ 119 lbs" <?php if($check1){} elseif($query1->ym_weight=="54 kgs/ 119 lbs") echo "selected='selected'"; ?> value="54 kgs/ 119 lbs">54 kgs/ 119 lbs</option>
									<option id="55 kgs/ 121 lbs" <?php if($check1){} elseif($query1->ym_weight=="55 kgs/ 121 lbs") echo "selected='selected'"; ?> value="55 kgs/ 121 lbs">55 kgs/ 121 lbs</option>
									<option id="56 kgs/ 123 lbs" <?php if($check1){} elseif($query1->ym_weight=="56 kgs/ 123 lbs") echo "selected='selected'"; ?> value="56 kgs/ 123 lbs">56 kgs/ 123 lbs</option>
									<option id="57 kgs/ 125 lbs" <?php if($check1){} elseif($query1->ym_weight=="57 kgs/ 125 lbs") echo "selected='selected'"; ?> value="57 kgs/ 125 lbs">57 kgs/ 125 lbs</option>
									<option id="58 kgs/ 127 lbs" <?php if($check1){} elseif($query1->ym_weight=="58 kgs/ 127 lbs") echo "selected='selected'"; ?> value="58 kgs/ 127 lbs">58 kgs/ 127 lbs</option>
									<option id="59 kgs/ 130 lbs" <?php if($check1){} elseif($query1->ym_weight=="59 kgs/ 130 lbs") echo "selected='selected'"; ?> value="59 kgs/ 130 lbs">59 kgs/ 130 lbs</option>
									<option id="60 kgs/ 132 lbs" <?php if($check1){} elseif($query1->ym_weight=="60 kgs/ 132 lbs") echo "selected='selected'"; ?> value="60 kgs/ 132 lbs">60 kgs/ 132 lbs</option>
									<option id="61 kgs/ 134 lbs" <?php if($check1){} elseif($query1->ym_weight=="61 kgs/ 134 lbs") echo "selected='selected'"; ?> value="61 kgs/ 134 lbs">61 kgs/ 134 lbs</option>
									<option id="62 kgs/ 136 lbs" <?php if($check1){} elseif($query1->ym_weight=="62 kgs/ 136 lbs") echo "selected='selected'"; ?> value="62 kgs/ 136 lbs">62 kgs/ 136 lbs</option>
									<option id="63 kgs/ 138 lbs" <?php if($check1){} elseif($query1->ym_weight=="63 kgs/ 138 lbs") echo "selected='selected'"; ?> value="63 kgs/ 138 lbs">63 kgs/ 138 lbs</option>
									<option id="64 kgs/ 141 lbs" <?php if($check1){} elseif($query1->ym_weight=="64 kgs/ 141 lbs") echo "selected='selected'"; ?> value="64 kgs/ 141 lbs">64 kgs/ 141 lbs</option>
									<option id="65 kgs/ 143 lbs" <?php if($check1){} elseif($query1->ym_weight=="65 kgs/ 143 lbs") echo "selected='selected'"; ?> value="65 kgs/ 143 lbs">65 kgs/ 143 lbs</option>
									<option id="66 kgs/ 145 lbs" <?php if($check1){} elseif($query1->ym_weight=="66 kgs/ 145 lbs") echo "selected='selected'"; ?> value="66 kgs/ 145 lbs">66 kgs/ 145 lbs</option>
									<option id="67 kgs/ 147 lbs" <?php if($check1){} elseif($query1->ym_weight=="67 kgs/ 147 lbs") echo "selected='selected'"; ?> value="67 kgs/ 147 lbs">67 kgs/ 147 lbs</option>
									<option id="68 kgs/ 149 lbs" <?php if($check1){} elseif($query1->ym_weight=="68 kgs/ 149 lbs") echo "selected='selected'"; ?> value="68 kgs/ 149 lbs">68 kgs/ 149 lbs</option>
									<option id="69 kgs/ 152 lbs" <?php if($check1){} elseif($query1->ym_weight=="69 kgs/ 152 lbs") echo "selected='selected'"; ?> value="69 kgs/ 152 lbs">69 kgs/ 152 lbs</option>
									<option id="70 kgs/ 154 lbs" <?php if($check1){} elseif($query1->ym_weight=="70 kgs/ 154 lbs") echo "selected='selected'"; ?> value="70 kgs/ 154 lbs">70 kgs/ 154 lbs</option>
									<option id="71 kgs/ 156 lbs" <?php if($check1){} elseif($query1->ym_weight=="71 kgs/ 156 lbs") echo "selected='selected'"; ?> value="71 kgs/ 156 lbs">71 kgs/ 156 lbs</option>
									<option id="72 kgs/ 158 lbs" <?php if($check1){} elseif($query1->ym_weight=="72 kgs/ 158 lbs") echo "selected='selected'"; ?> value="72 kgs/ 158 lbs">72 kgs/ 158 lbs</option>
									<option id="73 kgs/ 160 lbs" <?php if($check1){} elseif($query1->ym_weight=="73 kgs/ 160 lbs") echo "selected='selected'"; ?> value="73 kgs/ 160 lbs">73 kgs/ 160 lbs</option>
									<option id="74 kgs/ 163 lbs" <?php if($check1){} elseif($query1->ym_weight=="74 kgs/ 163 lbs") echo "selected='selected'"; ?> value="74 kgs/ 163 lbs">74 kgs/ 163 lbs</option>
									<option id="75 kgs/ 165 lbs" <?php if($check1){} elseif($query1->ym_weight=="75 kgs/ 165 lbs") echo "selected='selected'"; ?> value="75 kgs/ 165 lbs">75 kgs/ 165 lbs</option>
									<option id="76 kgs/ 167 lbs" <?php if($check1){} elseif($query1->ym_weight=="76 kgs/ 167 lbs") echo "selected='selected'"; ?> value="76 kgs/ 167 lbs">76 kgs/ 167 lbs</option>
									<option id="77 kgs/ 169 lbs" <?php if($check1){} elseif($query1->ym_weight=="77 kgs/ 169 lbs") echo "selected='selected'"; ?> value="77 kgs/ 169 lbs">77 kgs/ 169 lbs</option>
									<option id="78 kgs/ 171 lbs" <?php if($check1){} elseif($query1->ym_weight=="78 kgs/ 171 lbs") echo "selected='selected'"; ?> value="78 kgs/ 171 lbs">78 kgs/ 171 lbs</option>
									<option id="79 kgs/ 174 lbs" <?php if($check1){} elseif($query1->ym_weight=="79 kgs/ 174 lbs") echo "selected='selected'"; ?> value="79 kgs/ 174 lbs">79 kgs/ 174 lbs</option>
									<option id="80 kgs/ 176 lbs" <?php if($check1){} elseif($query1->ym_weight=="80 kgs/ 176 lbs") echo "selected='selected'"; ?> value="80 kgs/ 176 lbs">80 kgs/ 176 lbs</option>
									<option id="81 kgs/ 178 lbs" <?php if($check1){} elseif($query1->ym_weight=="81 kgs/ 178 lbs") echo "selected='selected'"; ?> value="81 kgs/ 178 lbs">81 kgs/ 178 lbs</option>
									<option id="82 kgs/ 180 lbs" <?php if($check1){} elseif($query1->ym_weight=="82 kgs/ 180 lbs") echo "selected='selected'"; ?> value="82 kgs/ 180 lbs">82 kgs/ 180 lbs</option>
									<option id="83 kgs/ 182 lbs" <?php if($check1){} elseif($query1->ym_weight=="83 kgs/ 182 lbs") echo "selected='selected'"; ?> value="83 kgs/ 182 lbs">83 kgs/ 182 lbs</option>
									<option id="84 kgs/ 185 lbs" <?php if($check1){} elseif($query1->ym_weight=="84 kgs/ 185 lbs") echo "selected='selected'"; ?> value="84 kgs/ 185 lbs">84 kgs/ 185 lbs</option>
									<option id="85 kgs/ 187 lbs" <?php if($check1){} elseif($query1->ym_weight=="85 kgs/ 187 lbs") echo "selected='selected'"; ?> value="85 kgs/ 187 lbs">85 kgs/ 187 lbs</option>
									<option id="86 kgs/ 189 lbs" <?php if($check1){} elseif($query1->ym_weight=="86 kgs/ 189 lbs") echo "selected='selected'"; ?> value="86 kgs/ 189 lbs">86 kgs/ 189 lbs</option>
									<option id="87 kgs/ 191 lbs" <?php if($check1){} elseif($query1->ym_weight=="87 kgs/ 191 lbs") echo "selected='selected'"; ?> value="87 kgs/ 191 lbs">87 kgs/ 191 lbs</option>
									<option id="88 kgs/ 194 lbs" <?php if($check1){} elseif($query1->ym_weight=="88 kgs/ 194 lbs") echo "selected='selected'"; ?> value="88 kgs/ 194 lbs">88 kgs/ 194 lbs</option>
									<option id="89 kgs/ 196 lbs" <?php if($check1){} elseif($query1->ym_weight=="89 kgs/ 196 lbs") echo "selected='selected'"; ?> value="89 kgs/ 196 lbs">89 kgs/ 196 lbs</option>
									<option id="90 kgs/ 198 lbs" <?php if($check1){} elseif($query1->ym_weight=="90 kgs/ 198 lbs") echo "selected='selected'"; ?> value="90 kgs/ 198 lbs">90 kgs/ 198 lbs</option>
									<option id="91 kgs/ 200 lbs" <?php if($check1){} elseif($query1->ym_weight=="91 kgs/ 200 lbs") echo "selected='selected'"; ?> value="91 kgs/ 200 lbs">91 kgs/ 200 lbs</option>
									<option id="92 kgs/ 202 lbs" <?php if($check1){} elseif($query1->ym_weight=="92 kgs/ 202 lbs") echo "selected='selected'"; ?> value="92 kgs/ 202 lbs">92 kgs/ 202 lbs</option>
									<option id="93 kgs/ 205 lbs" <?php if($check1){} elseif($query1->ym_weight=="93 kgs/ 205 lbs") echo "selected='selected'"; ?> value="93 kgs/ 205 lbs">93 kgs/ 205 lbs</option>
									<option id="94 kgs/ 207 lbs" <?php if($check1){} elseif($query1->ym_weight=="94 kgs/ 207 lbs") echo "selected='selected'"; ?> value="94 kgs/ 207 lbs">94 kgs/ 207 lbs</option>
									<option id="95 kgs/ 209 lbs" <?php if($check1){} elseif($query1->ym_weight=="95 kgs/ 209 lbs") echo "selected='selected'"; ?> value="95 kgs/ 209 lbs">95 kgs/ 209 lbs</option>
									<option id="96 kgs/ 211 lbs" <?php if($check1){} elseif($query1->ym_weight=="96 kgs/ 211 lbs") echo "selected='selected'"; ?> value="96 kgs/ 211 lbs">96 kgs/ 211 lbs</option>
									<option id="97 kgs/ 213 lbs" <?php if($check1){} elseif($query1->ym_weight=="97 kgs/ 213 lbs") echo "selected='selected'"; ?> value="97 kgs/ 213 lbs">97 kgs/ 213 lbs</option>
									<option id="98 kgs/ 216 lbs" <?php if($check1){} elseif($query1->ym_weight=="98 kgs/ 216 lbs") echo "selected='selected'"; ?> value="98 kgs/ 216 lbs">98 kgs/ 216 lbs</option>
									<option id="99 kgs/ 218 lbs" <?php if($check1){} elseif($query1->ym_weight=="99 kgs/ 218 lbs") echo "selected='selected'"; ?> value="99 kgs/ 218 lbs">99 kgs/ 218 lbs</option>
									<option id="100 kgs/ 220 lbs" <?php if($check1){} elseif($query1->ym_weight=="100 kgs/ 220 lbs") echo "selected='selected'"; ?> value="100 kgs/ 220 lbs">100 kgs/ 220 lbs</option>
									<option id="101 kgs/ 222 lbs" <?php if($check1){} elseif($query1->ym_weight=="101 kgs/ 222 lbs") echo "selected='selected'"; ?> value="101 kgs/ 222 lbs">101 kgs/ 222 lbs</option>
									<option id="102 kgs/ 224 lbs" <?php if($check1){} elseif($query1->ym_weight=="102 kgs/ 224 lbs") echo "selected='selected'"; ?> value="102 kgs/ 224 lbs">102 kgs/ 224 lbs</option>
									<option id="103 kgs/ 227 lbs" <?php if($check1){} elseif($query1->ym_weight=="103 kgs/ 227 lbs") echo "selected='selected'"; ?> value="103 kgs/ 227 lbs">103 kgs/ 227 lbs</option>
									<option id="104 kgs/ 229 lbs" <?php if($check1){} elseif($query1->ym_weight=="104 kgs/ 229 lbs") echo "selected='selected'"; ?> value="104 kgs/ 229 lbs">104 kgs/ 229 lbs</option>
									<option id="105 kgs/ 231 lbs" <?php if($check1){} elseif($query1->ym_weight=="105 kgs/ 231 lbs") echo "selected='selected'"; ?> value="105 kgs/ 231 lbs">105 kgs/ 231 lbs</option>
									<option id="106 kgs/ 233 lbs"<?php if($check1){} elseif($query1->ym_weight=="106 kgs/ 233 lbs") echo "selected='selected'"; ?> value="106 kgs/ 233 lbs">106 kgs/ 233 lbs</option>
									<option id="107 kgs/ 235 lbs" <?php if($check1){} elseif($query1->ym_weight=="107 kgs/ 235 lbs") echo "selected='selected'"; ?>  value="107 kgs/ 235 lbs">107 kgs/ 235 lbs</option>
									<option id="108 kgs/ 238 lbs" <?php if($check1){} elseif($query1->ym_weight=="108 kgs/ 238 lbs") echo "selected='selected'"; ?> value="108 kgs/ 238 lbs">108 kgs/ 238 lbs</option>
									<option id="109 kgs/ 240 lbs" <?php if($check1){} elseif($query1->ym_weight=="109 kgs/ 240 lbs") echo "selected='selected'"; ?> value="109 kgs/ 240 lbs">109 kgs/ 240 lbs</option>
									<option id="110 kgs/ 242 lbs" <?php if($check1){} elseif($query1->ym_weight=="110 kgs/ 242 lbs") echo "selected='selected'"; ?> value="110 kgs/ 242 lbs">110 kgs/ 242 lbs</option>
									<option id="111 kgs/ 244 lbs" <?php if($check1){} elseif($query1->ym_weight=="111 kgs/ 244 lbs") echo "selected='selected'"; ?> value="111 kgs/ 244 lbs">111 kgs/ 244 lbs</option>
									<option id="112 kgs/ 246 lbs" <?php if($check1){} elseif($query1->ym_weight=="112 kgs/ 246 lbs") echo "selected='selected'"; ?> value="112 kgs/ 246 lbs">112 kgs/ 246 lbs</option>
									<option id="113 kgs/ 249 lbs" <?php if($check1){} elseif($query1->ym_weight=="113 kgs/ 249 lbs") echo "selected='selected'"; ?> value="113 kgs/ 249 lbs">113 kgs/ 249 lbs</option>
									<option id="114 kgs/ 251 lbs" <?php if($check1){} elseif($query1->ym_weight=="114 kgs/ 251 lbs") echo "selected='selected'"; ?> value="114 kgs/ 251 lbs">114 kgs/ 251 lbs</option>
									<option id="115 kgs/ 253 lbs" <?php if($check1){} elseif($query1->ym_weight=="115 kgs/ 253 lbs") echo "selected='selected'"; ?> value="115 kgs/ 253 lbs">115 kgs/ 253 lbs</option>
									<option id="116 kgs/ 255 lbs" <?php if($check1){} elseif($query1->ym_weight=="116 kgs/ 255 lbs") echo "selected='selected'"; ?> value="116 kgs/ 255 lbs">116 kgs/ 255 lbs</option>
									<option id="117 kgs/ 257 lbs" <?php if($check1){} elseif($query1->ym_weight=="117 kgs/ 257 lbs") echo "selected='selected'"; ?> value="117 kgs/ 257 lbs">117 kgs/ 257 lbs</option>
									<option id="118 kgs/ 260 lbs" <?php if($check1){} elseif($query1->ym_weight=="118 kgs/ 260 lbs") echo "selected='selected'"; ?> value="118 kgs/ 260 lbs">118 kgs/ 260 lbs</option>
									<option id="119 kgs/ 262 lbs" <?php if($check1){} elseif($query1->ym_weight=="119 kgs/ 262 lbs") echo "selected='selected'"; ?> value="119 kgs/ 262 lbs">119 kgs/ 262 lbs</option>
									<option id="120 kgs/ 264 lbs" <?php if($check1){} elseif($query1->ym_weight=="120 kgs/ 264 lbs") echo "selected='selected'"; ?> value="120 kgs/ 264 lbs">120 kgs/ 264 lbs</option>
									<option id="121 kgs/ 266 lbs" <?php if($check1){} elseif($query1->ym_weight=="121 kgs/ 266 lbs") echo "selected='selected'"; ?> value="121 kgs/ 266 lbs">121 kgs/ 266 lbs</option>
									<option id="122 kgs/ 268 lbs" <?php if($check1){} elseif($query1->ym_weight=="122 kgs/ 268 lbs") echo "selected='selected'"; ?> value="122 kgs/ 268 lbs">122 kgs/ 268 lbs</option>
									<option id="123 kgs/ 271 lbs" <?php if($check1){} elseif($query1->ym_weight=="123 kgs/ 271 lbs") echo "selected='selected'"; ?> value="123 kgs/ 271 lbs">123 kgs/ 271 lbs</option>
									<option id="124 kgs/ 273 lbs" <?php if($check1){} elseif($query1->ym_weight=="124 kgs/ 273 lbs") echo "selected='selected'"; ?> value="124 kgs/ 273 lbs">124 kgs/ 273 lbs</option>
									<option id="125 kgs/ 275 lbs" <?php if($check1){} elseif($query1->ym_weight=="125 kgs/ 275 lbs") echo "selected='selected'"; ?> value="125 kgs/ 275 lbs">125 kgs/ 275 lbs</option>
									<option id="126 kgs/ 277 lbs" <?php if($check1){} elseif($query1->ym_weight=="126 kgs/ 277 lbs") echo "selected='selected'"; ?> value="126 kgs/ 277 lbs">126 kgs/ 277 lbs</option>
									<option id="127 kgs/ 279 lbs" <?php if($check1){} elseif($query1->ym_weight=="127 kgs/ 279 lbs") echo "selected='selected'"; ?> value="127 kgs/ 279 lbs">127 kgs/ 279 lbs</option>
									<option id="128 kgs/ 282 lbs" <?php if($check1){} elseif($query1->ym_weight=="128 kgs/ 282 lbs") echo "selected='selected'"; ?> value="128 kgs/ 282 lbs">128 kgs/ 282 lbs</option>
									<option id="129 kgs/ 284 lbs" <?php if($check1){} elseif($query1->ym_weight=="129 kgs/ 284 lbs") echo "selected='selected'"; ?> value="129 kgs/ 284 lbs">129 kgs/ 284 lbs</option>
									<option id="130 kgs/ 286 lbs" <?php if($check1){} elseif($query1->ym_weight=="130 kgs/ 286 lbs") echo "selected='selected'"; ?> value="130 kgs/ 286 lbs">130 kgs/ 286 lbs</option>
									<option id="131 kgs/ 288 lbs" <?php if($check1){} elseif($query1->ym_weight=="131 kgs/ 288 lbs") echo "selected='selected'"; ?> value="131 kgs/ 288 lbs">131 kgs/ 288 lbs</option>
									<option id="132 kgs/ 291 lbs" <?php if($check1){} elseif($query1->ym_weight=="132 kgs/ 291 lbs") echo "selected='selected'"; ?> value="132 kgs/ 291 lbs">132 kgs/ 291 lbs</option>
									<option id="133 kgs/ 293 lbs" <?php if($check1){} elseif($query1->ym_weight=="133 kgs/ 293 lbs") echo "selected='selected'"; ?> value="133 kgs/ 293 lbs">133 kgs/ 293 lbs</option>
									<option id="134 kgs/ 295 lbs" <?php if($check1){} elseif($query1->ym_weight=="134 kgs/ 295 lbs") echo "selected='selected'"; ?> value="134 kgs/ 295 lbs">134 kgs/ 295 lbs</option>
									<option id="135 kgs/ 297 lbs" <?php if($check1){} elseif($query1->ym_weight=="135 kgs/ 297 lbs") echo "selected='selected'"; ?> value="135 kgs/ 297 lbs">135 kgs/ 297 lbs</option>
									<option id="136 kgs/ 299 lbs" <?php if($check1){} elseif($query1->ym_weight=="136 kgs/ 299 lbs") echo "selected='selected'"; ?> value="136 kgs/ 299 lbs">136 kgs/ 299 lbs</option>
									<option id="137 kgs/ 302 lbs" <?php if($check1){} elseif($query1->ym_weight=="137 kgs/ 302 lbs") echo "selected='selected'"; ?> value="137 kgs/ 302 lbs">137 kgs/ 302 lbs</option>
									<option id="138 kgs/ 304 lbs" <?php if($check1){} elseif($query1->ym_weight=="138 kgs/ 304 lbs") echo "selected='selected'"; ?> value="138 kgs/ 304 lbs">138 kgs/ 304 lbs</option>
									<option id="139 kgs/ 306 lbs" <?php if($check1){} elseif($query1->ym_weight=="139 kgs/ 306 lbs") echo "selected='selected'"; ?> value="139 kgs/ 306 lbs">139 kgs/ 306 lbs</option>
									<option id="140 kgs/ 308 lbs" <?php if($check1){} elseif($query1->ym_weight=="140 kgs/ 308 lbs") echo "selected='selected'"; ?> value="140 kgs/ 308 lbs">140 kgs/ 308 lbs</option>
									<option id="141 kgs/ 310 lbs" <?php if($check1){} elseif($query1->ym_weight=="141 kgs/ 310 lbs") echo "selected='selected'"; ?> value="141 kgs/ 310 lbs">141 kgs/ 310 lbs</option>
									<option id="142 kgs/ 313 lbs" <?php if($check1){} elseif($query1->ym_weight=="142 kgs/ 313 lbs") echo "selected='selected'"; ?> value="142 kgs/ 313 lbs">142 kgs/ 313 lbs</option>
									<option id="143 kgs/ 315 lbs" <?php if($check1){} elseif($query1->ym_weight=="143 kgs/ 315 lbs") echo "selected='selected'"; ?> value="143 kgs/ 315 lbs">143 kgs/ 315 lbs</option>
									<option id="144 kgs/ 317 lbs" <?php if($check1){} elseif($query1->ym_weight=="144 kgs/ 317 lbs") echo "selected='selected'"; ?> value="144 kgs/ 317 lbs">144 kgs/ 317 lbs</option>
									<option id="145 kgs/ 319 lbs" <?php if($check1){} elseif($query1->ym_weight=="145 kgs/ 319 lbs") echo "selected='selected'"; ?> value="145 kgs/ 319 lbs">145 kgs/ 319 lbs</option>
									<option id="146 kgs/ 321 lbs" <?php if($check1){} elseif($query1->ym_weight=="146 kgs/ 321 lbs") echo "selected='selected'"; ?> value="146 kgs/ 321 lbs">146 kgs/ 321 lbs</option>
									<option id="147 kgs/ 324 lbs" <?php if($check1){} elseif($query1->ym_weight=="147 kgs/ 324 lbs") echo "selected='selected'"; ?> value="147 kgs/ 324 lbs">147 kgs/ 324 lbs</option>
									<option id="148 kgs/ 326 lbs" <?php if($check1){} elseif($query1->ym_weight=="148 kgs/ 326 lbs") echo "selected='selected'"; ?> value="148 kgs/ 326 lbs">148 kgs/ 326 lbs</option>
									<option id="149 kgs/ 328 lbs" <?php if($check1){} elseif($query1->ym_weight=="149 kgs/ 328 lbs") echo "selected='selected'"; ?> value="149 kgs/ 328 lbs">149 kgs/ 328 lbs</option>
									<option id="150 kgs/ 330 lbs" <?php if($check1){} elseif($query1->ym_weight=="150 kgs/ 330 lbs") echo "selected='selected'"; ?> value="150 kgs/ 330 lbs">150 kgs/ 330 lbs</option>
                                </select>
...
{
$('#loading').hide();
$(".photogallery").css({ opacity: "1" });///update_monita20130930//////////
}
