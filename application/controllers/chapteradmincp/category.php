...
class Category extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('chapteradmincp/dbcategory');
	...
	public function add()
	{
		...
		else
		{
			...
			redirect(base_url().'chapteradmincp/category');
		}
	
	
		$data['title']='Add Category';
		$this->load->view('chapteradmincp/category/add',$data);
	}
	...
	public function view()
	{
		...
		$config['base_url'] = base_url().'chapteradmincp/category/view/';
		...
		$this->load->view('chapteradmincp/category/view',$data);
	}
	...
	public function edit($id)
	{
		...
		$this->load->view('chapteradmincp/category/edit',$data);
	}
	 ...
	 public function delete($id)
	{
		...
		{
			redirect(base_url('chapteradmincp/category/view'));
		}
