	...
	function registration()
	{
		...
		else
		{
            ...
            $con_title = $settings->ch_name.' Convention '.$settings->ch_year;   
				...
				$final_message = array('name' => '', 'sitename'=> $settings->cs_sitename, 'user_email' => $email, 'con_hdn_ch_name' => '', 'con_hdn_reg_number' => $rand, 'con_hdn_lm_number' => '', 'con_hdn_last_name' => $lname, 'con_hdn_first_name' => $fname, 'con_hdn_addr' => $address, 'con_hdn_city' => $mm_city_name, 'con_hdn_state' => $mm_state_name, 'con_hdn_phnH' => $phoneh, 'con_hdn_phnC' => $phonec, 'con_hdn_email' => $email, 'zipcode'=> $zipcode, 'con_hdn_payment_method' => $payment_type, 'con_em_name' => $con_name, 'con_em_number' => $con_number, 'member' => $mem_html, 'event' => $event_html, 'total_fees' => $total, 'logo' => $settings->cs_logo, 'logo2' => $settings->cs_logo2, 'con_title' => $con_title);
	   ...
	   if(empty($_POST['confirmCaptcha']))
		...
		else
		{
            ...
            $con_title = $settings->ch_name.' Convention '.$settings->ch_year;   	
				...
				$final_message = array('name' => '', 'sitename'=> $settings->cs_sitename, 'user_email' => $email, 'con_hdn_ch_name' => '', 'con_hdn_reg_number' => $rand,'con_hdn_lm_number' => '', 'con_hdn_last_name' => $lname, 'con_hdn_first_name' => $fname, 'con_hdn_addr' => $address, 'con_hdn_city' => $get_cities->city_name, 'con_hdn_state' => $get_state->state_name, 'con_hdn_phnH' => $phoneh, 'con_hdn_phnC' => $phonec, 'con_hdn_email' => $email, 'zipcode'=> $zipcode, 'con_hdn_payment_method' => $p_type, 'con_em_name' => $con_name, 'con_em_number' => $con_number, 'member' => $mem_html, 'total_fees' => $total, 'logo' => $settings->cs_logo, 'logo2' => $settings->cs_logo2, 'con_title' => $con_title);
