  ...
  <tr>
  	<td>
    	<div class="dotted_line">
		        <h1><?php echo $this->lang->line('text_advertisement');?> <small><?php echo $this->lang->line('text_add_advertisement');?></small></h1>
		</div>
        ...
        <?php 
			...
			{		
		?>
        		<input type="hidden" id="" name="ads_created_by" value="<?php echo $username->mm_username;?>">
        <?php
			}
        ?>
