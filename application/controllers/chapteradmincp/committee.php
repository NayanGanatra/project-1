...

{
...

	{
		...
		$this->load->model('chapteradmincp/dbcommittee');
...

	{
		...
		$this->load->view('chapteradmincp/committee/view',$data);
...

	{
...

		{
				...
				$mm_id = $this->input->post('cm_mm_id');
				...
				$resultB=$this->dbcommittee->edit_mm($dataB,$mm_id);
				...
				redirect(base_url().'chapteradmincp/committee');
		...
		$this->load->view('chapteradmincp/committee/add',$data);
...

	{
		...
		$this->load->view('chapteradmincp/committee/edit',$data);

	}

	

	function delete($id,$mm_id)
...

	{
		...
		$this->load->view('chapteradmincp/committee/position',$data);
...

	{
...

		{
				...
				redirect(base_url().'chapteradmincp/committee/position');
		...
		$this->load->view('chapteradmincp/committee/edit_position',$data);
...

	{
		...
		$this->load->view('chapteradmincp/committee/add_position',$data);
