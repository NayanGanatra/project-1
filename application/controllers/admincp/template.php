...
class Template extends CI_Controller
{
	function __construct()
	{
		...
		$this->load->model('admincp/dbtemplate');
	...
	public function edit($id)
	{
		...
		else
		{
					...
					redirect(base_url().'admincp/template');
				
		}
	
	
		$data['title']=$this->lang->line('text_edit_template');
		$this->load->view('admincp/template/edit',$data);
	}
	...
	public function add()
	{
		...
		$this->load->view('admincp/template/add',$data);
	}
	...
	public function view()
	{
		...
		$config['base_url'] = base_url().'admincp/template/view/';
		...
		$this->load->view('admincp/template/view',$data);
	...
	public function delete($id)
	{
		...
		redirect(base_url().'admincp/template/view');
	}
